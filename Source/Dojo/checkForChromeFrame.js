...
define(
        ["dojo/dom-construct", "dijit/Dialog"],
            ...
            function promptForInstall() {
                ...
                domConstruct
                        .create(
                                'div',
                                {
                                    innerHTML : "Cesium requires WebGL, an open standard for displaying 3D content in a<br/>web browser. To enable WebGL in Internet Explorer, we recommend installing<br/><a href='http://code.google.com/chrome/chromeframe/' target='_blank'>Google Chrome Frame</a>, a free, unobtrusive plug-in offered by Google.<br/>To learn more about WebGL, visit <a href='http://www.khronos.org/webgl/' target='_blank'>http://www.khronos.org/webgl/</a><br/><br/>Would you like to install Chrome Frame now?<br/><br/>"
