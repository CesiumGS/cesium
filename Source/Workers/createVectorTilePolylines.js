...
define(['./AttributeCompression-be503b68', './Cartesian2-eb270219', './IndexDatatype-21fdd02b', './Math-ae27e6c0', './createTaskProcessorWorker', './Check-24cae389', './when-e6985d2a', './WebGLConstants-34c08bc0'], function (AttributeCompression, Cartesian2, IndexDatatype, _Math, createTaskProcessorWorker, Check, when, WebGLConstants) { 'use strict';
