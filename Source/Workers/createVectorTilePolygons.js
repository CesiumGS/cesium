...
define(['./AttributeCompression-be503b68', './Cartesian2-eb270219', './Color-6b6b065f', './when-e6985d2a', './IndexDatatype-21fdd02b', './Math-ae27e6c0', './OrientedBoundingBox-3f08b57d', './createTaskProcessorWorker', './Check-24cae389', './Transforms-ee5c1729', './RuntimeError-61701d3e', './WebGLConstants-34c08bc0', './EllipsoidTangentPlane-5ac66d0f', './IntersectionTests-a2675a5c', './Plane-18686069'], function (AttributeCompression, Cartesian2, Color, when, IndexDatatype, _Math, OrientedBoundingBox, createTaskProcessorWorker, Check, Transforms, RuntimeError, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';
