...
define(['./Cartesian2-ea36f114', './EllipsoidTangentPlane-badc060c', './Transforms-0a60c469', './when-9f8cafad', './Check-c23b5bd5', './TerrainEncoding-3835a556', './Math-cf2f57e0', './OrientedBoundingBox-8c50ec51', './WebMercatorProjection-c11d982d', './RuntimeError-40167735', './createTaskProcessorWorker', './IntersectionTests-b2d4b64d', './Plane-ed60195c', './AttributeCompression-953fe0fc', './ComponentDatatype-ec57da04', './WebGLConstants-daaa9be0'], function (Cartesian2, EllipsoidTangentPlane, Transforms, when, Check, TerrainEncoding, _Math, OrientedBoundingBox, WebMercatorProjection, RuntimeError, createTaskProcessorWorker, IntersectionTests, Plane, AttributeCompression, ComponentDatatype, WebGLConstants) { 'use strict';
