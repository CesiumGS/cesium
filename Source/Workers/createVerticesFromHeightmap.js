...
define(['./Cartesian2-eb270219', './EllipsoidTangentPlane-5ac66d0f', './Transforms-ee5c1729', './when-e6985d2a', './Check-24cae389', './TerrainEncoding-527a93c1', './Math-ae27e6c0', './OrientedBoundingBox-3f08b57d', './WebMercatorProjection-7e20f237', './RuntimeError-61701d3e', './createTaskProcessorWorker', './IntersectionTests-a2675a5c', './Plane-18686069', './AttributeCompression-be503b68', './ComponentDatatype-cb08e294', './WebGLConstants-34c08bc0'], function (Cartesian2, EllipsoidTangentPlane, Transforms, when, Check, TerrainEncoding, _Math, OrientedBoundingBox, WebMercatorProjection, RuntimeError, createTaskProcessorWorker, IntersectionTests, Plane, AttributeCompression, ComponentDatatype, WebGLConstants) { 'use strict';
