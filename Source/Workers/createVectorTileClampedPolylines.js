define([
    ...
    function decodePositionsToRtc(uBuffer, vBuffer, heightBuffer, rectangle, minimumHeight, maximumHeight, ellipsoid, center) {
        ...
        for (var i = 0; i < positionsLength; ++i) {
            ...
            var rtc = Cartesian3.subtract(decodedPosition, center, scratchEncodedPosition);
    ...
    function createVectorTileClampedPolylines(parameters, transferableObjects) {
        ...
        transferableObjects.push(attribsAndIndices.startFaceNormalAndVertexCorners.buffer);
        ...
        return {
            ...
            startFaceNormalAndVertexCorners : attribsAndIndices.startFaceNormalAndVertexCorners.buffer,
