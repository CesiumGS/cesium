define([
    ...
    var scratchCarto = new Cartographic();
        ...
        class RectangleGeometryOptions {
            constructor(entity) {
                this.id = entity;
        ...
        class RectangleGeometryUpdater {
            ...
            _setStaticOptions(entity, rectangle) {
    ...
    RectangleGeometryUpdater.DynamicGeometryUpdater = DynamicRectangleGeometryUpdater;
        ...
        /**
             * @private
             */
        class DynamicRectangleGeometryUpdater {
