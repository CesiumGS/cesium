...
define([
    ...
    RectangleGeometryUpdater.prototype.isOutlineVisible = function(time) {
        ...
        return this._outlineEnabled && entity.uiShow && entity.isAvailable(time) && this._showProperty.getValue(time) && this._showOutlineProperty.getValue(time);
    };
    ...
    RectangleGeometryUpdater.prototype.isFilled = function(time) {
        var entity = this._entity;
        return this._fillEnabled && entity.uiShow && entity.isAvailable(time) && this._showProperty.getValue(time) && this._fillProperty.getValue(time);
    };
    ...
    RectangleGeometryUpdater.prototype.createFillGeometryInstance = function(time) {
        ...
        var color;
        var show = new ShowGeometryInstanceAttribute(isAvailable && entity.uiShow && this._showProperty.getValue(time) && this._fillProperty.getValue(time));
    ...
    RectangleGeometryUpdater.prototype.createOutlineGeometryInstance = function(time) {
        ...
        return new GeometryInstance({
            ...
            attributes : {
                show : new ShowGeometryInstanceAttribute(isAvailable && entity.uiShow && this._showProperty.getValue(time) && this._showOutlineProperty.getValue(time)),
    ...
    DynamicGeometryUpdater.prototype.update = function(time) {
        ...
        if (!entity.uiShow || !entity.isAvailable(time) || (defined(show) && !show.getValue(time))) {
            return;
        }
