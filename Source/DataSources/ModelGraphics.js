...
import PropertyBag from './PropertyBag.js';
     ...
     * @param {Property} [options.lightColor] A property specifying the light color and intensity when shading the model. When <code>undefined</code> the scene's light color and intensity are used instead.
    ...
    defineProperties(ModelGraphics.prototype, {
        ...
        /**
         * A property specifying the {@link Cartesian3} light color and intensity when shading the model. When <code>undefined</code> the scene's light color and intensity are used instead.
         * @memberOf ModelGraphics.prototype
         * @type {Property}
         */
