...
define([
    ...
    PolylineGeometryUpdater.prototype.isFilled = function(time) {
        ...
        return this._fillEnabled && entity.uiShow && entity.isAvailable(time) && this._showProperty.getValue(time);
    };
    ...
    PolylineGeometryUpdater.prototype.createFillGeometryInstance = function(time) {
        ...
        var show = new ShowGeometryInstanceAttribute(isAvailable && entity.uiShow && this._showProperty.getValue(time));
    ...
    DynamicGeometryUpdater.prototype.update = function(time) {
        ...
        var show = entity.uiShow && entity.isAvailable(time) && Property.getValueOrDefault(polyline._show, time, true);
        if (!show) {
