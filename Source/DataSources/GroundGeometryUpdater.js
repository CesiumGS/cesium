define([
    ...
    class GroundGeometryUpdater {
        ...
        /**
             * @private
             */
        static getGeometryHeight(heightProperty, heightReferenceProperty, time) {
        ...
        /**
             * @private
             */
        static getGeometryExtrudedHeight(extrudedHeightProperty, extrudedHeightReferenceProperty, time) {
        ...
        /**
             * @private
             */
        static computeGeometryOffsetAttribute(heightReferenceProperty, extrudedHeightReferenceProperty, time) {
            var heightReference = Property.getValueOrDefault(heightReferenceProperty, time, HeightReference.NONE);
