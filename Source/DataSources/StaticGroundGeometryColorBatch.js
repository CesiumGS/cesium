...
import RectangleCollisionChecker from '../Core/RectangleCollisionChecker.js';
     ...
     * @private
     */
    function StaticGroundGeometryColorBatch(primitives, classificationType, mapProjection) {
        this._batches = [];
    ...
    StaticGroundGeometryColorBatch.prototype.add = function(time, updater) {
        ...
        if (!defined(batch)) {
            batch = new Batch(this._primitives, this._classificationType, instance.attributes.color.value, zIndex, this._mapProjection);
            batches.push(batch);
        }
