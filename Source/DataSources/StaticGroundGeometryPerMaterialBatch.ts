define([
    ...
    var defaultDistanceDisplayCondition = new DistanceDisplayCondition();
        ...
        class Batch {
            constructor(primitives, appearanceType, materialProperty, usingSphericalTextureCoordinates, zIndex) {
            ...
            add(time, updater, geometryInstance) {
                var id = updater.id;
        ...
        class StaticGroundGeometryPerMaterialBatch {
            constructor(primitives, appearanceType) {
                this._items = [];
