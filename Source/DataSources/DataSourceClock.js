...
define([
    ...
    defineProperties(DataSourceClock.prototype, {
         ...
         * @type {JulianDate}
         */
        startTime : PropertyHelper.createRawPropertyDescriptor('startTime'),
         ...
         * @type {JulianDate}
         */
        stopTime : PropertyHelper.createRawPropertyDescriptor('stopTime'),
         ...
         * @type {JulianDate}
         */
        currentTime : PropertyHelper.createRawPropertyDescriptor('currentTime'),
         ...
         * @type {ClockRange}
         */
        clockRange : PropertyHelper.createRawPropertyDescriptor('clockRange'),
         ...
         * @type {ClockStep}
         */
        clockStep : PropertyHelper.createRawPropertyDescriptor('clockStep'),
         ...
         * @type {Number}
         */
        multiplier : PropertyHelper.createRawPropertyDescriptor('multiplier')
    });
