define([
     ...
     * @param {MaterialProperty} [options.depthFailMaterial=undefinded] A property specifiying the material to used to draw the polyline when it is below the terrain.
