define([
    ...
    var offsetScratch = new Cartesian3();
        ...
        class Batch {
            constructor(primitives, translucent, appearanceType, depthFailAppearanceType, depthFailMaterialProperty, closed, shadows) {
        ...
        /**
             * @private
             */
        class StaticGeometryColorBatch {
            constructor(primitives, appearanceType, depthFailAppearanceType, closed, shadows) {
                this._solidItems = [];
