...
define([
     ...
     * @param {Property} [options.onTerrain=false] A boolean Property specifying whether the rectangle is drawn on terrain.
     *
     * @see Entity
    ...
    defineProperties(RectangleGraphics.prototype, {
        ...
        /**
         * Gets or sets the boolean Property specifying whether the rectangle should be drawn on terrain.
         * @memberof RectangleGraphics.prototype
         * @type {Property}
         * @default true
         */
