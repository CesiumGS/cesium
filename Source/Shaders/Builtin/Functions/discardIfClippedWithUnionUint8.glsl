 ...
 *
 * @name czm_discardIfClippedWithUnionUint8
 * @glslFunction
 *
 ...
 */
float czm_discardIfClippedWithUnionUint8(sampler2D clippingPlanes, int clippingPlanesLength, vec2 range, int textureWidth, mat4 clippingPlanesMatrix)
{
