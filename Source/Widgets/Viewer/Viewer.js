...
import VRButton from '../VRButton/VRButton.js';
     ...
     * @param {Boolean} [options.shadows=false] Determines if shadows are cast by each light source.
     * @param {ShadowMode} [options.terrainShadows=ShadowMode.RECEIVE_ONLY] Determines if the terrain casts or receives shadows from each light source.
...
Either specify options.terrainProvider instead or set options.baseLayerPicker to true.');
    ...
    defineProperties(Viewer.prototype, {
        ...
        /**
         * Determines if shadows are cast by each light source.
         * @memberof Viewer.prototype
         * @type {Boolean}
         */
        shadows : {
        ...
        /**
         * Determines if the terrain casts or shadows from each light source.
         * @memberof Viewer.prototype
         * @type {ShadowMode}
         */
        terrainShadows : {
