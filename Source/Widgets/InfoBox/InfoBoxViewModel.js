define([
    ...
    function InfoBoxViewModel() {
        ...
        /**
         * Gets or sets the security settings for iFrames generated by the Infobox.
         * This will disable sandboxing for the iFrame, and allow HTML to be in the title.
         * Only do this if you are in complete control of the data that will be loaded into the InfoBox,
         * otherwise it is a security issue.
         * @type {boolean}
         */
