define([
     ...
     * @param {Boolean} [options.disableSecurity=false] disableSecurity If set to true, iFrame sandboxing will be disabled, allowing JavaScript and HTML to be executed.
     *
