define([
    ...
    function validateStencilOperation(stencilOperation) {
        ...
        class RenderState {
            ...
            static apply(gl, renderState, passState) {
            ...
            static partialApply(gl, previousRenderState, renderState, previousPassState, passState, clear) {
