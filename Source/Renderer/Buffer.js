define([
    ...
    'use strict';
        ...
        class Buffer {
            ...
            copyFromArrayView(arrayView, offsetInBytes) {
            ...
            copyFromBuffer(readBuffer, readOffset, writeOffset, sizeInBytes) {
                //>>includeStart('debug', pragmas.debug);
                if (!this._webgl2) {
            ...
            getBufferData(arrayView, sourceOffset, destinationOffset, length) {
