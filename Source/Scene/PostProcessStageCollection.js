define([
     ...
     * @private
     */
    PostProcessStageCollection.prototype.update = function(context, usePackedDepth) {
        removeStages(this);
        ...
        fxaa.update(context, usePackedDepth);
        ao.update(context, usePackedDepth);
        bloom.update(context, usePackedDepth);
