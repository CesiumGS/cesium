...
define([
    ...
    OrthographicFrustum.prototype._updateProjectionMatrices = function() {
        ...
        this._orthographicMatrix = Matrix4.computeOrthographicOffCenter(l, r, b, t, n, f);
    };
     ...
     */
    OrthographicFrustum.prototype.getPlanes = function(position, direction, up, result) {
        update(this);
