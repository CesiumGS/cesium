 ...
 * @param {Boolean} [options.showOutline=true] Whether to display the outline for models. When true, outlines \
 *        are displayed. When false, outlines are not displayed.
