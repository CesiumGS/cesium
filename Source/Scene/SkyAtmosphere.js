...
SkyAtmosphere.prototype.update = function (frameState, globe) {
  ...
  var splitDirectionFlag = this.splitDirection === 0 ? 0 : this.splitDirection < 0.0 ? 1 : 2;
  var flags = colorCorrect | (perFragmentAtmosphere << 2) | (translucent << 3) || (splitDirectionFlag << 4);
