...
VertexAttributeToLoad.prototype.process = function (frameState) {
  this.vertexBufferLoader.process(frameState);
...
IndicesToLoad.prototype.process = function (frameState) {
  this.indexBufferLoader.process(frameState);
...
TextureToLoad.prototype.process = function (frameState) {
  this.textureLoader.process(frameState);
