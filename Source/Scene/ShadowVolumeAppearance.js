define([
    ...
    class ShadowVolumeAppearance {
        ...
        /**
             ...
             */
        static getPlanarTextureCoordinateAttributes(boundingRectangle, textureCoordinateRotationPoints, ellipsoid, projection, height) {
            //>>includeStart('debug', pragmas.debug);
        ...
        /**
             ...
             */
        static getSphericalExtentGeometryInstanceAttributes(boundingRectangle, textureCoordinateRotationPoints, ellipsoid, projection) {
            //>>includeStart('debug', pragmas.debug);
            Check.typeOf.object('boundingRectangle', boundingRectangle);
            Check.defined('textureCoordinateRotationPoints', textureCoordinateRotationPoints);
            Check.typeOf.object('ellipsoid', ellipsoid);
        ...
        static hasAttributesForTextureCoordinatePlanes(attributes) {
        ...
        static hasAttributesForSphericalExtents(attributes) {
        ...
        /**
             ...
             * @private
             */
        static shouldUseSphericalCoordinates(rectangle) {
            //>>includeStart('debug', pragmas.debug);
