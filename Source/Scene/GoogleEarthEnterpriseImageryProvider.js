...
define([
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getUrl = function() {
        return this._url;
    };
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getTileWidth = function() {
        if (!this._ready) {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getTileHeight = function() {
        if (!this._ready) {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getMaximumLevel = function() {
        if (!this._ready) {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getTilingScheme = function() {
        if (!this._ready) {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getExtent = function() {
        if (!this._ready) {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getTileDiscardPolicy = function() {
        if (!this._ready) {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.getErrorEvent = function() {
     ...
     */
    GoogleEarthEnterpriseImageryProvider.prototype.isReady = function() {
        return this._ready;
    };
     ...
     * the source of the imagery.  This function should not be called before {@link GoogleEarthEnterpriseImageryProvider#isReady} returns true.
     *
     * @memberof GoogleEarthEnterpriseImageryProvider
     *
