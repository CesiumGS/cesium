define([
    ...
    function PostProcessBloomStage() {
        ...
        this._bloomFramebuffer = undefined;
    ...
    PostProcessBloomStage.prototype.execute = function(frameState, inputColorTexture, inputDepthTexture, dirty) {
        ...
        this._bloomPostProcess.execute(frameState, inputColorTexture, inputDepthTexture, this._bloomFramebuffer);
    };
    ...
    function createResources(stage, context) {
        ...
        var bloomFramebuffer = new Framebuffer({
            context : context,
            colorTextures : [bloomTexture],
        ...
        contrastBiasStage.show = true;
        bloomBlurXStage.show = true;
        bloomBlurYStage.show = true;

        stage._bloomTexture = bloomTexture;
        stage._bloomFramebuffer = bloomFramebuffer;
        stage._bloomPostProcess = bloomPostProcess;
        stage._uniformValues.bloomTexture = bloomTexture;
    }

    function destroyResources(stage) {
        stage._bloomTexture = stage._bloomTexture && stage._bloomTexture.destroy();
        stage._bloomFramebuffer = stage._bloomFramebuffer && stage._bloomFramebuffer.destroy();
