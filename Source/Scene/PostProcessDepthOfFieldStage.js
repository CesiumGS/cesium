define([
    ...
    PostProcessDepthOfFieldStage.prototype.execute = function(frameState, inputColorTexture, inputDepthTexture, dirty) {
        ...
        this._dofPostProcess.execute(frameState, inputColorTexture, inputDepthTexture, undefined);
        this._uniformValues.dofTexture = this._dofPostProcess.outputColorTexture;
    };
