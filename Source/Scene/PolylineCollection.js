...
define([
    ...
    PolylineCollection.prototype.update = function(context, frameState, commandList) {
        ...
        if (pass.pick) {
            ...
            createCommandLists(this, pickList, boundingVolume, modelMatrix, this._vertexArrays, this._rs, this._uniforms, false);
        }
    ...
    function createCommandLists(polylineCollection, commands, boundingVolume, modelMatrix, vertexArrays, renderState, uniforms, colorPass) {
