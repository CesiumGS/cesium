...
define([
     ...
     * @param {Boolean} [options.faceForward=true] When <code>true</code>, the fragment shader flips the surface normal as needed to ensure that the normal faces the viewer to avoid dark spots.  This is useful when both sides of a geometry should be shaded like {@link WallGeometry}.
    ...
    var EllipsoidSurfaceAppearance = function(options) {
         ...
         * @default true
         */
        this.faceForward = defaultValue(options.faceForward, true);
