define([
     ...
     * @param {Boolean} [options.cullRequestsWhileMovingMultiplier=0] Optimization option. Multiplier used in culling requests while moving. Setting to 0 will turn this feature off.
