define([
     ...
     * @param {Boolean} [options.cullRequestsWhileMovingMultiplier=0] Optimization option. Multiplier used in culling requests while moving. Setting to 0 will turn this feature off (default). 60 is reasonable.
    ...
    function Cesium3DTileset(options) {
        ...
        this.cullRequestsWhileMovingMultiplier = defaultValue(options.cullRequestsWhileMovingMultiplier, 0);
