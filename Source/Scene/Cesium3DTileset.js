define([
     ...
     * @param {String} [options.debugHeatmapVariable=undefined] The tile variable to colorize as a heatmap. All rendered tiles will be colorized relative to each other's specified variable value.
    ...
    function Cesium3DTileset(options) {
        ...
        this._heatmap = new Cesium3DTilesetHeatmap(options.debugHeatmapVariable);
