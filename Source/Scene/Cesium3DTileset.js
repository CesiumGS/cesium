 ...
 * @param {Boolean} [options.projectTo2D=false] Whether to accurately project the tileset to 2D. If this is false, the tileset will render in 2D / CV mode, but its positions may be inaccurate. This cannot be set after the tileset has loaded.
