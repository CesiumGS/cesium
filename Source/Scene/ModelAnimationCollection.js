...
define([
     ...
     *
     * @exception {DeveloperError} Animations are not loaded.  Wait for the {@link Model#readtPromise} to resolve.
    ...
    ModelAnimationCollection.prototype.add = function(options) {
        ...
        if (!defined(animations)) {
            throw new DeveloperError('Animations are not loaded.  Wait for the {@link Model#readtPromise} to resolve.');
        }
        //>>includeEnd('debug');
