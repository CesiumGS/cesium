...
define([
     ...
     * var startTime = C.JulianDate.now();
     *
     * var animation = model.activeAnimations.add({
     *   name : 'another animation name',
     *   startTime : startTime,
     *   delay : 0.0,                          // Play at startTime (default)
     *   stopTime : C.JulianDate.addSeconds(startTime, 4.0, new C.JulianDate()),
     *   removeOnStop : false,                 // Do not remove when animation stops (default)
     *   speedup : 2.0,                        // Play at double speed
     *   reverse : true,                       // Play in reverse
     *   loop : C.ModelAnimationLoop.REPEAT      // Loop the animation
     * });
     *
     ...
     *   loop : C.ModelAnimationLoop.REPEAT      // Loop the animations
     * });
     */
