...
function findUsedVariables(customShader) {
  ...
  if (defined(fragmentShaderText)) {
    ...
    var metadataRegex = /fsInput\.metadata\.(\w+)/g;
    var metadataSet = customShader.usedVariablesFragment.metadataSet;
    getVariables(fragmentShaderText, metadataRegex, metadataSet);
  }
}
