...
function processMaterialUniforms(material, uniformMap, shaderBuilder) {
  ...
  if (defined(emissiveTexture)) {
    shaderBuilder.addUniform("sampler2D", "u_emissiveTexture", ShaderDestination.FRAGMENT);
    uniformMap.u_emissiveTexture = function() {
      return material.emissiveTexture.texture;
    };
    texCoordIndex = emissiveTexture.texCoord;
    shaderBuilder.addDefine("HAS_EMISSIVE_TEXTURE", undefined, ShaderDestination.FRAGMENT);
  ...
  if (defined(normalTexture)) {
    shaderBuilder.addUniform("sampler2D", "u_normalTexture", ShaderDestination.FRAGMENT);
    uniformMap.u_normalTexture = function() {
      return material.normalTexture.texture;
    };
    texCoordIndex = normalTexture.texCoord;
    shaderBuilder.addDefine("HAS_NORMAL_TEXTURE", undefined, ShaderDestination.FRAGMENT);
    shaderBuilder.addDefine(
      "TEXCOORD_NORMAL",
      "v_texCoord_" + texCoordIndex,
      ShaderDestination.FRAGMENT
  ...
  if (defined(occlusionTexture)) {
    shaderBuilder.addUniform("sampler2D", "u_occlusionTexture", ShaderDestination.FRAGMENT);
    uniformMap.u_occlusionTexture = function() {
      return material.occlusionTexture.texture;
    };
    texCoordIndex = occlusionTexture.texCoord;
    shaderBuilder.addDefine("HAS_OCCLUSION_TEXTURE", undefined, ShaderDestination.FRAGMENT);
    shaderBuilder.addDefine(
      "TEXCOORD_OCCLUSION",
      "v_texCoord_" + texCoordIndex,
      ShaderDestination.FRAGMENT
...
function processSpecularGlossinessUniforms(material, uniformMap, shaderBuilder) {
  ...
  if (defined(specularGlossiness.diffuseTexture)) {
    shaderBuilder.addUniform("sampler2D", "u_diffuseTexture", ShaderDestination.FRAGMENT);
    ...
    shaderBuilder.addDefine("HAS_DIFFUSE_TEXTURE", undefined, ShaderDestination.FRAGMENT);
    shaderBuilder.addDefine(
      "TEXCOORD_DIFFUSE",
      "v_texCoord_" + texCoordIndex,
      ShaderDestination.FRAGMENT
  ...
  if (defined(specularGlossiness.specularGlossinessTexture)) {
    shaderBuilder.addUniform("sampler2D", "u_specularGlossinessTexture", ShaderDestination.FRAGMENT);
  ...
  if (defined(specularFactor)) {
    shaderBuilder.addUniform("vec3", "u_specularFactor", ShaderDestination.FRAGMENT);
...
function processMetallicRoughnessUniforms(material, uniformMap, shaderBuilder) {
  ...
  if (defined(metallicRoughnessTexture)) {
    shaderBuilder.addUniform("sampler2D", "u_metallicRoughnessTexture", ShaderDestination.FRAGMENT);
...
function addAlphaUniforms(material, uniformMap, shaderBuilder) {
  ...
  if (alphaMode === AlphaMode.MASK) {
    ...
    shaderBuilder.addDefine("ALPHA_MODE_OPAQUE", undefined, ShaderDestination.FRAGMENT);
  }
}