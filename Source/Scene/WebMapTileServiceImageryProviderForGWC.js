...
define([
     ...
     *
     * @alias WebMapTileServiceImageryProviderForGWC
     * @constructor
     *
	 ...
	 * @param {String} options.tileMatrixPrefix The Prefix of the tileMatrix to use for WMTS requests.
	 * @param {Number} [options.zoomOffset=0] If your cache has more levels than you want to provide access to with this layer, supply a zoomOffset.
     ...
     * var shadedRelief = new Cesium.WebMapTileServiceImageryProviderForGWC({
     ...
     */
    var WebMapTileServiceImageryProviderForGWC = function WebMapTileServiceImageryProviderForGWC(options) {
		...
		this._zoomOffset = defaultValue(options.zoomOffset,0);
		this._tileMatrixPrefix = defaultValue(options.tileMatrixPrefix,"");
    ...
    function buildImageUrl(imageryProvider, col, row, level) {
        var url = imageryProvider._url +
                  ...
                  "&TILEMATRIX="+ imageryProvider._tileMatrixPrefix + (level+imageryProvider._zoomOffset) +
    ...
    defineProperties(WebMapTileServiceImageryProviderForGWC.prototype, {
        /**
         * Gets the URL of the service hosting the imagery.
         * @memberof WebMapTileServiceImageryProviderForGWC.prototype
         * @type {String}
         */
        url : {
            get : function() {
         ...
         * not be called before {@link WebMapTileServiceImageryProviderForGWC#ready} returns true.
         * @memberof WebMapTileServiceImageryProviderForGWC.prototype
         * @type {Number}
         */
        tileWidth : {
         ...
         * the source of the imagery.  This function should not be called before {@link WebMapTileServiceImageryProviderForGWC#ready} returns true.
         * @memberof WebMapTileServiceImageryProviderForGWC.prototype
         * @type {Credit}
         */
        credit : {
     ...
     */
    WebMapTileServiceImageryProviderForGWC.prototype.getTileCredits = function(x, y, level) {
        return undefined;
    };
     ...
     */
    WebMapTileServiceImageryProviderForGWC.prototype.requestImage = function(x, y, level) {
        //>>includeStart('debug', pragmas.debug);
        if (!this._ready) {
     ...
     */
    WebMapTileServiceImageryProviderForGWC.prototype.pickFeatures = function() {
        return undefined;
    };

    return WebMapTileServiceImageryProviderForGWC;
});
