...
define([
    ...
    CustomTemplateImageryProvider.prototype.reinitialize = function(options) {
        ...
        that._readyPromise = when(options).then(function(properties) {
            ...
            that._colorPalette = defaultValue(properties.colorPalette);
            that._min = defaultValue(properties.min, 0);
            that._max = defaultValue(properties.max, 100);
    ...
    CustomTemplateImageryProvider.prototype.pickFeatures = function(x, y, level, longitude, latitude) {
        ...
        var format = this._getFeatureInfoFormats[0];

        return format.callback(x, y, level, longitude, latitude);
    };
    ...
    function minValTag(imageryProvider, x, y, level) {
        return padWithZerosIfNecessary(imageryProvider, '{min}', imageryProvider._min);
    }

    function maxValTag(imageryProvider, x, y, level) {
