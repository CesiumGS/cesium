 ...
 *   <li>To avoid cluttering the code, check the flag in as few places as possible. Ideally this would be a single place. See {@link getModelClass} for an example.</li>
 * </ul>
 *
 * @private
 */
