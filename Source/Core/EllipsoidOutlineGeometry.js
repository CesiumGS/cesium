...
define([
     ...
     *
     * @example
     * var ellipsoid = new C.EllipsoidOutlineGeometry({
     *   radii : new C.Cartesian3(1000000.0, 500000.0, 500000.0),
     *   stackPartitions: 6,
     *   slicePartitions: 5
     * });
     * var geometry = C.EllipsoidOutlineGeometry.createGeometry(ellipsoid);
     */
