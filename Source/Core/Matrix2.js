...
define([
     ...
     * var m = C.Matrix2.fromArray(v);
     *
     * // Create same Matrix2 with using an offset into an array
     * var v2 = [0.0, 0.0, 1.0, 1.0, 2.0, 2.0];
     * var m2 = C.Matrix2.fromArray(v2, 2);
     */
     ...
     * //   [7.0, 0.0]
     * //   [0.0, 8.0]
     * var m = C.Matrix2.fromScale(new C.Cartesian2(7.0, 8.0));
     */
     ...
     * //   [2.0, 0.0]
     * //   [0.0, 2.0]
     * var m = C.Matrix2.fromUniformScale(2.0);
     */
     ...
     * var p = new C.Cartesian2(5, 6);
     * var m = C.Matrix2.fromRotation(C.Math.toRadians(45.0));
     * var rotated = C.Matrix2.multiplyByVector(m, p);
     */
     ...
     *
     * @example
     * var myMatrix = new C.Matrix2();
     * var column1Row0Index = C.Matrix2.getElementIndex(1, 0);
