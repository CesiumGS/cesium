    ...
    'use strict';
        ...
        class Occluder {
            ...
            /**
                 ...
                 */
            static fromBoundingSphere(occluderBoundingSphere, cameraPosition, result) {
                //>>includeStart('debug', pragmas.debug);
                if (!defined(occluderBoundingSphere)) {
                    throw new DeveloperError('occluderBoundingSphere is required.');
                }
            ...
            /**
                 ...
                 * which is a boolean value.
                 */
            static computeOccludeePointFromRectangle(rectangle, ellipsoid) {
                //>>includeStart('debug', pragmas.debug);
            ...
            static _rotationVector(occluderPosition, occluderPlaneNormal, occluderPlaneD, position, anyRotationVector) {
            ...
            static _horizonToPlaneNormalDotProduct(occluderBS, occluderPlaneNormal, occluderPlaneD, anyRotationVector, position) {
