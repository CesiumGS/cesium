...
define([
     ...
     * var polygon = new C.PolygonOutlineGeometry({
     *   polygonHierarchy : {
     ...
     *   }
     * });
     * var geometry = C.PolygonOutlineGeometry.createGeometry(polygon);
     *
     * // 2. create a nested polygon with holes outline
     * var polygonWithHole = new C.PolygonOutlineGeometry({
     *   polygonHierarchy : {
     *     positions : C.Cartesian3.fromDegreesArray([
     *       -109.0, 30.0,
     *       -95.0, 30.0,
     ...
     *   }
     * });
     * var geometry = C.PolygonOutlineGeometry.createGeometry(polygonWithHole);
     *
     * // 3. create extruded polygon outline
     * var extrudedPolygon = new C.PolygonOutlineGeometry({
     *   positions : C.Cartesian3.fromDegreesArray([
     *     -72.0, 40.0,
     *     -70.0, 35.0,
     *     -75.0, 30.0,
     ...
     * });
     * var geometry = C.PolygonOutlineGeometry.createGeometry(extrudedPolygon);
     */
     ...
     * var polygon = C.PolygonOutlineGeometry.fromPositions({
     *   positions : C.Cartesian3.fromDegreesArray([
     *     -72.0, 40.0,
     *     -70.0, 35.0,
     *     -75.0, 30.0,
