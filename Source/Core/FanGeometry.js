...
define([
     ...
     *
     * @example
     * var fan = Cesium.FanGeometry.fromDimensions({
     *   vertexFormat : Cesium.VertexFormat.POSITION_ONLY,
     *   dimensions : new Cesium.Cartesian3(500000.0, 500000.0, 500000.0)
     * });
     * var geometry = Cesium.FanGeometry.createGeometry(fan);
     */
    FanGeometry.fromDimensions = function(options) {
        options = defaultValue(options, defaultValue.EMPTY_OBJECT);
        ...
        return new FanGeometry(newOptions);
    };
    ...
    FanGeometry.createGeometry = function(fanGeometry) {
        var min = fanGeometry._minimumCorner;
        var max = fanGeometry._maximumCorner;
