        ...
        class QuantizedMeshTerrainData {
            ...
            createMesh(tilingScheme, x, y, level, exaggeration) {
                ...
                return when(verticesPromise, function(result) {
                    ...
                    that._mesh = new TerrainMesh(rtc, vertices, indicesTypedArray, minimumHeight, maximumHeight, boundingSphere, occlusionPoint, stride, obb, terrainEncoding, exaggeration);
