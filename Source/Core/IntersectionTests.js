...
define([
     ...
     *
     * @example
     * var origin = C.Cartesian3.fromDegrees(-75.59777, 40.03883);
     * var normal = ellipsoid.geodeticSurfaceNormal(origin);
     * var plane = C.Plane.fromPointNormal(origin, normal);
     *
     * var p0 = new C.Cartesian3(...);
     * var p1 = new C.Cartesian3(...);
     *
     * // find the intersection of the line segment from p0 to p1 and the tangent plane at origin.
     * var intersection = C.IntersectionTests.lineSegmentPlane(p0, p1, plane);
     */
     ...
     * var p0 = new C.Cartesian3(...);
     * var p1 = new C.Cartesian3(...);
     * var p2 = new C.Cartesian3(...);
     *
     * // convert the triangle composed of points (p0, p1, p2) to three triangles that don't cross the plane
     * var triangles = C.IntersectionTests.trianglePlaneIntersection(p0, p1, p2, plane);
     */
