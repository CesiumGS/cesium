...
define([
     ...
     *        makes the request.
     * @returns {Promise.<Any>|undefined} Either undefined, meaning the request would exceed the maximum number of
     ...
     *
     * @param {String} url The url to request.
     * @returns {Promise.<Any>} A promise for the requested data.
     */
