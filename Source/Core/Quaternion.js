...
define([
     ...
     * var s0 = C.Quaternion.innerQuadrangle(quaternions[i - 1], quaternions[i], quaternions[i + 1]);
     * var s1 = C.Quaternion.innerQuadrangle(quaternions[i], quaternions[i + 1], quaternions[i + 2]);
     * var q = C.Quaternion.squad(quaternions[i], quaternions[i + 1], s0, s1, t);
     *
     * // 2. compute the squad interpolation as above but where the first quaternion is a end point.
     * var s1 = C.Quaternion.innerQuadrangle(quaternions[0], quaternions[1], quaternions[2]);
     * var q = C.Quaternion.squad(quaternions[0], quaternions[1], quaternions[0], s1, t);
     */
