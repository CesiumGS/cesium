...
define([
    ...
    LeapSecond.setLeapSeconds = function(data) {
        ...
        for ( var i = 0; i < numObjects; i++) {
            LeapSecond._leapSeconds.push(new LeapSecond(JulianDate.fromDate(new Date(data[i].date)), data[i].offset));
        }
    ...
    LeapSecond.getLeapSeconds = function() {
        if (!LeapSecond._leapSeconds) {
            LeapSecond._leapSeconds =
                [
                 new LeapSecond(new JulianDate(2441317, 43209.0, TimeStandard.TAI), 10), // January 1, 1972 00:00:00 UTC
                 new LeapSecond(new JulianDate(2441499, 43210.0, TimeStandard.TAI), 11), // July 1, 1972 00:00:00 UTC
                 new LeapSecond(new JulianDate(2441683, 43211.0, TimeStandard.TAI), 12), // January 1, 1973 00:00:00 UTC
                 new LeapSecond(new JulianDate(2442048, 43212.0, TimeStandard.TAI), 13), // January 1, 1974 00:00:00 UTC
                 new LeapSecond(new JulianDate(2442413, 43213.0, TimeStandard.TAI), 14), // January 1, 1975 00:00:00 UTC
                 new LeapSecond(new JulianDate(2442778, 43214.0, TimeStandard.TAI), 15), // January 1, 1976 00:00:00 UTC
                 new LeapSecond(new JulianDate(2443144, 43215.0, TimeStandard.TAI), 16), // January 1, 1977 00:00:00 UTC
                 new LeapSecond(new JulianDate(2443509, 43216.0, TimeStandard.TAI), 17), // January 1, 1978 00:00:00 UTC
                 new LeapSecond(new JulianDate(2443874, 43217.0, TimeStandard.TAI), 18), // January 1, 1979 00:00:00 UTC
                 new LeapSecond(new JulianDate(2444239, 43218.0, TimeStandard.TAI), 19), // January 1, 1980 00:00:00 UTC
                 new LeapSecond(new JulianDate(2444786, 43219.0, TimeStandard.TAI), 20), // July 1, 1981 00:00:00 UTC
                 new LeapSecond(new JulianDate(2445151, 43220.0, TimeStandard.TAI), 21), // July 1, 1982 00:00:00 UTC
                 new LeapSecond(new JulianDate(2445516, 43221.0, TimeStandard.TAI), 22), // July 1, 1983 00:00:00 UTC
                 new LeapSecond(new JulianDate(2446247, 43222.0, TimeStandard.TAI), 23), // July 1, 1985 00:00:00 UTC
                 new LeapSecond(new JulianDate(2447161, 43223.0, TimeStandard.TAI), 24), // January 1, 1988 00:00:00 UTC
                 new LeapSecond(new JulianDate(2447892, 43224.0, TimeStandard.TAI), 25), // January 1, 1990 00:00:00 UTC
                 new LeapSecond(new JulianDate(2448257, 43225.0, TimeStandard.TAI), 26), // January 1, 1991 00:00:00 UTC
                 new LeapSecond(new JulianDate(2448804, 43226.0, TimeStandard.TAI), 27), // July 1, 1992 00:00:00 UTC
                 new LeapSecond(new JulianDate(2449169, 43227.0, TimeStandard.TAI), 28), // July 1, 1993 00:00:00 UTC
                 new LeapSecond(new JulianDate(2449534, 43228.0, TimeStandard.TAI), 29), // July 1, 1994 00:00:00 UTC
                 new LeapSecond(new JulianDate(2450083, 43229.0, TimeStandard.TAI), 30), // January 1, 1996 00:00:00 UTC
                 new LeapSecond(new JulianDate(2450630, 43230.0, TimeStandard.TAI), 31), // July 1, 1997 00:00:00 UTC
                 new LeapSecond(new JulianDate(2451179, 43231.0, TimeStandard.TAI), 32), // January 1, 1999 00:00:00 UTC
                 new LeapSecond(new JulianDate(2453736, 43232.0, TimeStandard.TAI), 33), // January 1, 2006 00:00:00 UTC
                 new LeapSecond(new JulianDate(2454832, 43233.0, TimeStandard.TAI), 34), // January 1, 2009 00:00:00 UTC
                 new LeapSecond(new JulianDate(2456109, 43234.0, TimeStandard.TAI), 35)  // July 1, 2012 00:00:00 UTC
                 ];
        }
