    ...
    var scratchCart4 = new Cartesian4();
        ...
        class EllipsoidTangentPlane {
            ...
            /**
                 ...
                 */
            projectPointOntoPlane(cartesian, result) {
                //>>includeStart('debug', pragmas.debug);
            ...
            /**
                 ...
                 */
            projectPointsOntoPlane(cartesians, result) {
                //>>includeStart('debug', pragmas.debug);
            ...
            /**
                 ...
                 */
            projectPointsToNearestOnPlane(cartesians, result) {
                //>>includeStart('debug', pragmas.debug);
                Check.defined('cartesians', cartesians);
                //>>includeEnd('debug');
                if (!defined(result)) {
            ...
            /**
                 ...
                 */
            projectPointOntoEllipsoid(cartesian, result) {
                //>>includeStart('debug', pragmas.debug);
                Check.defined('cartesian', cartesian);
                //>>includeEnd('debug');
                if (!defined(result)) {
            ...
            /**
                 ...
                 */
            projectPointsOntoEllipsoid(cartesians, result) {
                //>>includeStart('debug', pragmas.debug);
                Check.defined('cartesians', cartesians);
                //>>includeEnd('debug');
                var length = cartesians.length;
