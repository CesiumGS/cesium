...
define([
     ...
     *     controlPoints[i].tangent = Cartesian3.subtract(controlPoints[i + 1].point, controlPoints[i - 1].point).multiplyByScalar(0.5);
     * }
    ...
    function generateClamped(hermiteSpline) {
        ...
        for (i = 1; i < l.length - 1; ++i) {
            l[i] = u[i] = 1.0;
            d[i] = 4.0;
            r[i] = Cartesian3.subtract(hermiteSpline._points[i + 1].point, hermiteSpline._points[i - 1].point).multiplyByScalar(3.0);
        }
        l[i] = 0.0;
        u[i] = 1.0;
        d[i] = 4.0;
    ...
    function generateNatural(hermiteSpline){
        ...
        l[0] = u[0] = 1.0;
        d[0] = 2.0;
        r[0] = Cartesian3.subtract(hermiteSpline._points[1].point, hermiteSpline._points[0].point).multiplyByScalar(3.0);
        ...
        d[i] = 2.0;
        r[i] = Cartesian3.subtract(hermiteSpline._points[i].point, hermiteSpline._points[i - 1].point).multiplyByScalar(3.0);
