...
define([
     ...
     * var timeInterval = new C.TimeInterval({
     *     start : C.JulianDate.fromIso8601('1980-08-01T00:00:00Z'),
     *     stop : C.JulianDate.fromIso8601('1980-08-02T00:00:00Z'),
     *     isStartTimeIncluded : true,
     *     iSStopTimeIncluded : false,
     *     data : C.Cartesian.fromDegrees(39.921037, -75.170082)
     * });
     *
     * @example
     * // Create two instances from ISO 8601 intervals with associated numeric data
     * // then compute their intersection, summing the data they contain.
     * var left = C.TimeInterval.fromIso8601({
     *     iso8601 : '2000/2010',
     *     data : 2
     * });
     *
     * var right = C.TimeInterval.fromIso8601({
     *     iso8601 : '1995/2005',
     *     data : 3
     * });
     *
     * //The result of the below intersection will be an interval equivalent to
     * //var intersection = C.TimeInterval.fromIso8601({
     * //  iso8601 : '2000/2005',
     * //  data : 5
     * //});
     * var intersection = new C.TimeInterval();
     * C.TimeInterval.intersect(left, right, intersection, function(leftData, rightData) {
     *     return leftData + rightData;
     * });
     *
     * @example
     * // Check if an interval contains a specific time.
     * var dateToCheck = C.JulianDate.fromIso8601('1982-09-08T11:30:00Z');
     * var containsDate = C.TimeInterval.contains(timeInterval, dateToCheck);
     */
