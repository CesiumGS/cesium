    ...
    'use strict';
        ...
        class TimeInterval {
            ...
            /**
                 ...
                 * @returns {TimeInterval} The modified result parameter or a new instance if none was provided.
                 */
            static fromIso8601(options, result) {
            ...
            /**
                 ...
                 */
            static toIso8601(timeInterval, precision) {
                //>>includeStart('debug', pragmas.debug);
            ...
            /**
                 ...
                 * @returns {TimeInterval} The modified result parameter or a new instance if none was provided.
                 */
            static clone(timeInterval, result) {
            ...
            /**
                 ...
                 */
            static equals(left, right, dataComparer) {
                return left === right ||
            ...
            /**
                 ...
                 */
            static equalsEpsilon(left, right, epsilon, dataComparer) {
                //>>includeStart('debug', pragmas.debug);
            ...
            /**
                 ...
                 */
            static intersect(left, right, result, mergeCallback) {
                //>>includeStart('debug', pragmas.debug);
            ...
            /**
                 ...
                 */
            static contains(timeInterval, julianDate) {
                //>>includeStart('debug', pragmas.debug);
                Check.typeOf.object('timeInterval', timeInterval);
