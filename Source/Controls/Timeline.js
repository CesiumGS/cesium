...
define(['./TimelineTrack',
        ...
        '../Core/ClockRange',
        '../Core/JulianDate'],
        function (TimelineTrack, TimelineHighlightRange, Clock, ClockRange, JulianDate) {
            "use strict";
            ...
            Timeline.prototype.zoomTo = function(startJulianDate, endJulianDate) {
                ...
                if (this._clock && (this._clock.clockRange !== ClockRange.UNBOUNDED)) {
                    var clockStart = this._clock.startTime, clockEnd = this._clock.stopTime, clockSpan = clockStart.getSecondsDifference(clockEnd), startOffset = this._startJulian
                            .getSecondsDifference(clockStart), endOffset = this._endJulian.getSecondsDifference(clockEnd);
