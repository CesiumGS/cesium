...
var StbDecoderModule = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  return (
function(StbDecoderModule) {
  StbDecoderModule = StbDecoderModule || {};
...
var Module = typeof StbDecoderModule !== 'undefined' ? StbDecoderModule : {};
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'stbi_decode.wast';
  var wasmBinaryFile = 'stbi_decode.wasm';
  var asmjsCodeFile = 'stbi_decode.temp.asm.js';
...
Module['wasmTableSize'] = 51;

Module['wasmMaxTableSize'] = 51;

Module.asmGlobalArg = {};

Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_iiiiii": nullFunc_iiiiii, "nullFunc_vii": nullFunc_vii, "nullFunc_viii": nullFunc_viii, "nullFunc_viiiiii": nullFunc_viiiiii, "___assert_fail": ___assert_fail, "___lock": ___lock, "___setErrNo": ___setErrNo, "___syscall140": ___syscall140, "___syscall146": ___syscall146, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___unlock": ___unlock, "_emscripten_memcpy_big": _emscripten_memcpy_big, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
...
// {{MODULE_ADDITIONS}}
  ...
  return StbDecoderModule;
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
    module.exports = StbDecoderModule;
  else if (typeof define === 'function' && define['amd'])
    define([], function() { return StbDecoderModule; });
  else if (typeof exports === 'object')
    exports["StbDecoderModule"] = StbDecoderModule;
