    ...
    describe("RenderState", function () {
        ...
        it("creates with all render states", function () {
            var r = {
                ...
                depthTest : {
                    enabled : true,
                    func    : Cesium.DepthFunction.GREATER
                },
                ...
                blending : {
                    ...
                    functionSourceRgb        : Cesium.BlendFunction.ZERO,
                    functionSourceAlpha      : Cesium.BlendFunction.ZERO,
                    functionDestinationRgb   : Cesium.BlendFunction.ONE,
                    functionDestinationAlpha : Cesium.BlendFunction.ONE
                },
                stencilTest : {
                    enabled        : true,
                    frontFunction  : Cesium.StencilFunction.NEVER,
