(function() {
    ...
    describe("ShaderCache", function () {
        ...
        it("adds and removes", function() {
            ...
            var cache = new Cesium.ShaderCache(context);
            var sp = cache.getShaderProgram(vs, fs, { position : 0});
        ...
        it("has a cache hit", function() {
            ...
            var cache = new Cesium.ShaderCache(context);
            var sp = cache.getShaderProgram(vs, fs, { position : 0});
            var sp2 = cache.getShaderProgram(vs, fs, { position : 0});
        ...
        it("avoids thrashing", function() {
            ...
            var sp = cache.getShaderProgram(vs, fs, { position : 0});
            sp.release();
            var sp2 = cache.getShaderProgram(vs, fs, { position : 0});  // still cache hit
