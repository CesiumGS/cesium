(function() {
    ...
    describe("Ray", function () {
        ...
        function renderFragment(context, fs) {
            var fsSource = Cesium._shaders.Ray + "#line 0\n" + fs;
        ...
        it("agi_intersect: no intersection 0", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_isEmpty(agi_intersection(" + 
                "  agi_raySegment(1.0, 2.0), agi_raySegment(3.0, 4.0)))); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });        
        ...
        it("agi_intersect: no intersection 1", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_isEmpty(agi_intersection(" + 
                "  agi_raySegment(3.0, 4.0), agi_raySegment(1.0, 2.0)))); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_intersect: no intersection 2", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_isEmpty(agi_intersection(" + 
                "  agi_raySegment(-2.0, -1.0), agi_raySegment(3.0, 4.0)))); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_intersect: intersection 0", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_intersection(" + 
                "  agi_raySegment(1.0, 2.0), agi_raySegment(1.0, 2.0)) == agi_raySegment(1.0, 2.0)); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_intersect: intersection 1", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_intersection(" + 
                "  agi_raySegment(1.0, 3.0), agi_raySegment(2.0, 4.0)) == agi_raySegment(2.0, 3.0)); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_intersect: intersection 2", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_intersection(" + 
                "  agi_raySegment(1.0, 2.0), agi_raySegment(2.0, 3.0)) == agi_raySegment(2.0, 2.0)); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_intersect: intersection 3", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_intersection(" + 
                "  agi_raySegment(1.0, 4.0), agi_raySegment(2.0, 3.0)) == agi_raySegment(2.0, 3.0)); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_intersect: intersection 4", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_intersection(" + 
                "  agi_raySegment(2.0, 3.0), agi_raySegment(1.0, 4.0)) == agi_raySegment(2.0, 3.0)); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });          
        ...
        it("agi_intersect: intersection 5", function () {
            var fs = 
                "void main() {" +
                "gl_FragColor = vec4(agi_intersection(" + 
                "  agi_raySegment(-3.0, 3.0), agi_raySegment(-1.0, 1.0)) == agi_raySegment(-1.0, 1.0)); }";
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_subtract: inner inside outer", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
        ...
        it("agi_subtract: inner inside outer on right boundary", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(3.0, 4.0));" +
        ...
        it("agi_subtract: inner equals outer", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(1.0, 4.0));" +
        ...
        it("agi_subtract: inner is greater than outer", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(0.0, 5.0));" +
                "gl_FragColor = vec4(i.count == 0); }"; 
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        }); 
        ...
        it("agi_subtract: inner overlaps outer at left boundary", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(0.0, 2.0));" +
                "gl_FragColor = vec4((i.intervals[0] == agi_raySegment(2.0, 4.0)) && (i.count == 1)); }"; 
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_subtract: inner overlaps outer at right boundary", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(3.0, 5.0));" +
                "gl_FragColor = vec4((i.intervals[0] == agi_raySegment(1.0, 3.0)) && (i.count == 1)); }"; 
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_subtract: inner touches at left boundary", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(0.0, 1.0));" +
        ...
        it("agi_subtract: inner touches at right boundary", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(4.0, 5.0));" +
                "gl_FragColor = vec4((i.intervals[0] == agi_raySegment(1.0, 4.0)) && (i.count == 1)); }"; 
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
        ...
        it("agi_subtract: inner is to the left of outer", function () {
            var fs = 
                "void main() {" +
                "agi_raySegmentCollection i = agi_subtraction(" +
                "  agi_raySegment(1.0, 4.0), agi_raySegment(-1.0, 0.0));" +
                "gl_FragColor = vec4((i.intervals[0] == agi_raySegment(1.0, 4.0)) && (i.count == 1)); }"; 
            expect(renderFragment(context, fs)).toEqualArray([255, 255, 255, 255]);
        });
