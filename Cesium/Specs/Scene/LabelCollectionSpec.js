(function() {
    ...
    describe("LabelCollection", function () {
        ...
        it("default constructs a label", function () {
            ...
            expect(l.getPosition().equals(Cesium.Cartesian3.getZero())).toBeTruthy();
        ...
        it("explicitly constructs a label", function () {
            var l = labels.add({
                ...
                text : "abc",
                font : "24px Helvetica",
                fillColor : { red : 2.0, green : 3.0, blue : 4.0, alpha : 1.0 },
                outlineColor : { red : 3.0, green : 4.0, blue : 2.0, alpha : 1.0 },
            ...
            expect(l.getPosition().equals(new Cesium.Cartesian3(1.0, 2.0, 3.0))).toBeTruthy();
        ...
        it("sets a labels's properties", function () {
            ...
            l.setFillColor({ red : 2.0, green : 3.0, blue : 4.0, alpha : 1.0 });
            l.setOutlineColor({ red : 3.0, green : 4.0, blue : 2.0, alpha : 1.0 });
            l.setStyle(Cesium.LabelStyle.FILL_AND_OUTLINE);
            l.setPixelOffset(new Cesium.Cartesian2(1.0, 2.0));
            l.setEyeOffset(new Cesium.Cartesian3(1.0, 2.0, 3.0));
            l.setHorizontalOrigin(Cesium.HorizontalOrigin.LEFT);
            l.setVerticalOrigin(Cesium.VerticalOrigin.BOTTOM);
            l.setScale(2.0);
        ...
        it("doesn't render when constructed", function () {
            ...
            labels.update(context, Cesium.Specs.sceneState);
        ...
        it("modifies and removes a label, then renders", function () {
            ...
            expect((p[3] === 0) ||
                   (p[3] === 255)).toBeTruthy();     // ANGLE Workaround:  Blending or texture alpha channel is buggy
        });
        ...
        it("renders with a different buffer usage", function () {
            ...
            labels.bufferUsage = Cesium.BufferUsage.STREAM_DRAW;
            labels.update(context, Cesium.Specs.sceneState);
            labels.render(context, us);
            expect(context.readPixels()).not.toEqualArray([0, 0, 0, 0]);
        });
        ...
        it("renders using label's position property", function () {
            ...
            l.setPosition({ x : -2.0, y : 0.0, z : 0.0 });  // Behind viewer
            labels.update(context, Cesium.Specs.sceneState);
            labels.render(context, us);
            expect(context.readPixels()).toEqualArray([0, 0, 0, 0]);

            l.setPosition({ x : 0.0, y : 0.0, z : 0.0 });  // Back in front of viewer
            labels.update(context, Cesium.Specs.sceneState);
            labels.render(context, us);
            expect(context.readPixels()).not.toEqualArray([0, 0, 0, 0]);
        });
        ...
        it("is picked", function () {
            ...
            var pickedObject = Cesium.Specs.pick(context, labels, 0, 0);
        ...
        it("computes screen space position (1)", function () {
            ...
            expect(l.computeScreenSpacePosition(us).equals(new Cesium.Cartesian2(0.5, 0.5)));
        });
        ...
        it("computes screen space position (2)", function () {
            ...
            expect(l.computeScreenSpacePosition(us).equals(new Cesium.Cartesian2(1.5, 2.5)));
        });
        ...
        it("cache should have distinct entries", function () {
            ...
            label.setStyle(Cesium.LabelStyle.OUTLINE);
            expect(labels._canvasContainer.getItems().length).toEqual(9);
            label.setFillColor({ red : 1.0, green : 165.0/255.0, blue : 0.0, alpha : 1.0 });
            expect(labels._canvasContainer.getItems().length).toEqual(12);
            label.setOutlineColor({ red : 1.0, green : 1.0, blue : 1.0, alpha : 1.0 });
            expect(labels._canvasContainer.getItems().length).toEqual(15);
            label.setVerticalOrigin(Cesium.VerticalOrigin.CENTER);
        ...
        it("pixelOffsets of billboards should should be correct when verticalOrigin is changed", function () {
            ...
            label.setVerticalOrigin(Cesium.VerticalOrigin.TOP);
        ...
        it("pixelOffsets of billboards should should be correct when verticalOrigin, scale and pixelOffset are changed", function () {
            ...
            label.setPixelOffset({x:10,y:10});
            label.setScale(2);
        ...
        it("pixelOffset should equal if set by constructor or properties", function () {
            ...
            propLabel.setVerticalOrigin(Cesium.VerticalOrigin.CENTER);
            propLabel.setPixelOffset({x:10, y:15});
