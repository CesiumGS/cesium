(function() {
    ...
    describe("MeshFilters", function () {
        ...
        it("creates attribute indices", function () {
            ...
            var indices = Cesium.MeshFilters.createAttributeIndices(mesh);
        ...
        it("maps attribute indices to different names", function () {
            ...
            var mappedIndices = Cesium.MeshFilters.mapAttributeIndices(indices, {
                positions : "position",
                normals   : "normal",
                colors    : "color"
            });
        ...
        it("throws an exception when mesh properties have a different number of attributes", function() {
            expect(function() {
                ...
                mesh = Cesium.MeshFilters.reorderForPreVertexCache(mesh);
            }).toThrow();
        });
        ...
        it("can reorder all indices and attributes for the pre vertex cahce", function () {
            ...
            Cesium.MeshFilters.reorderForPreVertexCache(mesh);
        ...
        it("can reorder indices for the post vertex cache", function () {
            var mesh = Cesium.CubeMapEllipsoidTessellator.compute(new Cesium.Ellipsoid(new Cesium.Cartesian3(10.0, 10.0, 10.0)), 100);
            ...
            var ACMRbefore = Cesium.Tipsify.calculateACMR(indices, maximumIndex, 24);
            expect(ACMRbefore).toBeGreaterThan(1.00);
            mesh = Cesium.MeshFilters.reorderForPostVertexCache(mesh);
            indices = mesh.indexLists[0].values;
            var ACMRafter = Cesium.Tipsify.calculateACMR(indices, maximumIndex, 24);
        ...
        it("fitToUnsignedShortIndices doesn't change mesh", function () {
            ...
            var meshes = Cesium.MeshFilters.fitToUnsignedShortIndices(mesh);
        ...
        it("fitToUnsignedShortIndices creates one mesh", function () {
                ...
                indexLists : [
                    {
                        ...
                        values : [
                            0, 0, 0,
                            sixtyFourK, sixtyFourK, sixtyFourK,
                            0, sixtyFourK, 0
                        ]
                    }
                ]
            ...
            expect(meshes.length).toEqual(1);
            expect(meshes[0].attributes.time.componentDatatype).toEqual(Cesium.ComponentDatatype.FLOAT);
            ...
            expect(meshes[0].indexLists[0].primitiveType).toEqual(Cesium.PrimitiveType.TRIANGLES);
        ...
        it("fitToUnsignedShortIndices throws without triangles", function () {
            ...
            expect(function() {
                return Cesium.MeshFilters.fitToUnsignedShortIndices(mesh);
            }).toThrow();
        });
