(function () {
    ...
    describe("CachePolicy", function () {
        describe("LRU", function () {
            var Cache = Cesium.Cache;
            var LRU = Cesium.CachePolicy.LRU;

            var Key = function (value) {
                this.x = value;
                this.getKey = function () { return this.x.toString(); };
            };
            ...
            it("constructor throws on invalid fetch function", function () {
                ...
                expect(function () {
                    return new LRU({ fetchFunc : "not-a-function" });
                }).toThrow();
            });
