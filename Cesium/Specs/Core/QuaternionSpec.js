( function() {
    ...
    describe("Quaternion", function () {
        ...
        it("unitInverseEqualsConjugate", function () {
            var s = Math.sin(Cesium.Math.PI_OVER_FOUR);
            var c = Math.cos(Cesium.Math.PI_OVER_FOUR);
        ...
        it("rotate", function () {
            ...
            expect(q.rotate(xAxis).equalsEpsilon(yAxis, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("getAxis", function () {
            ...
            expect(q.getAxis().equals(Cesium.Cartesian3.getZero())).toBeTruthy();
        });
        ...
        it("getAngle", function () {
            ...
            var cartesian = new Cartesian3(0.0, 0.0, 1.0).multiplyWithScalar(s);
            var q = new Quaternion(cartesian.x, cartesian.y, cartesian.z, c);
            expect(q.getAngle()).toEqual(Cesium.Math.PI_OVER_TWO);
            q = new Quaternion(4.0, 3.0, 2.0, 1.0);
            expect(q.getAngle() === 0.0).toBeTruthy();
        });
        
        it("toRotationMatrix", function () {
            var sPiOver4 = Math.sin(Cesium.Math.PI_OVER_FOUR);
            var cPiOver4 = Math.cos(Cesium.Math.PI_OVER_FOUR);
            var sPiOver2 = Math.sin(Cesium.Math.PI_OVER_TWO);
            var cPiOver2 = Math.cos(Cesium.Math.PI_OVER_TWO);
            var q = new Quaternion(new Cartesian3(0.0, 0.0, 1.0).multiplyWithScalar(sPiOver4), cPiOver4);
            var rotation = new Matrix3(
                cPiOver2, -sPiOver2, 0.0,
                sPiOver2,  cPiOver2, 0.0,
                0.0,            0.0, 1.0
            );
            expect(q.toRotationMatrix().equalsEpsilon(rotation, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("slerp", function () {
           ...
           var cartesian1 = new Cartesian3(0.0, 0.0, Math.sin(Cesium.Math.PI_OVER_FOUR));
           var r = new Quaternion(cartesian1.x, cartesian1.y, cartesian1.z, Math.cos(Cesium.Math.PI_OVER_FOUR));
           ...
           expect(q.slerp(0.5, r).equalsEpsilon(s, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("log", function () {
            ...
            var cartesian = new Cartesian3(0.0, 0.0, 1.0).multiplyWithScalar(s);
            var q = new Quaternion(cartesian.x, cartesian.y, cartesian.z, c);
            expect(q.log().equals(new Cartesian3(0.0, 0.0, Cesium.Math.PI_OVER_FOUR)));
        });
        ...
        it("power", function () {
            ...
            var u = t.power(2.0);
            var v = t.multiply(t);
            expect(u.equalsEpsilon(v, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("fromAxisAngle", function () {
            ...
            var theta = Cesium.Math.PI_OVER_TWO;
        ...
        it("fromRotationMatrix (1)", function () {
            ...
            var zRotation = new Matrix3(
                cTheta, -sTheta, 0.0,
                sTheta,  cTheta, 0.0,
                   0.0,     0.0, 1.0
            );
            expect(Quaternion.fromRotationMatrix(zRotation).equalsEpsilon(q, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("fromRotationMatrix (2)", function () {
            ...
            var yRotation = new Matrix3(
                cTheta,  0.0, sTheta,
                0.0,     1.0,    0.0,
                -sTheta, 0.0, cTheta
            );
            expect(Quaternion.fromRotationMatrix(yRotation).equalsEpsilon(q, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("fromRotationMatrix (3)", function () {
            ...
            var xRotation = new Matrix3(
                1.0,    0.0,     0.0,
                0.0, cTheta, -sTheta,
                0.0, sTheta,  cTheta
            );
            expect(Quaternion.fromRotationMatrix(xRotation).equalsEpsilon(q, Cesium.Math.EPSILON15)).toBeTruthy();
        });
        ...
        it("exp", function () {
            ...
            var cartesian = new Cartesian3(0.0, 0.0, 1.0).multiplyWithScalar(s);
            var q = new Quaternion(cartesian.x, cartesian.y, cartesian.z, c);
            expect(Quaternion.exp(new Cartesian3(0.0, 0.0, Cesium.Math.PI_OVER_FOUR)).equals(q)).toBeTruthy();
        });
        
        it("matrixAndQuaternionfromAxisAngle", function () {
           var axis = new Cartesian3(1.0, 2.0, 3.0);
           var angle = 2.0 * Cesium.Math.PI_OVER_THREE;
           var m = Matrix3.fromAxisAngle(axis, angle);
           var n = Quaternion.fromAxisAngle(axis, angle).toRotationMatrix();
           expect(m.equalsEpsilon(n, Cesium.Math.EPSILON15)).toBeTruthy();
        });
    });
}());
