( function() {
   ...
   var EventHandler = Cesium.EventHandler;
   var EventModifier = Cesium.EventModifier;
   var MouseEventType = Cesium.MouseEventType;
   ...
   describe("EventHandler", function() {
       ...
       it("key events", function () {
           ...
           element.fireEvents("keydown", { keyCode : 'a'.charCodeAt(0) });
       ...
       it("modified key events", function () {
           ...
           element.fireEvents("keydown", { keyCode : 'b'.charCodeAt(0), ctrlKey : true });
       ...
       it("mouse right down", function () {
           var actualCoords = new Cesium.Cartesian2(0, 0);
           var expectedCoords = new Cesium.Cartesian2(1, 1);
           ...
           element.fireEvents("mousedown", {button : 2,  clientX : 1, clientY : 1 });
           ...
           element.fireEvents("mousedown", {button : 2,  clientX : 2, clientY : 2 });
       ...
       it("mouse right up", function () {
           ...
           element.fireEvents("mouseup", {button : 2,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
       ...
       it("mouse right click", function () {
           ...
           element.fireEvents("mousedown", {button : 2,  clientX : 2, clientY : 2 });
           element.fireEvents("mouseup", {button : 2,  clientX : 2, clientY : 2 });
       ...
       it("mouse left down", function () {
           ...
           element.fireEvents("mousedown", {button : 0,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("mousedown", {button : 0,  clientX : 2, clientY : 2 });
       ...
       it("mouse left up", function () {
           ...
           element.fireEvents("mouseup", {button : 0,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
       ...
       it("mouse left click", function () {
           ...
           element.fireEvents("mousedown", {button : 0,  clientX : 2, clientY : 2 });
           element.fireEvents("mouseup", {button : 0,  clientX : 2, clientY : 2 });
       ...
       it("mouse middle down", function () {
           ...
           element.fireEvents("mousedown", {button : 1,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("mousedown", {button : 1,  clientX : 2, clientY : 2 });
       ...
       it("mouse middle up", function () {
           ...
           element.fireEvents("mouseup", {button : 1,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
       ...
       it("mouse middle click", function () {
           ...
           element.fireEvents("mousedown", {button : 1,  clientX : 2, clientY : 2 });
           element.fireEvents("mouseup", {button : 1,  clientX : 2, clientY : 2 });
       ...
       it("mouse left double click", function () {
           ...
           element.fireEvents("dblclick", {button : 0,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("dblclick", {button : 0,  clientX : 2, clientY : 2 });
       ...
       it("mouse right double click", function () {
           ...
           element.fireEvents("dblclick", {button : 2,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("dblclick", {button : 2,  clientX : 2, clientY : 2 });
       ...
       it("mouse middle double click", function () {
           ...
           element.fireEvents("dblclick", {button : 1,  clientX : 1, clientY : 1 });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("dblclick", {button : 1,  clientX : 2, clientY : 2 });
       ...
       it("mouse move", function () {
           var actualMove = {
               ...
               endPosition : new Cesium.Cartesian2(0, 0)
           };
           var expectedMove = {
               startPosition : new Cesium.Cartesian2(1, 1),
               endPosition : new Cesium.Cartesian2(2, 2)
            };
           ...
           element.fireEvents("mousemove", {button : 1,  clientX : 1, clientY : 1});
           element.fireEvents("mousemove", {button : 1, clientX : 2, clientY : 2});
           ...
           element.fireEvents("mousemove", {button : 1,  clientX : 2, clientY : 2 });
           element.fireEvents("mousemove", {button : 1, clientX : 3, clientY : 3});
       ...
       it("mouse wheel", function() {
           ...
           element.fireEvents("mousewheel", {wheelDelta : -120});
           ...
           element.fireEvents("mousewheel", {wheelDelta : -360});
       ...
       it("modified mouse right down", function () {
           ...
           element.fireEvents("mousedown", {button : 2,  clientX : 1, clientY : 1, shiftKey : true });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("mousedown", {button : 2,  clientX : 2, clientY : 2, shiftKey : true });
       ...
       it("modified mouse right up", function () {
           ...
           element.fireEvents("mouseup", {button : 2,  clientX : 1, clientY : 1, shiftKey : true });
           expect(actualCoords).toEqual(expectedCoords);
       ...
       it("modified mouse right click", function () {
           ...
           element.fireEvents("mousedown", {button : 2,  clientX : 2, clientY : 2, shiftKey : true });
           element.fireEvents("mouseup", {button : 2,  clientX : 2, clientY : 2, shiftKey : true });
       ...
       it("modified mouse left down", function () {
           ...
           element.fireEvents("mousedown", {button : 0,  clientX : 1, clientY : 1, altKey : true });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("mousedown", {button : 0,  clientX : 2, clientY : 2, altKey : true });
       ...
       it("modified mouse left up", function () {
           ...
           element.fireEvents("mouseup", {button : 0,  clientX : 1, clientY : 1, altKey : true });
           expect(actualCoords).toEqual(expectedCoords);
       ...
       it("modified mouse left click", function () {
           ...
           element.fireEvents("mousedown", {button : 0,  clientX : 2, clientY : 2, altKey : true });
           element.fireEvents("mouseup", {button : 0,  clientX : 2, clientY : 2, altKey : true });
       ...
       it("modified mouse middle down", function () {
           ...
           element.fireEvents("mousedown", {button : 1,  clientX : 1, clientY : 1, ctrlKey : true });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("mousedown", {button : 1,  clientX : 2, clientY : 2, ctrlKey : true });
       ...
       it("modified mouse middle up", function () {
           ...
           element.fireEvents("mouseup", {button : 1,  clientX : 1, clientY : 1, ctrlKey : true });
           expect(actualCoords).toEqual(expectedCoords);
       ...
       it("modified mouse middle click", function () {
           ...
           element.fireEvents("mousedown", {button : 1,  clientX : 2, clientY : 2, ctrlKey : true });
           element.fireEvents("mouseup", {button : 1,  clientX : 2, clientY : 2, ctrlKey : true });
       ...
       it("modified mouse left double click", function () {
           ...
           element.fireEvents("dblclick", {button : 0,  clientX : 1, clientY : 1, ctrlKey : true });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("dblclick", {button : 0,  clientX : 2, clientY : 2, ctrlKey : true });
       ...
       it("modified mouse right double click", function () {
           ...
           element.fireEvents("dblclick", {button : 2,  clientX : 1, clientY : 1, ctrlKey : true });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("dblclick", {button : 2,  clientX : 2, clientY : 2, ctrlKey : true });
       ...
       it("modified mouse middle double click", function () {
           ...
           element.fireEvents("dblclick", {button : 1,  clientX : 1, clientY : 1, ctrlKey : true });
           expect(actualCoords).toEqual(expectedCoords);
           ...
           element.fireEvents("dblclick", {button : 1,  clientX : 2, clientY : 2, ctrlKey : true });
       ...
       it("modified mouse move", function () {
           ...
           element.fireEvents("mousemove", {button : 1,  clientX : 1, clientY : 1, ctrlKey : true});
           element.fireEvents("mousemove", {button : 1, clientX : 2, clientY : 2, ctrlKey : true});
           expect(actualMove).toEqual(expectedMove);
           ...
           element.fireEvents("mousemove", {button : 1,  clientX : 2, clientY : 2, ctrlKey : true });
           element.fireEvents("mousemove", {button : 1, clientX : 3, clientY : 3, ctrlKey : true});
       ...
       it("modified mouse wheel", function() {
           ...
           element.fireEvents("mousewheel", {wheelDelta : -120, ctrlKey : true});
           expect(actualDelta).toEqual(expectedDelta);
           ...
           element.fireEvents("mousewheel", {wheelDelta : -360, ctrlKey : true});
