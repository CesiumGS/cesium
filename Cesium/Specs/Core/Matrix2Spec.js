(function() {
    ...
    describe("Matrix2", function () {
        ...
        it("creates a non-uniform scale matrix", function() {
            var m = Matrix2.createNonUniformScale(new Cesium.Cartesian2(1, 2));

            expect(m.getColumn0().equals(new Cesium.Cartesian2(1, 0))).toBeTruthy();
            expect(m.getColumn1().equals(new Cesium.Cartesian2(0, 2))).toBeTruthy();
        });

        it("creates a uniform scale matrix", function() {
            var m0 = Matrix2.createScale(2);
            var m1 = Matrix2.createNonUniformScale(new Cesium.Cartesian2(2, 2));
        ...
        it("gets individual columns", function () {
            ...
            expect(m.getColumn0().equals(new Cesium.Cartesian2(1, 4))).toBeTruthy();
            expect(m.getColumn1().equals(new Cesium.Cartesian2(2, 5))).toBeTruthy();
        });

        it("gets individual columns 2", function () {
            expect(Matrix2.getIdentity().getColumn0().equals(Cesium.Cartesian2.getUnitX())).toBeTruthy();
            expect(Matrix2.getIdentity().getColumn1().equals(Cesium.Cartesian2.getUnitY())).toBeTruthy();
        });

        it("sets individual columns", function () {
            var m = new Matrix2();
            var c0 = new Cesium.Cartesian2(1, 2);
            var c1 = new Cesium.Cartesian2(3, 4);
        ...
        it("gets individual rows", function () {
            ...
            expect(m.getRow0().equals(new Cesium.Cartesian2(1, 2))).toBeTruthy();
            expect(m.getRow1().equals(new Cesium.Cartesian2(3, 4))).toBeTruthy();
        });

        it("gets individual rows 2", function () {
            expect(Matrix2.getIdentity().getRow0().equals(Cesium.Cartesian2.getUnitX())).toBeTruthy();
            expect(Matrix2.getIdentity().getRow1().equals(Cesium.Cartesian2.getUnitY())).toBeTruthy();
        });
