(function() {
    ...
    describe("Occluder", function () {
        var Cartesian3 = Cesium.Cartesian3;
        var BoundingSphere = Cesium.BoundingSphere;
        var Occluder = Cesium.Occluder;
        ...
        it("can throw errors during getOccludeePoint (1 of 5)", function () {
            expect(function() {
                Cesium.Occluder.getOccludeePoint();
            }).toThrow();
        });
        ...
        it("can throw errors during getOccludeePoint (2 of 5)", function () {
            ...
            expect(function() {
                Cesium.Occluder.getOccludeePoint(occluderBS, occludeePosition, positions);
            }).toThrow();
        });
        ...
        it("can throw errors during getOccludeePoint (3 of 5)", function () {
            ...
            expect(function() {
                Cesium.Occluder.getOccludeePoint(occluderBS, new Cartesian3(0, 0, -3), positions);
            }).toThrow();
        });
        ...
        it("can throw errors during getOccludeePoint (4 of 5)", function () {
            ...
            expect(function() {
                Cesium.Occluder.getOccludeePoint(occluderBS, new Cartesian3(0, 0, -3));
            }).toThrow();
        });
        ...
        it("can throw errors during getOccludeePoint (5 of 5)", function () {
            ...
            expect(function() {
                Cesium.Occluder.getOccludeePoint(occluderBS, new Cartesian3(0, 0, -5), new Cartesian3(0, 0, -3));
            }).toThrow();
        });
        ...
        it("can compute an occludee point", function () {
            ...
            var result = Cesium.Occluder.getOccludeePoint(occluderBS, occludeePosition, positions);
            expect(result.valid).toBeTruthy();
            expect(result.occludeePoint.equalsEpsilon(new Cartesian3(0, 0, -5), Cesium.Math.EPSILON1)).toBeTruthy();
        });
        ...
        it("can compute a rotation vector (major axis = 0)", function () {
            ...
            var aRotationVector = Cesium.Occluder._anyRotationVector(occluderPosition, occluderPlaneNormal, occluderPlaneD);
