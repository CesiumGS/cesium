(function() {
   ...
   describe("TridiagonalSystemSolver", function () {
       var Cartesian3 = Cesium.Cartesian3;
       var TridiagonalSystemSolver = Cesium.TridiagonalSystemSolver;
       ...
       it("solve three unknowns", function () {
           ...
           expect(actual[0].equalsEpsilon(expected[0], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[1].equalsEpsilon(expected[1], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[2].equalsEpsilon(expected[2], Cesium.Math.EPSILON4)).toBeTruthy();
       });
       ...
       it("solve nine unknowns", function () {
           ...
           expect(actual[1].equalsEpsilon(expected[1], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[2].equalsEpsilon(expected[2], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[3].equalsEpsilon(expected[3], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[4].equalsEpsilon(expected[4], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[5].equalsEpsilon(expected[5], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[6].equalsEpsilon(expected[6], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[7].equalsEpsilon(expected[7], Cesium.Math.EPSILON4)).toBeTruthy();
           expect(actual[8].equalsEpsilon(expected[8], Cesium.Math.EPSILON4)).toBeTruthy();
       });
   });
