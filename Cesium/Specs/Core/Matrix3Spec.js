(function() {
    ...
    describe("Matrix3", function () {
        ...
        it("creates a non-uniform scale matrix", function() {
            ...
            expect(m.getColumn0().equals(new Cesium.Cartesian3(1, 0, 0))).toBeTruthy();
            expect(m.getColumn1().equals(new Cesium.Cartesian3(0, 2, 0))).toBeTruthy();
            expect(m.getColumn2().equals(new Cesium.Cartesian3(0, 0, 3))).toBeTruthy();
        });
        ...
        it("creates from a column major array", function () {
            ...
            var m = Matrix3.createFromColumnMajorArray(values);
            expect(m.getColumn0Row0()).toEqual(1);
        ...
        it("creates from a column major array 2", function () {
            expect(Matrix3.createFromColumnMajorArray().equals(new Matrix3())).toBeTruthy();
        });
        ...
        it("gets individual columns", function () {
            ...
            expect(m.getColumn0().equals(new Cesium.Cartesian3(1, 4, 7))).toBeTruthy();
            expect(m.getColumn1().equals(new Cesium.Cartesian3(2, 5, 8))).toBeTruthy();
            expect(m.getColumn2().equals(new Cesium.Cartesian3(3, 6, 9))).toBeTruthy();
        });

        it("gets individual columns 2", function () {
            expect(Matrix3.getIdentity().getColumn0().equals(Cesium.Cartesian3.getUnitX())).toBeTruthy();
            expect(Matrix3.getIdentity().getColumn1().equals(Cesium.Cartesian3.getUnitY())).toBeTruthy();
            expect(Matrix3.getIdentity().getColumn2().equals(Cesium.Cartesian3.getUnitZ())).toBeTruthy();
        });

        it("sets individual columns", function () {
            var m = new Matrix3();
            var c0 = new Cesium.Cartesian3(1, 2, 3);
            var c1 = new Cesium.Cartesian3(4, 5, 6);
            var c2 = new Cesium.Cartesian3(7, 8, 9);
        ...
        it("gets individual rows", function () {
            ...
            expect(m.getRow0().equals(new Cesium.Cartesian3(1, 2, 3))).toBeTruthy();
            expect(m.getRow1().equals(new Cesium.Cartesian3(4, 5, 6))).toBeTruthy();
            expect(m.getRow2().equals(new Cesium.Cartesian3(7, 8, 9))).toBeTruthy();
        });

        it("gets individual rows 2", function () {
            expect(Matrix3.getIdentity().getRow0().equals(Cesium.Cartesian3.getUnitX())).toBeTruthy();
            expect(Matrix3.getIdentity().getRow1().equals(Cesium.Cartesian3.getUnitY())).toBeTruthy();
            expect(Matrix3.getIdentity().getRow2().equals(Cesium.Cartesian3.getUnitZ())).toBeTruthy();
        });
        ...
        it("throws when creating from a column major array without enough elements", function () {
            ...
            expect(function() {
                return Matrix3.createFromColumnMajorArray(values);
            }).toThrow();
        });
