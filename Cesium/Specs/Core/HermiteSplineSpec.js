(function() {
   ...
   describe("HermiteSpline", function () {
       ...
       var HermiteSpline = Cesium.HermiteSpline;
       ...
       it("natural cubic spline", function () {
           points = [
               ...
               {
                   point : new Cartesian3(0.0, 1.0, Cesium.Math.PI_OVER_TWO),
                   time : 1.0
               },
               {
               ...
               {
                   point : new Cartesian3(0.0, -1.0, Cesium.Math.THREE_PI_OVER_TWO),
                   time : 3.0
               }
           ];
           ...
           for (var i = points[0].time; i < points[1].time; i = i + granularity) {
               expect(hs.evaluate(i).equalsEpsilon(interpolate(i), Cesium.Math.EPSILON3)).toBeTruthy();
           }
       });
