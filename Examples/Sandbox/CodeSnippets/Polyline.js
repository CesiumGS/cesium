(function() {
    ...
    Sandbox.PolylineTwoPoints = function (scene, ellipsoid, primitives) {
        this.code = function () {
            ...
            polyline.setPositions(ellipsoid.cartographicDegreesToCartesians([
                new Cesium.Cartographic(-75.10, 39.57),  // Philadelphia
                new Cesium.Cartographic(-80.12, 25.46)   // Miami
            ]));
    ...
    Sandbox.PolylineSeveralPoints = function (scene, ellipsoid, primitives) {
        this.code = function () {
            ...
            polyline.setPositions(ellipsoid.cartographicDegreesToCartesians([
                new Cesium.Cartographic(-75.10, 39.57),  // Philadelphia
                new Cesium.Cartographic(-77.02, 38.53),  // Washington, D.C.
                new Cesium.Cartographic(-80.50, 35.14),  // Charlotte
                new Cesium.Cartographic(-80.12, 25.46)   // Miami
            ]));
