(function() {
    ...
    Sandbox.RectangularPyramidSensorVolume = function (scene, ellipsoid, primitives) {
        this.code = function () {
            var modelMatrix = Cesium.Transforms.northEastDownToFixedFrame(ellipsoid.cartographicDegreesToCartesian(new Cesium.Cartographic(-90.0, 0.0)));
    ...
    Sandbox.SensorMaterial = function (scene, ellipsoid, primitives) {
        this.code = function () {
            ...
            var modelMatrix = Cesium.Transforms.eastNorthUpToFixedFrame(ellipsoid.cartographicDegreesToCartesian(new Cesium.Cartographic(-75.10, 39.57)));
