    ...
    Sandbox.MarkerBillboards = function (scene, ellipsoid, primitives) {
        this.code = function () {
            ...
            image.onload = function() {
                ...
                billboards.add({
                    position: ellipsoid.cartographicDegreesToCartesian(new Cesium.Cartographic3(-84.0, 39.0)),
                    imageIndex: 16,
                    scale: 1,
                    color: { red: 0, green: 0.5, blue: 1, alpha: 1 }
                });
                billboards.add({
                    position: ellipsoid.cartographicDegreesToCartesian(new Cesium.Cartographic3(-70.0, 41.0)),
                    imageIndex: 21,
                    scale: 1,
                    color: { red: 0.5, green: 0.9, blue: 1, alpha: 1 }
                });
                billboards.add({
                    position: ellipsoid.cartographicDegreesToCartesian(new Cesium.Cartographic3(-73.0, 37.0)),
                    imageIndex: 35,
                    scale: 1,
                    color: { red: 1, green: 0, blue: 0, alpha: 1 }
                });
                billboards.add({
                    position: ellipsoid.cartographicDegreesToCartesian(new Cesium.Cartographic3(-79.0, 35.0)),
                    imageIndex: 40,
                    scale: 1,
