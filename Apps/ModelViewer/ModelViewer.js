...
define([
    ...
    function createModel(url) {
        var modelMatrix = Transforms.northUpEastToFixedFrame(Cartesian3.fromDegrees(-123.0744619, 44.0503706, 0));
        ...
        model.readyToRender.addEventListener(function(model) {
            ...
            camera.lookAt(new Cartesian3(r, r, r), Cartesian3.ZERO, Cartesian3.UNIT_Y);
        });
    }
    ...
    function configureCanvasSize() {
        ...
        var zoomFactor = defaultValue(window.devicePixelRatio, 1.0);
    ...
    scene.renderError.addEventListener(function(scene, error) {
        displayMessage('Unable to render model.  Rendering has stopped.<br>' + error.message);
        render = false;
    });
