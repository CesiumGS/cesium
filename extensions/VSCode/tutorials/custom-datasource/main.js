...
WebGLGlobeDataSource.prototype.loadUrl = function (url) {
    ...
    // Load the URL into a json object and then process it with the `load` function.
    const that = this;
...
// Note: For this demo to work, you'll need to provide your own population data file
// in the WebGL Globe format, or use a sample data URL
const sampleDataUrl = 'https://raw.githubusercontent.com/CesiumGS/cesium/main/Apps/SampleData/population909500.json';

dataSource.loadUrl(sampleDataUrl).then(function () {
    ...
    for (let i = 0; i < dataSource.seriesNames.length; i++) {
        ...
        button.onclick = createSeriesSetter(seriesName);
...
// Create a Viewer instance and add the DataSource.
