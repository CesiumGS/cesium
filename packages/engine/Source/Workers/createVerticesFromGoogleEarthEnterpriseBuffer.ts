...
function indexOfEpsilon(arr: any, elem: any, elemType: any) {
...
function createVerticesFromGoogleEarthEnterpriseBuffer(parameters: any, transferableObjects: any, ) {
...
function processBuffer(buffer: any, relativeToCenter: any, ellipsoid: any, rectangle: any, nativeRectangle: any, exaggeration: any, exaggerationRelativeHeight: any, skirtHeight: any, includeWebMercatorT: any, negativeAltitudeExponentBias: any, negativeElevationThreshold: any, ) {
  let geographicWest;
  let geographicSouth;
  let geographicEast;
  let geographicNorth;
...
function addSkirt(positions: any, heights: any, uvs: any, webMercatorTs: any, geodeticSurfaceNormals: any, indices: any, skirtOptions: any, borderPoints: any, fudgeFactor: any, eastOrWest: any, cornerFudge: any, ) {
