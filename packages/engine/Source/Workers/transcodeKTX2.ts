...
function transcode(parameters: any, transferableObjects: any) {
...
function parseUncompressed(header: any, result: any) {
...
function transcodeCompressed(data: any, header: any, supportedTargetFormats: any, transcoderModule: any, transferableObjects: any, result: any, ) {
...
function transcodeKTX2(parameters: any, transferableObjects: any) {
