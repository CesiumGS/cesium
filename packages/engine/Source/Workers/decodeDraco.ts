...
function decodeIndexArray(dracoGeometry: any, dracoDecoder: any) {
...
function decodeQuantizedDracoTypedArray(dracoGeometry: any, dracoDecoder: any, dracoAttribute: any, quantization: any, vertexArrayLength: any, ) {
  let vertexArray;
  let attributeData;
...
function decodeDracoTypedArray(dracoGeometry: any, dracoDecoder: any, dracoAttribute: any, vertexArrayLength: any, ) {
  let vertexArray;
  let attributeData;
...
function decodeAttribute(dracoGeometry: any, dracoDecoder: any, dracoAttribute: any) {
  const numPoints = dracoGeometry.num_points();
...
function decodePointCloud(parameters: any) {
...
function decodePrimitive(parameters: any) {
  const dracoDecoder = new draco.Decoder();
...
async function decode(parameters: any, transferableObjects: any) {
...
async function decodeDraco(parameters: any, transferableObjects: any) {
