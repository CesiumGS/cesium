 ...
 *
 * @example
 * function doCalculation(parameters: any, transferableObjects: any) {
 ...
 */
function createTaskProcessorWorker(workerFunction: any) {
  ...
  function onMessageErrorHandler(event: any) {
    postMessage({
      id: event.data?.id,
 ...
 *
 * @example
 * function calculate(parameters: any, transferableObjects: any) {
