...
function boxModelMatrixAndBoundingVolume(boxes: any, index: any) {
...
function cylinderModelMatrixAndBoundingVolume(cylinders: any, index: any) {
...
function ellipsoidModelMatrixAndBoundingVolume(ellipsoids: any, index: any) {
...
function sphereModelMatrixAndBoundingVolume(spheres: any, index: any) {
...
function createPrimitive(options: any, primitive: any, primitiveBatchIds: any, geometry: any, getModelMatrixAndBoundingVolume: any, ) {
...
function unpackBuffer(buffer: any) {
...
function packedBatchedIndicesLength(batchedIndices: any) {
...
function packBuffer(indicesBytesPerElement: any, batchedIndices: any, boundingVolumes: any) {
...
function createVectorTileGeometries(parameters: any, transferableObjects: any) {
