...
function sampleGeoidFromList(lon: any, lat: any, geoidDataList: any) {
...
function orthometricToEllipsoidal(vertexCount: any, position: any, scale_x: any, scale_y: any, center: any, geoidDataList: any, fast: any, ) {
  if (fast) {
...
function transformToLocal(vertexCount: any, positions: any, normals: any, cartographicCenter: any, cartesianCenter: any, parentRotation: any, ellipsoidRadiiSquare: any, scale_x: any, scale_y: any, ) {
...
function cropUVs(vertexCount: any, uv0s: any, uvRegions: any) {
...
function generateIndexArray(vertexCount: any, indices: any, colors: any, splitGeometryByColorTransparency: any, ) {
  // Allocate array
  const indexArray = new Uint32Array(vertexCount);
  const vertexIndexFn = defined(indices)
    ? (vertexIndex: any) => indices[vertexIndex]
    : (vertexIndex: any) => vertexIndex;
  ...
  if (splitGeometryByColorTransparency && defined(colors)) {
    ...
    const isVertexTransparentFn = (vertexIndex: any) =>
...
function getFeatureHash(symbologyData: any, outlinesHash: any, featureIndex: any) {
...
function addVertexToHash(indexHash: any, positionHash: any, vertexIndex: any, positions: any) {
...
function addEdgeToHash(edgeHash: any, vertexAIndex: any, vertexBIndex: any, vertexAIndexUnique: any, vertexBIndexUnique: any, normalIndex: any, ) {
...
function generateOutlinesHash(symbologyData: any, featureIndexArray: any, indexArray: any, positions: any, ) {
  const outlinesHash = [];
...
function calculateFaceNormal(normals: any, vertexAIndex: any, indexArray: any, positions: any) {
...
function isEdgeSmooth(normals: any, normalAIndex: any, normalBIndex: any) {
...
function addOutlinesForEdge(outlines: any, edgeData: any, indexArray: any, positions: any, normals: any, ) {
...
function addOutlinesForFeature(outlines: any, edgeHash: any, indexArray: any, positions: any, normals: any, ) {
...
function generateOutlinesFromHash(outlinesHash: any, indexArray: any, positions: any, normals: any, ) {
  const outlines = [];
...
function generateOutlinesIndexArray(symbologyData: any, featureIndexArray: any, indexArray: any, positions: any, normals: any, ) {
...
function convertColorsArray(colors: any) {
...
function generateNormals(vertexCount: any, indices: any, positions: any, normals: any, uv0s: any, colors: any, featureIndex: any, ) {
  const result = {
    normals: undefined,
    positions: undefined,
    uv0s: undefined,
...
function generateGltfBuffer(vertexCount: any, indices: any, positions: any, normals: any, uv0s: any, colors: any, featureIndex: any, parameters: any, ) {
  if (vertexCount === 0 || !defined(positions) || positions.length === 0) {
    return {
      buffers: [],
      bufferViews: [],
...
function decode(data: any, schema: any, bufferInfo: any, featureData: any) {
...
function decodeDracoEncodedGeometry(data: any) {
...
function decodeDracoAttribute(dracoDecoderModule: any, dracoDecoder: any, dracoGeometry: any, dracoAttribute: any, vertexCount: any, ) {
...
function decodeBinaryGeometry(data: any, schema: any, bufferInfo: any, featureData: any) {
  // From this spec:
...
function decodeAndCreateGltf(parameters: any) {
...
async function initWorker(parameters: any, transferableObjects: any) {
...
function decodeI3S(parameters: any, transferableObjects: any) {
