...
function decodePositions(uBuffer: any, vBuffer: any, heightBuffer: any, rectangle: any, minimumHeight: any, maximumHeight: any, ellipsoid: any, ) {
...
function removeDuplicates(uBuffer: any, vBuffer: any, heightBuffer: any, counts: any) {
  const countsLength = counts.length;
  const positionsLength = uBuffer.length;
...
function VertexAttributesAndIndices(volumesCount: any) {
...
function computeMiteredNormal(previousPosition: any, position: any, nextPosition: any, ellipsoidSurfaceNormal: any, result: any, ) {
...
function createVectorTileClampedPolylines(parameters: any, transferableObjects: any) {
