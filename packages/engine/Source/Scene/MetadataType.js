 ...
 * @returns {boolean} <code>true</code> if the type is a vector, <code>false</code> otherwise
 * @private
 */
 ...
 * @param {MetadataType} type The type
 * @returns {boolean} <code>true</code> if the type is a matrix, <code>false</code> otherwise
 * @private
 */
 ...
 * @returns {object} The appropriate CartesianN class for vector types, MatrixN class for matrix types, or undefined otherwise.
 * @private
 */
