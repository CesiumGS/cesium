...
const HeightReference = {
  ...
  /**
   * The position is clamped to the terrain, 3D Tiles, and models. When clamping to 3D Tilesets such as photorealistic 3D Tiles, ensure the tileset has {@link Cesium3DTileset#enableCollision} set to <code>true</code>. Otherwise, the entity may not be correctly clamped to the tileset surface.
   * @type {number}
   * @constant
   */
  CLAMP_TO_GROUND: 1,
  ...
  /**
   * The position height is the height above the terrain, 3D Tiles, and models.
   * @type {number}
   * @constant
   */
  ...
  /**
   * The position is clamped to 3D Tiles and models.
   * @type {number}
   * @constant
   */
  CLAMP_TO_3D_TILE: 5,
  ...
  /**
   * The position height is the height above 3D Tiles and models.
   * @type {number}
   * @constant
   */
