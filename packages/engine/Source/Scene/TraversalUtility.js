...
/**
 * Utility functions for {@link Cesium3DTilesetTraversal}.
 *
 * @private
 */
function TraversalUtility() {}
 ...
 * @returns {number}
 */
TraversalUtility.sortChildrenByDistanceToCamera = function (a, b) {
 ...
 * @returns {boolean}
 */
TraversalUtility.canTraverse = function (tile) {
 ...
 */
TraversalUtility.selectTile = function (tile, frameState) {
 ...
 * @param {FrameState} frameState
 */
TraversalUtility.visitTile = function (tile, frameState) {
 ...
 * @param {FrameState} frameState
 */
TraversalUtility.touchTile = function (tile, frameState) {
 ...
 * @param {FrameState} frameState
 */
TraversalUtility.loadTile = function (tile, frameState) {
  const { tileset } = tile;
  if (
 ...
 * @param {FrameState} frameState
 */
TraversalUtility.updateTile = function (tile, frameState) {
...
export default TraversalUtility;
