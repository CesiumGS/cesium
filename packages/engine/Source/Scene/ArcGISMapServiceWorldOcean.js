 ...
 * @default https://ibasemaps-api.arcgis.com/arcgis/rest/services/World_Ocean/MapServer
 */
ArcGISMapServiceWorldOcean.defaultServer = new Resource({
  url:
    "https://ibasemaps-api.arcgis.com/arcgis/rest/services/World_Ocean/MapServer",
});
