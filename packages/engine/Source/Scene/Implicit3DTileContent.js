...
import BoundingVolumeDerivation from "./BoundingVolumeDerivation.js";
...
function getTileBoundingVolume(
  ...
  if (
    ...
    boundingVolume = BoundingVolumeDerivation.deriveBoundingVolume(
...
function makePlaceholderChildSubtree(content, parentTile, childIndex) {
  ...
  const childBoundingVolume = BoundingVolumeDerivation.deriveBoundingVolume(
    implicitTileset.boundingVolume,
    implicitCoordinates,
    childIndex,
    false,
