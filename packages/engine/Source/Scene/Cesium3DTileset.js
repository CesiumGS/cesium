 ...
 * @property {boolean} [disableCollision=false] When {@link ScreenSpaceCameraController#enableCollisionDetection} is true, allows the camera to go in or below the tileset surface. If using WebGL 1, <code>enablePick</code> must be true for collision to work.
 ...
 *
 * @example
 * // Allow camera to go in and under 3D tileset
 * try {
 *   const tileset = await Cesium.Cesium3DTileset.fromUrl(
 *      "http://localhost:8002/tilesets/Seattle/tileset.json",
...
function Cesium3DTileset(options) {
  ...
  /**
   * When {@link ScreenSpaceCameraController#enableCollisionDetection} is true, allows the camera to go in or below the tileset surface.
   *
   * @type {boolean}
   * @default false
   */
