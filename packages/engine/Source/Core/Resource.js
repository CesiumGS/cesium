 ...
 * @param {boolean} [query] If true, the query string is included.
 * @param {boolean} [proxy] If true, the url is processed by the proxy object, if defined.
 ...
 * @param {boolean} [useAsDefault] If true the params will be used as the default values, so they will only be set if they are undefined.
 */
 ...
 * @param {boolean} [useAsDefault] If true the values will be used as the default values, so they will only be set if they are undefined.
 */
 ...
 * @param {boolean} [options.preserveQueryParameters] If true, this will keep all query parameters from the current resource and derived resource. If false, derived parameters will replace those of the current resource.
 ...
 * @param {boolean} [includeQuery] Whether or not to include the query string and fragment form the uri
 ...
 * @param {object} [options] An object with the following properties.
 * @param {boolean} [options.preferBlob] If true, we will load the image via a blob.
 ...
 * @param {boolean} [options.skipColorSpaceConversion] If true, any custom gamma or color profiles in the image will be ignored. Only applies if the browser supports <code>createImageBitmap</code>.
 ...
 * @param {object} [options.headers] Additional HTTP headers that will be sent.
 * @param {Proxy} [options.proxy] A proxy to be used when loading the resource.
 * @param {boolean} [options.flipY] Whether to vertically flip the image during fetch and decode. Only applies when requesting an image and the browser supports <code>createImageBitmap</code>.
 * @param {Resource.RetryCallback} [options.retryCallback] The Function to call when a request for this resource fails. If it returns true, the request will be retried.
 * @param {number} [options.retryAttempts] The number of times the retryCallback should be called before giving up.
 * @param {Request} [options.request] A Request object that will be used. Intended for internal use only.
 * @param {boolean} [options.preferBlob]  If true, we will load the image via a blob.
 * @param {boolean} [options.preferImageBitmap] If true, image will be decoded during fetch and an <code>ImageBitmap</code> is returned.
 * @param {boolean} [options.skipColorSpaceConversion] If true, any custom gamma or color profiles in the image will be ignored. Only applies when requesting an image and the browser supports <code>createImageBitmap</code>.
 * @returns {Promise<ImageBitmap|HTMLImageElement>|undefined} a promise that will resolve to the requested data when loaded. Returns undefined if <code>request.throttle</code> is true and the request does not have high enough priority.
 */
