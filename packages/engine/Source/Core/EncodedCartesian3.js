...
/**
 * @typedef {object} EncodedCartesian3Components
...
class EncodedCartesian3 {
   ...
   * @param {EncodedCartesian3Components} [result] The object onto which to store the result.
   * @returns {EncodedCartesian3Components} The modified result parameter or a new instance if one was not provided.
   *
   * @example
