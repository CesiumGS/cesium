...
class TerrainEncoding {
   ...
   */
  addGeodeticSurfaceNormals(oldBuffer, newBuffer, ellipsoid) {
    //>>includeStart('debug', pragmas.debug);
   ...
   */
  removeGeodeticSurfaceNormals(oldBuffer, newBuffer) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("oldBuffer", oldBuffer);
    Check.typeOf.object("newBuffer", newBuffer);
    //>>includeEnd('debug');
   ...
   */
  getExaggeratedPosition(buffer, index, result) {
   ...
   */
  decodeWebMercatorT(buffer, index) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("buffer", buffer);
    Check.typeOf.number("index", index);
    //>>includeEnd('debug');
   ...
   * @returns {Cartesian3}
   */
  decodeNormal(buffer, index, result) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("buffer", buffer);
    Check.typeOf.number("index", index);
   ...
   */
  decodeGeodeticSurfaceNormal(buffer, index, result) {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("buffer", buffer);
    Check.typeOf.number("index", index);
    Check.typeOf.object("result", result);
