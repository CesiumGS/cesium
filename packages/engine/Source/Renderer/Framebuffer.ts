...
function attachTexture(framebuffer: any, attachment: any, texture: any) {
...
function attachRenderbuffer(framebuffer: any, attachment: any, renderbuffer: any) {
  const gl = framebuffer._gl;
 ...
 * @constructor
 */
function Framebuffer(options: any) {
