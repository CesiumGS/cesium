...
fdescribe("Scene/DynamicEnvironmentMapManager", function () {
  ...
  describe("render tests", () => {
    ...
    it("creates environment map and spherical harmonics at altitude in Philadelphia with static lighting", async function () {
      ...
      const cartographic = Cartographic.fromDegrees(-75.165222, 39.952583, 20000.0);
      manager.position = Ellipsoid.WGS84.cartographicToCartesian(cartographic);
      ...
      expect(manager.sphericalHarmonicCoefficients[0]).toEqualEpsilon(
        new Cartesian3(
          0.1009233146905899, 0.10943963378667831, 0.12368400394916534
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[1]).toEqualEpsilon(
        new Cartesian3(
          0.05498318374156952, 0.044787511229515076, 0.026188815012574196
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[2]).toEqualEpsilon(
        new Cartesian3(
          0.000607481284532696, 0.00047677505062893033, 0.0003103993949480355
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[3]).toEqualEpsilon(
        new Cartesian3(
          -0.00002178461909352336, -0.00000523854259881773, 0.000022690264813718386
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[4]).toEqualEpsilon(
        new Cartesian3(
          -0.00001488747147959657, -0.000008339899068232626, -0.0000022421534140448784
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[5]).toEqualEpsilon(
        new Cartesian3(
          -0.000022197265934664756, 0.000015122794138733298, 0.000003064520569751039
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[6]).toEqualEpsilon(
        new Cartesian3(
          0.0006848506745882332, -0.0006184031954035163, -0.0032658539712429047
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[7]).toEqualEpsilon(
        new Cartesian3(
          0.00004173172055743635, -0.0002229579840786755, -0.00031301588751375675
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[8]).toEqualEpsilon(
        new Cartesian3(
          -0.001145384507253766, 0.0002962825819849968, 0.0040063755586743355
        ),
        CesiumMath.EPSILON8
      );
    });
    ...
    it("creates environment map and spherical harmonics above Earth's atmosphere with static lighting", async function () {
      ...
      const cartographic = Cartographic.fromDegrees(-75.165222, 39.952583, 1000000.0);
      manager.position = Ellipsoid.WGS84.cartographicToCartesian(cartographic);
      ...
      expect(manager.sphericalHarmonicCoefficients[0]).toEqualEpsilon(
        new Cartesian3(
          0.20291849970817566, 0.21098950505256653, 0.2223447859287262
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[1]).toEqualEpsilon(
        new Cartesian3(
          0.03659752011299133, 0.02856328710913658, 0.01719149760901928
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[2]).toEqualEpsilon(
        new Cartesian3(
          0.0009044585167430341, 0.0010656686499714851, 0.0012444753665477037
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[3]).toEqualEpsilon(
        new Cartesian3(
          -0.0011628743959590793, -0.0011680441675707698, -0.0011507802410051227
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[4]).toEqualEpsilon(
        new Cartesian3(
          -0.00019400268502067775, -0.0002006645518122241, -0.00017666186613496393
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[5]).toEqualEpsilon(
        new Cartesian3(
          -0.00040162945515476167, -0.0005506023298949003, -0.0007173771737143397
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[6]).toEqualEpsilon(
        new Cartesian3(
          0.031479597091674805, 0.02691546082496643, 0.020333565771579742
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[7]).toEqualEpsilon(
        new Cartesian3(
          -0.0002572553639765829, -0.0002495200315024704, -0.0002257294545415789
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[8]).toEqualEpsilon(
        new Cartesian3(
          -0.03815876692533493, -0.032493289560079575, -0.024339288473129272
        ),
        CesiumMath.EPSILON8
      );
    });
    ...
    it("creates environment map and spherical harmonics at surface in Philadelphia with dynamic lighting", async function () {
      ...
      expect(manager.sphericalHarmonicCoefficients[0]).toEqualEpsilon(
        new Cartesian3(
          0.03429396450519562, 0.032081544399261475, 0.028762752190232277
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[1]).toEqualEpsilon(
        new Cartesian3(
          -0.0000025223789634765126, -0.0000023597081053594593, -0.0000021155233298486564
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[2]).toEqualEpsilon(
        new Cartesian3(
          0.00011601427104324102, 0.0001085287585738115, 0.00009730226884130388
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[3]).toEqualEpsilon(
        new Cartesian3(
          5.25413724972168e-7, 4.91490709464415e-7, 4.4070020521758124e-7
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[4]).toEqualEpsilon(
        new Cartesian3(
          3.0070265211179503e-7, 2.81280051694921e-7, 2.522050408515497e-7
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[5]).toEqualEpsilon(
        new Cartesian3(
          0.0000025374474716954865, 0.000002373756615270395, 0.0000021282285160850734
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[6]).toEqualEpsilon(
        new Cartesian3(
          2.865272108465433e-7, 2.738524926826358e-7, 2.469751052558422e-7
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[7]).toEqualEpsilon(
        new Cartesian3(
          0.00001196307857753709, 0.000011191226803930476, 0.000010033609214588068
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[8]).toEqualEpsilon(
        new Cartesian3(
          6.47090530492278e-7, 6.05321702096262e-7, 5.426667257779627e-7
        ),
        CesiumMath.EPSILON8
      );
    });
    ...
    it("creates environment map and spherical harmonics at surface in Sydney with dynamic lighting", async function () {
      ...
      const cartographic = Cartographic.fromDegrees(151.209900, -33.865143);
      manager.position = Ellipsoid.WGS84.cartographicToCartesian(cartographic);
      ...
      expect(manager.sphericalHarmonicCoefficients[0]).toEqualEpsilon(
        new Cartesian3(
          0.009373737499117851, 0.009373737499117851, 0.008282523602247238
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[1]).toEqualEpsilon(
        new Cartesian3(
          0.001393672777339816, 0.001393672777339816, 0.0014051483012735844
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[2]).toEqualEpsilon(
        new Cartesian3(
          -0.0005047473823651671, -0.0005047473823651671, -0.0005102163995616138
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[3]).toEqualEpsilon(
        new Cartesian3(
          -0.00009009439963847399, -0.00009009439963847399, -0.00009034635149873793
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[4]).toEqualEpsilon(
        new Cartesian3(
          0.00015939869626890868, 0.00015939869626890868, 0.00016029566177166998
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[5]).toEqualEpsilon(
        new Cartesian3(
          -0.000621203682385385, -0.000621203682385385, -0.0006253988831304014
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[6]).toEqualEpsilon(
        new Cartesian3(
          -0.0005390251171775162, -0.0005390251171775162, -0.0005395518383011222
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[7]).toEqualEpsilon(
        new Cartesian3(
          0.00032644663588143885, 0.00032644663588143885, 0.0003294381021987647
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[8]).toEqualEpsilon(
        new Cartesian3(
          0.0007399972528219223, 0.0007399972528219223, 0.0007447657408192754
        ),
        CesiumMath.EPSILON8
      );
    });
    ...
    it("reflects atmosphere changes", async function () {
      ...
      expect(manager.sphericalHarmonicCoefficients[0]).toEqualEpsilon(
        new Cartesian3(
          0.10372506082057953, 0.11203387379646301, 0.12661541998386383
        ),
        CesiumMath.EPSILON8
      );
      expect(manager.sphericalHarmonicCoefficients[1]).toEqualEpsilon(
