define(['./Check-666ab1a0', './RuntimeError-06c93819', './defaultValue-0a909f67', './createTaskProcessorWorker'], (function (Check, RuntimeError, defaultValue, createTaskProcessorWorker) { 'use strict';
  ...
  var _utf8len = new utils$1.Buf8(256);
  for (var q = 0; q < 256; q++) {
  ...
  function buf2binstring(buf, len) {
    ...
    if (len < 65534) {
      if ((buf.subarray && STR_APPLY_UIA_OK) || (!buf.subarray && STR_APPLY_OK)) {
        return String.fromCharCode.apply(null, utils$1.shrinkBuf(buf, len));
      }
    }
  ...
  strings$1.binstring2buf = function (str) {
    var buf = new utils$1.Buf8(str.length);
