...
* Added point attenuation for rendering 3D Tiles point clouds. Can be toggled with `tileset.pointAttenuation`. [#5824](https://github.com/AnalyticalGraphicsInc/cesium/pull/5824)
