...
- Added `TrustedServers.pack` and `TrustedServers.unpack` to serialize the trusted server registry, e.g. to send it to a Web Worker so requests made there can resolve credentials the same way the document does. [#13617](https://github.com/CesiumGS/cesium/issues/13617)
