...
- Added `preserveDrawOrder` option to `PolylineCollection` which allows polylines to be drawn on top of each other in the order they were added to the collection regardless of rendered depth. [#9986](https://github.com/CesiumGS/cesium/pull/9986)
