...
* Deprecated
  ...
  * The default value for the `mouseMoveOnDocument` parameter to the `ScreenSpaceEventHandler` constructor was deprecated in Cesium 1.6. The default will change from `true` to `false` in Cesium 1.7.
