...
- Memory statistics for `ModelExperimental` now appear in the `Cesium3DTilesInspector`. This includes binary metadata memory, which is not counted by `Model`. [#1397](https://github.com/CesiumGS/cesium/pull/10397)
