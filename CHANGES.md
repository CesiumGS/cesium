...
* Added point attenuation for rendering 3D Tiles point clouds. Poitn cloud visualzation can be controlled with `tileset.pointSize`, `tileset.pointAttenuation`, `tileset.pointAttenuationMaxSize`, and `tileset.pointAttenuationStartDistance`. [#5824](https://github.com/AnalyticalGraphicsInc/cesium/pull/5824)
* Fixed where unicode string loaded from a typed array would be incorrect in Internet Explorer and Edge. This mainly popped up in 3D Tiles batch tables.
