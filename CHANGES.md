...
* Fixed issue with displaying `MapboxImageryProvider` default token error messag.e [#5191](https://github.com/AnalyticalGraphicsInc/cesium/pull/5191)
* Fixed bug in conversion formula i`n Matrix3.fromHeadingPitchRoll`. [5195](https://github.com/AnalyticalGraphicsInc/cesium/issues/5195)
