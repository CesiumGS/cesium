...
- Fixed a bug where dynamic geometries would cause the Scene to continuously render when configured to use requestRenderMode [#6631](https://github.com/CesiumGS/cesium/issues/6631)
