...
- `Model.gltf`, `Model.basePath`, `Model.pendingTextureLoads` (properties), and `Model.dequantizeInShader` (constructor option) were deprecate in CesiumJS 1.94 and will be removed in CesiumJS 1.95 as these will not be supported in `ModelExperimental`. [#10415](https://github.com/CesiumGS/cesium/pull/10415)
