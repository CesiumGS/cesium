...
* Deprecated
   ...
   * `SingleTileImageryProvider` taking an `options.url` parameter has been deprecated and will be removed in Cesium 1.37, use the `options.image` parameter instead.
