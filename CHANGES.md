...
* Fixed `TimeInterval` so now it throws if `fromIso8601` is given an iso8601 input with improper formatting. [#6493](https://github.com/AnalyticalGraphicsInc/cesium/pull/6493)
