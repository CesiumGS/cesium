...
* `WebMapServiceImageryProvider`  updates:
  * `WebMapServiceImageryProvider` can take an srs or crs string to pass to the resource query parameters based on the WMS version. [#6223](https://github.com/AnalyticalGraphicsInc/cesium/issues/6223)
  * `WebMapServiceImageryProvider` can optionally take a clock and times and will pass parameters with the requests for image tiles.
