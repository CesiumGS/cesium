...
* Fixed `WebMapServiceImageryProvider` so it can now take an srs or crs string to pass to the resource query parameters based on the WMS version. [#6223](https://github.com/AnalyticalGraphicsInc/cesium/issues/6223) 
