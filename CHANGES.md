...
- Added `WebMapServiceImageryProvider.featureInfoUrl` which reads the getFeatureInfo request URL for WMS service if it differs with the getCapabilities URL. [#9563](https://github.com/CesiumGS/cesium/pull/9563)
