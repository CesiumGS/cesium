...
* Added support for projections defined using Proj4-style well-known-text, projections defined by user code, and projections defined by matrices in Columbus View and 2D. [#7502](https://github.com/AnalyticalGraphicsInc/cesium/pull/7502)
