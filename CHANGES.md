...
- Added `ModelExperimental.texturesLoadedPromise`, exposing a promise separate from `readyPromise` for loading textures. [#10361](https://github.com/CesiumGS/cesium/pull/10361)
