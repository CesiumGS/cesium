...
* Breaking changes:
   ...
   * `Cartographic3` has been renamed to `Cartographic`.
   * `Cartographic2` use been removed, use `Cartographic` instead.
   ...
   * `Math.cartographic3ToRadians`, `Math.cartographic2ToRadians`, `Math.cartographic2ToDegrees`, `Math.cartographic3ToDegrees` were removed.  These functions are no longer needed because Cartographic instances are always represented in radians. 
