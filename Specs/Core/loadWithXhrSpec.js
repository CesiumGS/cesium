...
defineSuite([
    ...
    describe('data URI loading', function() {
        it('can load URI escaped text', function() {
        ...
        it('can load Base64 encoded text', function() {
            var promise = loadWithXhr({
        ...
        it('can load Base64 & URI encoded text', function() {
            var promise = loadWithXhr({
        ...
        it('can load URI escaped HTML as text', function() {
            var promise = loadWithXhr({
