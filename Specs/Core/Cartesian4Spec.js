...
defineSuite([
    ...
    it('getMinimumByComponent without a result parameter', function() {
        ...
        expect(Cartesian4.getMinimumByComponent(first, second, result)).toEqual(expected);
    ...
    it('getMinimumByComponent works when first\'s or second\'s X is lesser', function() {
        ...
        expect(Cartesian4.getMinimumByComponent(first, second, r)).toEqual(result);
        second.x = 3.0;
        result.x = 2.0;
        expect(Cartesian4.getMinimumByComponent(first, second,r )).toEqual(result);
    });
    ...
    it('getMaximumByComponent', function() {
        ...
        expect(Cartesian4.getMaximumByComponent(first, second, result)).toEqual(expected);
        first = new Cartesian4(1.0, 0.0, 0.0, 0.0);
        second = new Cartesian4(2.0, 0.0, 0.0, 0.0);
    ...
    it('getMaximumByComponent works when first\'s or second\'s X is greater', function() {
        ...
        var result = new Cartesian4(2.0, 0.0, 0.0, 0.0);
        var r = new Cartesian4();
        expect(Cartesian4.getMaximumByComponent(first, second, r)).toEqual(result);
        second.x = 3.0;
        result.x = 3.0;
        expect(Cartesian4.getMaximumByComponent(first, second, r)).toEqual(result);
    });
    ...
    it('getMinimumByComponent throws with no result', function() {
        expect(function() {
            Cartesian4.getMinimumByComponent(new Cartesian4(), new Cartesian4());
        }).toThrowDeveloperError();
    });

    it('getMaximumByComponent throws with no result', function() {
        expect(function() {
            Cartesian4.getMaximumByComponent(new Cartesian4(), new Cartesian4());
        }).toThrowDeveloperError();
    });
