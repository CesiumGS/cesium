...
describe('Core/Proj4Projection', function() {
    ...
    var webMercatorProjectedBounds = new Rectangle(-20026376.39, -20048966.10, 20026376.39, 20048966.10);
    ...
    it('clamps projected coordinates to the specified projected bounds', function() {
        ...
        var unprojected = projection.unproject(new Cartesian3(webMercatorProjectedBounds.west, 0.0, 0.0));

        var projectedOutOfBounds = new Cartesian3(webMercatorProjectedBounds.west - 100000.0, 0.0, 0.0);
