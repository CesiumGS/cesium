defineSuite(['Core/HermitePolynomialApproximation'], function(HermitePolynomialApproximation) {
    ...
    it('should match the results produced by Components', function() {
        ...
        var dyTable = [
                       0.000000000000, 5458.47176691947, 0,
                       -133.614738921601, 5456.83618333919, 0,
                       -267.149404854867, 5451.93041277513, 0,
                       -400.523972797808, 5443.75739517027, 0,
                       -533.658513692378, 5432.32202847183, 0,
                       -666.473242324565, 5417.63116569613, 0,
                       -798.888565138278, 5399.69361082164, 0,
                       -930.825127934390, 5378.52011351288, 0
                   ];
        ...
        var componentsResult = [
                                13367002.87092863, 545695.73881006264, 0.0,
                                -222.6516878705215, 5453.92888257129, 0.0
                            ];
    ...
    it('should match the results produced by Components for large arrays', function() {
        ...
        var componentsResult = [
                                -91.125, -0.81485450435264861, 0.63762815162439379,
                                60.75, -0.48120254819647229, 0.06376281516395714
                            ];
    ...
    it('should match the results produced by Components for small degrees', function() {
        ...
        var componentsResult = [
                                -91.125, -0.81485539380478811, 0.63762816572474934,
                                60.75, -0.48120550709317134, 0.0637628624090974
                            ];
    ...
    it('should match the results produced by Components for a non-zero start index', function() {
        ...
        var expectedResult = [
                              13367002.870928625, 545695.73881006264, 0.0,
                              -222.65168787012135, 5453.9288825713256, 0.0
                          ];
