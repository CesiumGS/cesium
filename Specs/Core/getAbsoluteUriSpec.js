...
defineSuite([
    ...
    it('works as expected', function() {
        ...
        result = getAbsoluteUri('https://www.mysite.com/somefolder/awesome.png#makeitawesome');
        expect(result).toEqual('https://www.mysite.com/somefolder/awesome.png#makeitawesome');

        result = getAbsoluteUri('awesome.png', 'http://test.com');
        expect(result).toEqual('http://test.com/awesome.png');

        result = getAbsoluteUri('awesome.png', 'https://test.com');
        expect(result).toEqual('https://test.com/awesome.png');
