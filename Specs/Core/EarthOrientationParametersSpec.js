/*global defineSuite*/
defineSuite(['Core/Transforms', 'Core/DeveloperError', 'Core/Cartesian2', 'Core/Cartesian3', 'Core/Cartesian4', 'Core/Ellipsoid', 'Core/JulianDate', 'Core/Matrix3', 'Core/Matrix4', 'Core/Math', 'Core/Quaternion', 'Core/TimeConstants', 'Core/TimeInterval', 'Core/EarthOrientationParameters', 'ThirdParty/when', 'Core/loadJson'], function(Transforms, DeveloperError, Cartesian2, Cartesian3, Cartesian4, Ellipsoid, JulianDate, Matrix3, Matrix4, CesiumMath, Quaternion, TimeConstants, TimeInterval, EarthOrientationParameters, when, loadJson) {
    "use strict";
    ...
    describe('loading eop', function() {
        ...
        it('data interpolates correctly under normal circumstances', function() {
            var eopDescription = {
                    ...
                    data : {
                        "columnNames":[
                                       "dateIso8601","xPoleWanderRadians","yPoleWanderRadians","xCelestialPoleOffsetRadians","yCelestialPoleOffsetRadians","ut1MinusUtcSeconds","taiMinusUtcSeconds","lengthOfDayCorrectionSeconds"
                                       ],
                        "samples":[
                                   "2011-07-01T00:00:00Z",2.117957047295119e-7,2.111518721609984e-6,3.393695767766752e-11,3.3452143996557983e-10,-0.2908948,34.0,-2.956e-4,
