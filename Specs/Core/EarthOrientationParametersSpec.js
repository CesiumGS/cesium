...
defineSuite([
    ...
    describe('loading eop', function() {
        ...
        it('interpolates data correctly under normal circumstances', function() {
            ...
            var dt = JulianDate.getSecondsDifference(JulianDate.fromIso8601(eopDescription.data.samples[nColumns]), date) / 86400.0;
        ...
        it('interpolates UT1 correctly over a leap second', function() {
            ...
            var dt = JulianDate.getSecondsDifference(t0, dateSlightlyBefore) / (86400.0 + 1);
            ...
            dt = JulianDate.getSecondsDifference(t1, dateSlightlyAfter) / (86400.0);
