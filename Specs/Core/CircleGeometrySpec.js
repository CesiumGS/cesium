...
defineSuite([
    ...
    it('computes positions', function() {
        ...
        expect(m.attributes.position.values.length).toEqual(3 * 18);
        expect(m.indices.length).toEqual(3 * 24);
    ...
    it('compute all vertex attributes', function() {
        ...
        expect(m.attributes.position.values.length).toEqual(3 * 18);
        expect(m.attributes.st.values.length).toEqual(2 * 18);
        expect(m.attributes.normal.values.length).toEqual(3 * 18);
        expect(m.attributes.tangent.values.length).toEqual(3 * 18);
        expect(m.attributes.binormal.values.length).toEqual(3 * 18);
        expect(m.indices.length).toEqual(3 * 24);
    });
    ...
    it('computes positions extruded', function() {
        ...
        expect(m.attributes.position.values.length).toEqual(3 * (18 + 8) * 2);
        expect(m.indices.length).toEqual(3 * (24 + 8) * 2);
    });
    ...
    it('compute all vertex attributes extruded', function() {
        ...
        expect(m.attributes.position.values.length).toEqual(3 * (18 + 8) * 2);
        expect(m.attributes.st.values.length).toEqual(2 * (18 + 8) * 2);
        expect(m.attributes.normal.values.length).toEqual(3 * (18 + 8) * 2);
        expect(m.attributes.tangent.values.length).toEqual(3 * (18 + 8) * 2);
        expect(m.attributes.binormal.values.length).toEqual(3 * (18 + 8) * 2);
        expect(m.indices.length).toEqual(3 * (24 + 8) * 2);
    });
    ...
    it('compute texture coordinates with rotation', function() {
        ...
        expect(positions.length).toEqual(3 * 18);
        expect(length).toEqual(2 * 18);
        expect(m.indices.length).toEqual(3 * 24);
