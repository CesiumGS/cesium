defineSuite([
    ...
    it('throws without end', function() {
        expect(function() {
            var rhumb = new EllipsoidRhumb(new Cartographic(Math.PI, Math.PI));
            return rhumb.interpolateUsingSurfaceDistance(0);
        }).toThrowDeveloperError();
    });
    ...
    it('throws without unique position', function() {
        expect(function() {
            var rhumb = new EllipsoidRhumb(new Cartographic(Math.PI, Math.PI), new Cartographic(0, Math.PI));
            return rhumb.interpolateUsingSurfaceDistance(0);
        }).toThrowDeveloperError();
    });
    ...
    it('can create using fromStartAndEnd function', function() {
        ...
        var rhumb = EllipsoidRhumb.fromStartAndEnd(start, end);
    ...
    it('can create using fromStartAndEnd function with result', function() {
        var scratch = new EllipsoidRhumb();
        ...
        var rhumb = EllipsoidRhumb.fromStartAndEnd(start, end, ellipsoid, scratch);
    ...
    it('can create using fromStartHeadingDistance function', function() {
        ...
        var rhumb = EllipsoidRhumb.fromStartHeadingDistance(start, heading, distance, ellipsoid);
        expect(start).toEqual(rhumb.start);
    ...
    it('can create using fromStartHeadingDistance function with result', function() {
        ...
        var rhumb = EllipsoidRhumb.fromStartHeadingDistance(start, heading, distance, ellipsoid, scratch);
        expect(rhumb).toBe(scratch);
        expect(rhumb.ellipsoid).toBe(ellipsoid);
        expect(start).toEqual(rhumb.start);
        expect(distance).toEqualEpsilon(rhumb.surfaceDistance, CesiumMath.EPSILON12);
    ...
    it('works with two points', function() {
        ...
        var rhumb = new EllipsoidRhumb(start, end);
        expect(start).toEqual(rhumb.start);
        expect(end).toEqual(rhumb.end);
    });
    ...
    it('gets heading', function() {
        ...
        var rhumb = new EllipsoidRhumb(start, end, ellipsoid);
    ...
    it('heading works when going around the world at constant latitude', function() {
        ...
        var rhumb2 = new EllipsoidRhumb(start, end, ellipsoid);
    ...
    it('computes heading for vertical lines', function() {
        ...
        var rhumb2 = new EllipsoidRhumb(end, start, ellipsoid);
    ...
    it('computes distance for sphere 90 degrees along meridian and equator and check equality', function() {
        ...
        var westEastRhumb = new EllipsoidRhumb(fortyFiveWest, fortyFiveEast, ellipsoid);
        var southNorthRhumb = new EllipsoidRhumb(fortyFiveSouth, fortyFiveNorth, ellipsoid);
        var eastWestRhumb = new EllipsoidRhumb(fortyFiveEast, fortyFiveWest, ellipsoid);
        var northSouthRhumb = new EllipsoidRhumb(fortyFiveNorth, fortyFiveSouth, ellipsoid);
    ...
    it('tests sphere', function() {
        ...
        var rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, fifteenDegrees, distance, ellipsoid);
        var rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
    ...
    it('tests sphere close to 90 degrees', function() {
        ...
        var rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, eightyNineDegrees, distance, ellipsoid);
        var rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
        ...
        rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, eightyNinePointNineDegrees, distance, ellipsoid);
        rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
        expect(rhumb1.heading).toEqualEpsilon(rhumb2.heading, CesiumMath.EPSILON12);
        expect(rhumb1.surfaceDistance).toEqualEpsilon(rhumb2.surfaceDistance, CesiumMath.EPSILON6);

        rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, ninetyDegrees, distance, ellipsoid);
        rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
        expect(rhumb1.heading).toEqualEpsilon(rhumb2.heading, CesiumMath.EPSILON12);
        expect(rhumb1.surfaceDistance).toEqualEpsilon(rhumb2.surfaceDistance, CesiumMath.EPSILON6);

        rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, ninetyPointOneDegrees, distance, ellipsoid);
        rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
        expect(rhumb1.heading).toEqualEpsilon(rhumb2.heading, CesiumMath.EPSILON12);
        expect(rhumb1.surfaceDistance).toEqualEpsilon(rhumb2.surfaceDistance, CesiumMath.EPSILON6);

        rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, ninetyPointZeroTwoDegrees, distance, ellipsoid);
        rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
        expect(rhumb1.heading).toEqualEpsilon(rhumb2.heading, CesiumMath.EPSILON12);
        expect(rhumb1.surfaceDistance).toEqualEpsilon(rhumb2.surfaceDistance, CesiumMath.EPSILON6);
    });
    ...
    it('test sphereoid across meridian', function() {
        ...
        var rhumb1 = new EllipsoidRhumb(initial, final, ellipsoid);
        var rhumb2 = EllipsoidRhumb.fromStartHeadingDistance(initial, CesiumMath.PI_OVER_TWO, distance, ellipsoid);
    ...
    it('test across IDL with -PI to PI range of longitude', function() {
        ...
        var rhumb1 = new EllipsoidRhumb(initial, final, ellipsoid);
        var rhumb2 = new EllipsoidRhumb.fromStartHeadingDistance(initial, 3.0 * CesiumMath.PI_OVER_TWO, distance, ellipsoid);
        ...
        var rhumb3 = new EllipsoidRhumb(final, initial, ellipsoid);
        var rhumb4 = new EllipsoidRhumb.fromStartHeadingDistance(final, CesiumMath.PI_OVER_TWO, distance, ellipsoid);
    ...
    it('test across equator', function() {
        ...
        var rhumb = new EllipsoidRhumb(initial, final, ellipsoid);
    ...
    it('test close to poles', function() {
        ...
        var rhumb1 = EllipsoidRhumb.fromStartHeadingDistance(initial, eightyDegrees, distance, ellipsoid);
        var rhumb2 = new EllipsoidRhumb(initial, rhumb1.end, ellipsoid);
