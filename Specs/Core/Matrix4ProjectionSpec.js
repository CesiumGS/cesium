...
describe('Core/Matrix4Projection', function() {
    ...
    it('project1', function() {
        var cartographic = new Cartographic(CesiumMath.PI, CesiumMath.PI_OVER_TWO, 0.0);
    ...
    it('serializes and deserializes', function() {
        ...
        return Matrix4Projection.deserialize(serialized).then(function(deserializedProjection) {
