...
describe("Core/Matrix4Projection", function () {
  ...
  it("clamps projected coordinates to the specified projected bounds", function () {
    ...
    var clampedUnprojected = projection.unproject(
      new Cartesian3(-190, 0.0, 0.0)
    );
  ...
  it("serializes and deserializes", function () {
    ...
    return Matrix4Projection.deserialize(serialized).then(function (
      ...
      expect(projection.projectedBounds).toEqual(
        deserializedProjection.projectedBounds
      );
      expect(projection.wgs84Bounds).toEqual(
        deserializedProjection.wgs84Bounds
      );
    });
  });
});
