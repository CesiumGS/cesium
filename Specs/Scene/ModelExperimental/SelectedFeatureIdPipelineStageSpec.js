...
describe("Scene/ModelExperimental/SelectedFeatureIdPipelineStage", function () {
  ...
  it("selects primitive feature IDs", function() {
    return loadGltf(buildingsMetadata).then(function(gltfLoader) {
      ...
      SelectedFeatureIdPipelineStage.process(renderResources, primitive, frameState);
      ...
      ShaderBuilderTester.expectVertexLinesEqual(shaderBuilder, [_shadersSelectedFeatureIdStageCommon]);
