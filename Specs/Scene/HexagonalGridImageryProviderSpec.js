...
import { HexagonalGridImageryProvider } from '../../Source/Cesium.js';
import { ImageryProvider } from '../../Source/Cesium.js';
import pollToPromise from '../pollToPromise.js';
import { when } from '../../Source/Cesium.js';

describe('Scene/HexagonalGridImageryProvider', function() {

    it('conforms to ImageryProvider interface', function() {
        expect(HexagonalGridImageryProvider).toConformToInterface(ImageryProvider);
    });

    it('resolves readyPromise', function() {
        var provider = new HexagonalGridImageryProvider();
