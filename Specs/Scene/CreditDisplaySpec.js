...
defineSuite([
    ...
    it('credit display displays image credit', function() {
        var creditDisplay = new CreditDisplay(container);
        var credits = [new Credit(undefined, 'imagesrc')];
        creditDisplay.showCredits(credits);
        expect(container.innerHTML).toEqual('<span><span><img class="credit-image" src="imagesrc" style="vertical-align: bottom;"></span></span><span></span>');
    });

    it('credit display displays hyperlink credit', function() {
        var creditDisplay = new CreditDisplay(container);
        var credits = [new Credit(undefined, undefined, 'http://cesium.agi.com')];
        creditDisplay.showCredits(credits);
    ...
    it('credit display updates html when credits change', function() {
        ...
        creditDisplay.showCredits(credits);
        expect(container.innerHTML).toEqual('<span><span><img class="credit-image" src="imagesrc" style="vertical-align: bottom;"></span></span><span><span>credit1</span></span>');
    ...
    it('credit display uses text as title for image credit', function() {
        ...
        var creditDisplay = new CreditDisplay(container);
        creditDisplay.showCredits(credits);
        expect(container.innerHTML).toEqual('<span><span><img class="credit-image" src="imagesrc" alt="credit text" title="credit text" style="vertical-align: bottom;"></span></span><span></span>');
    });
    ...
    it('credit display creates image credit with hyperlink', function() {
        ...
        var creditDisplay = new CreditDisplay(container);
        creditDisplay.showCredits(credits);
        expect(container.innerHTML).toEqual('<span><span><a href="link.com" target="_blank"><img class="credit-image" src="imagesrc" style="vertical-align: bottom;"></a></span></span><span></span>');
    });
