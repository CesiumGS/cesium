...
describe("Scene/MetadataComponentType", function () {
  ...
  it("getMinimum throws without componentType", function () {
    expect(function () {
      MetadataComponentType.getMinimum();
    }).toThrowDeveloperError();
  });

  it("getMinimum throws if componentType is not a numeric type", function () {
    expect(function () {
  ...
  it("getMaximum throws without componentType", function () {
    expect(function () {
      MetadataComponentType.getMaximum();
    }).toThrowDeveloperError();
  });

  it("getMaximum throws if componentType is not a numeric type", function () {
    expect(function () {
  ...
  it("isNumericType throws without componentType", function () {
    expect(function () {
  ...
  it("isIntegerType throws without componentType", function () {
    expect(function () {
  ...
  it("isUnsignedIntegerType throws without componentType", function () {
    expect(function () {
  ...
  it("normalizes signed integers", function () {
    ...
    for (var i = 0; i < signedComponentTypes.length; ++i) {
      var componentType = signedComponentTypes[i];
      var min = MetadataComponentType.getMinimum(
        MetadataComponentType[componentType]
      );
      var max = MetadataComponentType.getMaximum(
        MetadataComponentType[componentType]
      );
      var values = [min, min / 2, 0, max / 2, max];
      var expectedResults = [-1.0, -0.5, 0.0, 0.5, 1.0];
      for (var j = 0; j < values.length; ++j) {
        var result = MetadataComponentType.normalize(values[j], componentType);
  ...
  it("normalizes unsigned integers", function () {
    ...
    for (var i = 0; i < unsignedComponentTypes.length; ++i) {
      var componentType = unsignedComponentTypes[i];
      var max = MetadataComponentType.getMaximum(
        MetadataComponentType[componentType]
      );
  ...
  it("normalize throws without componentType", function () {
    expect(function () {
  ...
  it("normalize throws if componentType is not an integer type", function () {
    expect(function () {
  ...
  it("unnormalize throws without componentType", function () {
    expect(function () {
      MetadataComponentType.unnormalize(10.0);
    }).toThrowDeveloperError();
  });

  it("unnormalize throws if componentType is not an integer type", function () {
    expect(function () {
