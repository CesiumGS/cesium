...
defineSuite([
    ...
    it('get perspective projection matrix', function() {
        ...
        var expected = Matrix4.fromPerspectiveFieldOfView(frustum.fovy, frustum.aspectRatio, frustum.near, frustum.far);
    ...
    it('get infinite perspective matrix', function() {
        ...
        var expected = Matrix4.fromInfinitePerspectiveOffCenter(left, right, bottom, top, near);
