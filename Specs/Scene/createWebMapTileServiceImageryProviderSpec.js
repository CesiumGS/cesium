/*global defineSuite*/
defineSuite([
    'Scene/createWebMapTileServiceImageryProvider',
    'Core/Credit',
    'Core/DefaultProxy',
    'Core/defined',
    ...
    createWebMapTileServiceImageryProvider,
    Credit,
    DefaultProxy,
    defined,
    ...
    it('conforms to ImageryProvider interface', function() {
        expect(createWebMapTileServiceImageryProvider).toConformToInterface(ImageryProvider);
    });
    ...
    it('generates expected tile urls', function() {
        ...
        var provider = createWebMapTileServiceImageryProvider(options);
    ...
    it('resolves readyPromise', function() {
        var provider = createWebMapTileServiceImageryProvider({
            layer : 'someLayer',
            style : 'someStyle',
            url : 'http://wmts.invalid',
            tileMatrixSetID : 'someTMS'
    ...
    it("doesn't care about trailing question mark at the end of URL", function() {
        var provider1 = createWebMapTileServiceImageryProvider({
            layer : 'someLayer',
            style : 'someStyle',
            url : 'http://wmts.invalid',
            tileMatrixSetID : 'someTMS'
        });
        var provider2 = createWebMapTileServiceImageryProvider({
            layer : 'someLayer',
            style : 'someStyle',
            url : 'http://wmts.invalid?',
            tileMatrixSetID : 'someTMS'
