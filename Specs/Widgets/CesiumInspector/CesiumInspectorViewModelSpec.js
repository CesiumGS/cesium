...
defineSuite([
    ...
    beforeEach(function() {
        scene.centralBody = new CentralBody();
    ...
    it('show wireframe', function() {
        ...
        expect(viewModel.scene.centralBody._surface._debug.wireframe).toBe(true);

        viewModel.wireframe = false;
        viewModel.showWireframe();
        expect(viewModel.scene.centralBody._surface._debug.wireframe).toBe(false);
    });
    ...
    it('suspend updates', function() {
        ...
        expect(viewModel.scene.centralBody._surface._debug.suspendLodUpdate).toBe(true);

        viewModel.suspendUpdates = false;
        viewModel.doSuspendUpdates();
        expect(viewModel.scene.centralBody._surface._debug.suspendLodUpdate).toBe(false);
    });
    ...
    it('show tile bounding sphere', function() {
        ...
        expect(viewModel.scene.centralBody._surface._debug.boundingSphereTile).toBe(tile);

        viewModel.tileBoundingSphere = false;
        viewModel.showTileBoundingSphere();
        expect(viewModel.scene.centralBody._surface._debug.boundingSphereTile).toBe(undefined);
    });
    ...
    it('filter tile', function() {
        ...
        expect(viewModel.scene.centralBody._surface._tilesToRenderByTextureCount[0][0]).toBe(tile);
