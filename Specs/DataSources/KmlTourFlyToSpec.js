...
describe('DataSources/KmlTourFlyTo', function() {
    ...
    it('calls camera flyTo for KmlCamera', function() {
        ...
        var flyFake = jasmine.createSpy('flyTo')
    ...
    it('calls camera flyToBoundingSphere for KmlLookAt', function() {
        ...
        var doneSpy = jasmine.createSpy('cameraDone');
        var flyFake = jasmine.createSpy('flyToBoundingSphere')
        ...
        return pollToPromise(function() {
            ...
            expect(fakeCamera.flyToBoundingSphere.calls.mostRecent().args[0].center.z).toEqual(position.z);
            expect(fakeCamera.flyToBoundingSphere.calls.mostRecent().args[1].offset).toBe(hpr);
            expect(doneSpy).toHaveBeenCalled();
        });
    });
