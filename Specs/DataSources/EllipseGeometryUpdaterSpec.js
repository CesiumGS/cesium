...
defineSuite([
    ...
    it('dynamic updater sets properties 2', function() {
        var ellipse = new EllipseGraphics();
        ellipse.show = createDynamicProperty(true);
        ellipse.semiMajorAxis = createDynamicProperty(2);
        ellipse.semiMinorAxis = createDynamicProperty(1);
    ...
    it('dynamic updater sets properties 2', function() {
        ...
        entity.position.setValue(Cartesian3.UNIT_Z);
        ellipse.semiMinorAxis.setValue(undefined);
        dynamicUpdater.update(JulianDate.now());
        expect(primitives.length).toBe(0);

        ellipse.semiMinorAxis.setValue(1);
