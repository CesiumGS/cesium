defineSuite([
    ...
    createGeometryUpdaterSpecs(RectangleGeometryUpdater, 'rectangle', createBasicRectangle, getScene);

    createDynamicGeometryUpdaterSpecs(RectangleGeometryUpdater, 'rectangle', createDynamicRectangle, getScene);
