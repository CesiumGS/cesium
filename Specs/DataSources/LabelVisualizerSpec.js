defineSuite([
    ...
    it('A LabelGraphics causes a label to be created and updated.', function() {
        ...
        label.rightToLeft = new ConstantProperty(false);
        ...
        expect(l.rightToLeft).toEqual(testObject.label.rightToLeft.getValue(time));
        ...
        label.rightToLeft = new ConstantProperty(true);
