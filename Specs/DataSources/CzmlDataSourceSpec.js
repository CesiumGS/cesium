...
defineSuite([
    ...
    it('checks validation document', function() {
        return CzmlDataSource.load('Data/CZML/ValidationDocument.czml').then(function(dataSource) {
            ...
            expect(e.model.color.getValue(date)).toEqual(Color.fromBytes(54, 55, 56, 53));
            expect(e.model.colorBlendMode.getValue(date)).toEqual(ColorBlendMode.REPLACE);
            expect(e.model.colorBlendAmount.getValue(date)).toEqual(35.0);
            ...
            expect(e.path.width.getValue(date)).toEqual(36.0);
            expect(e.path.resolution.getValue(date)).toEqual(37.0);
            expect(e.path.leadTime.getValue(date)).toEqual(38.0);
            expect(e.path.trailTime.getValue(date)).toEqual(39.0);
            expect(e.path.material.color.getValue(date)).toEqual(Color.fromBytes(58, 59, 60, 57));
            expect(e.point.show.getValue(date)).toEqual(true);
            expect(e.point.pixelSize.getValue(date)).toEqual(40.0);
            expect(e.point.heightReference.getValue(date)).toEqual(HeightReference.CLAMP_TO_GROUND);
            expect(e.point.color.getValue(date)).toEqual(Color.fromBytes(62, 63, 64, 61));
            expect(e.point.outlineColor.getValue(date)).toEqual(Color.fromBytes(66, 67, 68, 65));
            expect(e.point.outlineWidth.getValue(date)).toEqual(41.0);
            ...
            expect(e.polygon.height.getValue(date)).toEqual(42.0);
            expect(e.polygon.extrudedHeight.getValue(date)).toEqual(43.0);
            expect(e.polygon.stRotation.getValue(date)).toEqual(44.0);
            expect(e.polygon.granularity.getValue(date)).toEqual(45.0);
            expect(e.polygon.fill.getValue(date)).toEqual(true);
            expect(e.polygon.material.color.getValue(date)).toEqual(Color.fromBytes(70, 71, 72, 69));
            expect(e.polygon.outline.getValue(date)).toEqual(true);
            expect(e.polygon.outlineColor.getValue(date)).toEqual(Color.fromBytes(74, 75, 76, 73));
            expect(e.polygon.outlineWidth.getValue(date)).toEqual(46.0);
            ...
            expect(e.polyline.width.getValue(date)).toEqual(47.0);
            expect(e.polyline.granularity.getValue(date)).toEqual(48.0);
            expect(e.polyline.material.color.getValue(date)).toEqual(Color.fromBytes(78, 79, 80, 77));
            ...
            expect(e.rectangle.height.getValue(date)).toEqual(49.0);
            expect(e.rectangle.extrudedHeight.getValue(date)).toEqual(50.0);
            expect(e.rectangle.rotation.getValue(date)).toEqual(51.0);
            expect(e.rectangle.stRotation.getValue(date)).toEqual(52.0);
            expect(e.rectangle.granularity.getValue(date)).toEqual(53.0);
            expect(e.rectangle.fill.getValue(date)).toEqual(true);
            expect(e.rectangle.material.color.getValue(date)).toEqual(Color.fromBytes(82, 83, 84, 81));
            expect(e.rectangle.outline.getValue(date)).toEqual(true);
            expect(e.rectangle.outlineColor.getValue(date)).toEqual(Color.fromBytes(86, 87, 88, 85));
            expect(e.rectangle.outlineWidth.getValue(date)).toEqual(54.0);
            ...
            expect(e.wall.granularity.getValue(date)).toEqual(55.0);
            expect(e.wall.fill.getValue(date)).toEqual(true);
            expect(e.wall.material.color.getValue(date)).toEqual(Color.fromBytes(90, 91, 92, 89));
            expect(e.wall.outline.getValue(date)).toEqual(true);
            expect(e.wall.outlineColor.getValue(date)).toEqual(Color.fromBytes(94, 95, 96, 93));
            expect(e.wall.outlineWidth.getValue(date)).toEqual(56.0);
            ...
            expect(e.box.material.color.getValue(date)).toEqual(Color.fromBytes(198, 199, 200, 197));
            expect(e.box.material.cellAlpha.getValue(date)).toEqual(77.0);
            ...
            expect(e.box.material.evenColor.getValue(date)).toEqual(Color.fromBytes(202, 203, 204, 201));
            expect(e.box.material.oddColor.getValue(date)).toEqual(Color.fromBytes(206, 207, 208, 205));
            expect(e.box.material.offset.getValue(date)).toEqual(78.0);
            expect(e.box.material.repeat.getValue(date)).toEqual(79.0);
            ...
            expect(e.corridor.material.color.getValue(date)).toEqual(Color.fromBytes(214, 215, 216, 213));
            expect(e.corridor.material.cellAlpha.getValue(date)).toEqual(80.0);
            ...
            expect(e.corridor.material.evenColor.getValue(date)).toEqual(Color.fromBytes(218, 219, 220, 217));
            expect(e.corridor.material.oddColor.getValue(date)).toEqual(Color.fromBytes(222, 223, 224, 221));
            expect(e.corridor.material.offset.getValue(date)).toEqual(81.0);
            expect(e.corridor.material.repeat.getValue(date)).toEqual(82.0);
            ...
            expect(e.cylinder.material.color.getValue(date)).toEqual(Color.fromBytes(230, 231, 232, 229));
            expect(e.cylinder.material.cellAlpha.getValue(date)).toEqual(83.0);
            ...
            expect(e.cylinder.material.evenColor.getValue(date)).toEqual(Color.fromBytes(234, 235, 236, 233));
            expect(e.cylinder.material.oddColor.getValue(date)).toEqual(Color.fromBytes(238, 239, 240, 237));
            expect(e.cylinder.material.offset.getValue(date)).toEqual(84.0);
            expect(e.cylinder.material.repeat.getValue(date)).toEqual(85.0);
            ...
            expect(e.ellipse.material.color.getValue(date)).toEqual(Color.fromBytes(246, 247, 248, 245));
            expect(e.ellipse.material.cellAlpha.getValue(date)).toEqual(86.0);
            ...
            expect(e.ellipse.material.evenColor.getValue(date)).toEqual(Color.fromBytes(250, 251, 252, 249));
            expect(e.ellipse.material.oddColor.getValue(date)).toEqual(Color.fromBytes(254, 0, 1, 253));
            expect(e.ellipse.material.offset.getValue(date)).toEqual(87.0);
            expect(e.ellipse.material.repeat.getValue(date)).toEqual(88.0);
            ...
            expect(e.ellipsoid.material.color.getValue(date)).toEqual(Color.fromBytes(7, 8, 9, 6));
            expect(e.ellipsoid.material.cellAlpha.getValue(date)).toEqual(89.0);
            ...
            expect(e.ellipsoid.material.evenColor.getValue(date)).toEqual(Color.fromBytes(11, 12, 13, 10));
            expect(e.ellipsoid.material.oddColor.getValue(date)).toEqual(Color.fromBytes(15, 16, 17, 14));
            expect(e.ellipsoid.material.offset.getValue(date)).toEqual(90.0);
            expect(e.ellipsoid.material.repeat.getValue(date)).toEqual(91.0);
            ...
            expect(e.model.color.getValue(date)).toEqualEpsilon(new Color(0.525490196078431, 0.529411764705882, 0.533333333333333, 0.52156862745098), 1e-14);
            ...
            expect(e.path.material.color.getValue(date)).toEqual(Color.fromBytes(19, 20, 21, 18));
            expect(e.path.material.outlineColor.getValue(date)).toEqual(Color.fromBytes(23, 24, 25, 22));
            expect(e.path.material.outlineWidth.getValue(date)).toEqual(92.0);
            ...
            expect(e.path.material.glowPower.getValue(date)).toEqual(93.0);
            ...
            expect(e.path.material.color.getValue(date)).toEqual(Color.fromBytes(39, 40, 41, 38));
            expect(e.path.material.cellAlpha.getValue(date)).toEqual(94.0);
            ...
            expect(e.path.material.evenColor.getValue(date)).toEqual(Color.fromBytes(43, 44, 45, 42));
            expect(e.path.material.oddColor.getValue(date)).toEqual(Color.fromBytes(47, 48, 49, 46));
            expect(e.path.material.offset.getValue(date)).toEqual(95.0);
            expect(e.path.material.repeat.getValue(date)).toEqual(96.0);
            expect(e = dataSource.entities.getById('material21')).toBeDefined();
            expect(e.path.material.color.getValue(date)).toEqualEpsilon(new Color(0.556862745098039, 0.56078431372549, 0.564705882352941, 0.552941176470588), 1e-14);
            expect(e = dataSource.entities.getById('material22')).toBeDefined();
            expect(e.path.material.outlineColor.getValue(date)).toEqualEpsilon(new Color(0.572549019607843, 0.576470588235294, 0.580392156862745, 0.568627450980392), 1e-14);
            ...
            expect(e.path.material.color.getValue(date)).toEqualEpsilon(new Color(0.635294117647059, 0.63921568627451, 0.643137254901961, 0.631372549019608), 1e-14);
            expect(e = dataSource.entities.getById('material27')).toBeDefined();
            expect(e.path.material.evenColor.getValue(date)).toEqualEpsilon(new Color(0.650980392156863, 0.654901960784314, 0.658823529411765, 0.647058823529412), 1e-14);
            expect(e = dataSource.entities.getById('material28')).toBeDefined();
            expect(e.path.material.oddColor.getValue(date)).toEqualEpsilon(new Color(0.666666666666667, 0.670588235294118, 0.674509803921569, 0.662745098039216), 1e-14);
            expect(e = dataSource.entities.getById('constant22')).toBeDefined();
            expect(e.point.color.getValue(date)).toEqualEpsilon(new Color(0.682352941176471, 0.686274509803922, 0.690196078431373, 0.67843137254902), 1e-14);
            expect(e = dataSource.entities.getById('constant23')).toBeDefined();
            expect(e.point.outlineColor.getValue(date)).toEqualEpsilon(new Color(0.698039215686274, 0.701960784313725, 0.705882352941177, 0.694117647058824), 1e-14);
            ...
            expect(e.polygon.material.color.getValue(date)).toEqual(Color.fromBytes(55, 56, 57, 54));
            expect(e.polygon.material.cellAlpha.getValue(date)).toEqual(97.0);
            ...
            expect(e.polygon.material.evenColor.getValue(date)).toEqual(Color.fromBytes(59, 60, 61, 58));
            expect(e.polygon.material.oddColor.getValue(date)).toEqual(Color.fromBytes(63, 64, 65, 62));
            expect(e.polygon.material.offset.getValue(date)).toEqual(98.0);
            expect(e.polygon.material.repeat.getValue(date)).toEqual(99.0);
            ...
            expect(e.polygon.material.color.getValue(date)).toEqualEpsilon(new Color(0.745098039215686, 0.749019607843137, 0.752941176470588, 0.741176470588235), 1e-14);
            expect(e = dataSource.entities.getById('material31')).toBeDefined();
            expect(e.polygon.material.evenColor.getValue(date)).toEqualEpsilon(new Color(0.76078431372549, 0.764705882352941, 0.768627450980392, 0.756862745098039), 1e-14);
            expect(e = dataSource.entities.getById('material32')).toBeDefined();
            expect(e.polygon.material.oddColor.getValue(date)).toEqualEpsilon(new Color(0.776470588235294, 0.780392156862745, 0.784313725490196, 0.772549019607843), 1e-14);
            expect(e = dataSource.entities.getById('constant27')).toBeDefined();
            expect(e.polygon.outlineColor.getValue(date)).toEqualEpsilon(new Color(0.792156862745098, 0.796078431372549, 0.8, 0.788235294117647), 1e-14);
            ...
            expect(e.polyline.material.color.getValue(date)).toEqual(Color.fromBytes(67, 68, 69, 66));
            expect(e.polyline.material.outlineColor.getValue(date)).toEqual(Color.fromBytes(71, 72, 73, 70));
            expect(e.polyline.material.outlineWidth.getValue(date)).toEqual(100.0);
            ...
            expect(e.polyline.material.glowPower.getValue(date)).toEqual(101.0);
            ...
            expect(e.polyline.material.color.getValue(date)).toEqual(Color.fromBytes(87, 88, 89, 86));
            expect(e.polyline.material.cellAlpha.getValue(date)).toEqual(102.0);
            ...
            expect(e.polyline.material.evenColor.getValue(date)).toEqual(Color.fromBytes(91, 92, 93, 90));
            expect(e.polyline.material.oddColor.getValue(date)).toEqual(Color.fromBytes(95, 96, 97, 94));
            expect(e.polyline.material.offset.getValue(date)).toEqual(103.0);
            expect(e.polyline.material.repeat.getValue(date)).toEqual(104.0);
            ...
            expect(e.polyline.material.outlineColor.getValue(date)).toEqualEpsilon(new Color(0.83921568627451, 0.843137254901961, 0.847058823529412, 0.835294117647059), 1e-14);
            ...
            expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(new Color(0.901960784313726, 0.905882352941176, 0.909803921568627, 0.898039215686275), 1e-14);
            expect(e = dataSource.entities.getById('material39')).toBeDefined();
            expect(e.polyline.material.evenColor.getValue(date)).toEqualEpsilon(new Color(0.917647058823529, 0.92156862745098, 0.925490196078431, 0.913725490196078), 1e-14);
            expect(e = dataSource.entities.getById('material40')).toBeDefined();
            expect(e.polyline.material.oddColor.getValue(date)).toEqualEpsilon(new Color(0.933333333333333, 0.937254901960784, 0.941176470588235, 0.929411764705882), 1e-14);
            ...
            expect(e.rectangle.material.color.getValue(date)).toEqual(Color.fromBytes(103, 104, 105, 102));
            expect(e.rectangle.material.cellAlpha.getValue(date)).toEqual(105.0);
            ...
            expect(e.rectangle.material.evenColor.getValue(date)).toEqual(Color.fromBytes(107, 108, 109, 106));
            expect(e.rectangle.material.oddColor.getValue(date)).toEqual(Color.fromBytes(111, 112, 113, 110));
            expect(e.rectangle.material.offset.getValue(date)).toEqual(106.0);
            expect(e.rectangle.material.repeat.getValue(date)).toEqual(107.0);
            ...
            expect(e.rectangle.material.color.getValue(date)).toEqualEpsilon(new Color(0.980392156862745, 0.984313725490196, 0.988235294117647, 0.976470588235294), 1e-14);
            expect(e = dataSource.entities.getById('material43')).toBeDefined();
            expect(e.rectangle.material.evenColor.getValue(date)).toEqualEpsilon(new Color(0.996078431372549, 0, 0.00392156862745098, 0.992156862745098), 1e-14);
            expect(e = dataSource.entities.getById('material44')).toBeDefined();
            expect(e.rectangle.material.oddColor.getValue(date)).toEqualEpsilon(new Color(0.0117647058823529, 0.0156862745098039, 0.0196078431372549, 0.00784313725490196), 1e-14);
            expect(e = dataSource.entities.getById('constant33')).toBeDefined();
            expect(e.rectangle.outlineColor.getValue(date)).toEqualEpsilon(new Color(0.0274509803921569, 0.0313725490196078, 0.0352941176470588, 0.0235294117647059), 1e-14);
            ...
            expect(e.wall.material.color.getValue(date)).toEqual(Color.fromBytes(119, 120, 121, 118));
            expect(e.wall.material.cellAlpha.getValue(date)).toEqual(108.0);
            ...
            expect(e.wall.material.evenColor.getValue(date)).toEqual(Color.fromBytes(123, 124, 125, 122));
            expect(e.wall.material.oddColor.getValue(date)).toEqual(Color.fromBytes(127, 128, 129, 126));
            expect(e.wall.material.offset.getValue(date)).toEqual(109.0);
            expect(e.wall.material.repeat.getValue(date)).toEqual(110.0);
            ...
            expect(e.wall.material.color.getValue(date)).toEqualEpsilon(new Color(0.0745098039215686, 0.0784313725490196, 0.0823529411764706, 0.0705882352941176), 1e-14);
            expect(e = dataSource.entities.getById('material47')).toBeDefined();
            expect(e.wall.material.evenColor.getValue(date)).toEqualEpsilon(new Color(0.0901960784313725, 0.0941176470588235, 0.0980392156862745, 0.0862745098039216), 1e-14);
            expect(e = dataSource.entities.getById('material48')).toBeDefined();
            expect(e.wall.material.oddColor.getValue(date)).toEqualEpsilon(new Color(0.105882352941176, 0.109803921568627, 0.113725490196078, 0.101960784313725), 1e-14);
            expect(e = dataSource.entities.getById('constant37')).toBeDefined();
            expect(e.wall.outlineColor.getValue(date)).toEqualEpsilon(new Color(0.12156862745098, 0.125490196078431, 0.129411764705882, 0.117647058823529), 1e-14);
            ...
            expect(e = dataSource.entities.getById('constant70')).toBeDefined();
            ...
            expect(e.billboard.scale.getValue(date)).toEqual(160.0);
            ...
            expect(e.billboard.scale.getValue(documentStartDate)).toEqual(161.0);
            expect(e.billboard.scale.getValue(documentStopDate)).toEqual(162.0);
            ...
            expect(e.billboard.color.getValue(documentStartDate)).toEqual(Color.fromBytes(132, 133, 134, 131));
            expect(e.billboard.color.getValue(documentStopDate)).toEqual(Color.fromBytes(136, 137, 138, 135));
            expect(e.billboard.rotation.getValue(documentStartDate)).toEqual(163.0);
            expect(e.billboard.rotation.getValue(documentStopDate)).toEqual(164.0);
            ...
            expect(e.billboard.width.getValue(documentStartDate)).toEqual(165.0);
            expect(e.billboard.width.getValue(documentStopDate)).toEqual(166.0);
            expect(e.billboard.height.getValue(documentStartDate)).toEqual(167.0);
            expect(e.billboard.height.getValue(documentStopDate)).toEqual(168.0);
            ...
            expect(e.box.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(140, 141, 142, 139));
            expect(e.box.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(144, 145, 146, 143));
            expect(e.box.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(148, 149, 150, 147));
            expect(e.box.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(152, 153, 154, 151));
            expect(e.box.outlineWidth.getValue(documentStartDate)).toEqual(169.0);
            expect(e.box.outlineWidth.getValue(documentStopDate)).toEqual(170.0);
            expect(e.corridor.width.getValue(documentStartDate)).toEqual(171.0);
            expect(e.corridor.width.getValue(documentStopDate)).toEqual(172.0);
            expect(e.corridor.height.getValue(documentStartDate)).toEqual(173.0);
            expect(e.corridor.height.getValue(documentStopDate)).toEqual(174.0);
            expect(e.corridor.extrudedHeight.getValue(documentStartDate)).toEqual(175.0);
            expect(e.corridor.extrudedHeight.getValue(documentStopDate)).toEqual(176.0);
            expect(e.corridor.granularity.getValue(documentStartDate)).toEqual(177.0);
            expect(e.corridor.granularity.getValue(documentStopDate)).toEqual(178.0);
            expect(e.corridor.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(156, 157, 158, 155));
            expect(e.corridor.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(160, 161, 162, 159));
            expect(e.corridor.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(164, 165, 166, 163));
            expect(e.corridor.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(168, 169, 170, 167));
            expect(e.corridor.outlineWidth.getValue(documentStartDate)).toEqual(179.0);
            expect(e.corridor.outlineWidth.getValue(documentStopDate)).toEqual(180.0);
            expect(e.cylinder.length.getValue(documentStartDate)).toEqual(181.0);
            expect(e.cylinder.length.getValue(documentStopDate)).toEqual(182.0);
            expect(e.cylinder.topRadius.getValue(documentStartDate)).toEqual(183.0);
            expect(e.cylinder.topRadius.getValue(documentStopDate)).toEqual(184.0);
            expect(e.cylinder.bottomRadius.getValue(documentStartDate)).toEqual(185.0);
            expect(e.cylinder.bottomRadius.getValue(documentStopDate)).toEqual(186.0);
            expect(e.cylinder.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(172, 173, 174, 171));
            expect(e.cylinder.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(176, 177, 178, 175));
            expect(e.cylinder.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(180, 181, 182, 179));
            expect(e.cylinder.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(184, 185, 186, 183));
            expect(e.cylinder.outlineWidth.getValue(documentStartDate)).toEqual(187.0);
            expect(e.cylinder.outlineWidth.getValue(documentStopDate)).toEqual(188.0);
            expect(e.cylinder.numberOfVerticalLines.getValue(documentStartDate)).toEqual(189.0);
            expect(e.cylinder.numberOfVerticalLines.getValue(documentStopDate)).toEqual(190.0);
            expect(e.cylinder.slices.getValue(documentStartDate)).toEqual(191.0);
            expect(e.cylinder.slices.getValue(documentStopDate)).toEqual(192.0);
            expect(e.ellipse.semiMajorAxis.getValue(documentStartDate)).toEqual(193.0);
            expect(e.ellipse.semiMajorAxis.getValue(documentStopDate)).toEqual(194.0);
            expect(e.ellipse.semiMinorAxis.getValue(documentStartDate)).toEqual(195.0);
            expect(e.ellipse.semiMinorAxis.getValue(documentStopDate)).toEqual(196.0);
            expect(e.ellipse.height.getValue(documentStartDate)).toEqual(197.0);
            expect(e.ellipse.height.getValue(documentStopDate)).toEqual(198.0);
            expect(e.ellipse.extrudedHeight.getValue(documentStartDate)).toEqual(199.0);
            expect(e.ellipse.extrudedHeight.getValue(documentStopDate)).toEqual(200.0);
            expect(e.ellipse.rotation.getValue(documentStartDate)).toEqual(201.0);
            expect(e.ellipse.rotation.getValue(documentStopDate)).toEqual(202.0);
            expect(e.ellipse.stRotation.getValue(documentStartDate)).toEqual(203.0);
            expect(e.ellipse.stRotation.getValue(documentStopDate)).toEqual(204.0);
            expect(e.ellipse.granularity.getValue(documentStartDate)).toEqual(205.0);
            expect(e.ellipse.granularity.getValue(documentStopDate)).toEqual(206.0);
            expect(e.ellipse.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(188, 189, 190, 187));
            expect(e.ellipse.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(192, 193, 194, 191));
            expect(e.ellipse.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(196, 197, 198, 195));
            expect(e.ellipse.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(200, 201, 202, 199));
            expect(e.ellipse.outlineWidth.getValue(documentStartDate)).toEqual(207.0);
            expect(e.ellipse.outlineWidth.getValue(documentStopDate)).toEqual(208.0);
            expect(e.ellipse.numberOfVerticalLines.getValue(documentStartDate)).toEqual(209.0);
            expect(e.ellipse.numberOfVerticalLines.getValue(documentStopDate)).toEqual(210.0);
            ...
            expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(204, 205, 206, 203));
            expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(208, 209, 210, 207));
            expect(e.ellipsoid.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(212, 213, 214, 211));
            expect(e.ellipsoid.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(216, 217, 218, 215));
            expect(e.ellipsoid.outlineWidth.getValue(documentStartDate)).toEqual(211.0);
            expect(e.ellipsoid.outlineWidth.getValue(documentStopDate)).toEqual(212.0);
            expect(e.ellipsoid.stackPartitions.getValue(documentStartDate)).toEqual(213.0);
            expect(e.ellipsoid.stackPartitions.getValue(documentStopDate)).toEqual(214.0);
            expect(e.ellipsoid.slicePartitions.getValue(documentStartDate)).toEqual(215.0);
            expect(e.ellipsoid.slicePartitions.getValue(documentStopDate)).toEqual(216.0);
            expect(e.ellipsoid.subdivisions.getValue(documentStartDate)).toEqual(217.0);
            expect(e.ellipsoid.subdivisions.getValue(documentStopDate)).toEqual(218.0);
            expect(e.label.scale.getValue(documentStartDate)).toEqual(219.0);
            expect(e.label.scale.getValue(documentStopDate)).toEqual(220.0);
            ...
            expect(e.label.fillColor.getValue(documentStartDate)).toEqual(Color.fromBytes(220, 221, 222, 219));
            expect(e.label.fillColor.getValue(documentStopDate)).toEqual(Color.fromBytes(224, 225, 226, 223));
            expect(e.label.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(228, 229, 230, 227));
            expect(e.label.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(232, 233, 234, 231));
            expect(e.label.outlineWidth.getValue(documentStartDate)).toEqual(221.0);
            expect(e.label.outlineWidth.getValue(documentStopDate)).toEqual(222.0);
            ...
            expect(e.model.scale.getValue(documentStartDate)).toEqual(223.0);
            expect(e.model.scale.getValue(documentStopDate)).toEqual(224.0);
            expect(e.model.minimumPixelSize.getValue(documentStartDate)).toEqual(225.0);
            expect(e.model.minimumPixelSize.getValue(documentStopDate)).toEqual(226.0);
            expect(e.model.maximumScale.getValue(documentStartDate)).toEqual(227.0);
            expect(e.model.maximumScale.getValue(documentStopDate)).toEqual(228.0);
            expect(e.model.color.getValue(documentStartDate)).toEqual(Color.fromBytes(236, 237, 238, 235));
            expect(e.model.color.getValue(documentStopDate)).toEqual(Color.fromBytes(240, 241, 242, 239));
            expect(e.model.colorBlendAmount.getValue(documentStartDate)).toEqual(229.0);
            expect(e.model.colorBlendAmount.getValue(documentStopDate)).toEqual(230.0);
            expect(e.path.width.getValue(documentStartDate)).toEqual(231.0);
            expect(e.path.width.getValue(documentStopDate)).toEqual(232.0);
            expect(e.path.resolution.getValue(documentStartDate)).toEqual(233.0);
            expect(e.path.resolution.getValue(documentStopDate)).toEqual(234.0);
            expect(e.path.leadTime.getValue(documentStartDate)).toEqual(235.0);
            expect(e.path.leadTime.getValue(documentStopDate)).toEqual(236.0);
            expect(e.path.trailTime.getValue(documentStartDate)).toEqual(237.0);
            expect(e.path.trailTime.getValue(documentStopDate)).toEqual(238.0);
            expect(e.path.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(244, 245, 246, 243));
            expect(e.path.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(248, 249, 250, 247));
            expect(e.point.pixelSize.getValue(documentStartDate)).toEqual(239.0);
            expect(e.point.pixelSize.getValue(documentStopDate)).toEqual(240.0);
            expect(e.point.color.getValue(documentStartDate)).toEqual(Color.fromBytes(252, 253, 254, 251));
            expect(e.point.color.getValue(documentStopDate)).toEqual(Color.fromBytes(1, 2, 3, 0));
            expect(e.point.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(5, 6, 7, 4));
            expect(e.point.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(9, 10, 11, 8));
            expect(e.point.outlineWidth.getValue(documentStartDate)).toEqual(241.0);
            expect(e.point.outlineWidth.getValue(documentStopDate)).toEqual(242.0);
            ...
            expect(e.polygon.height.getValue(documentStartDate)).toEqual(243.0);
            expect(e.polygon.height.getValue(documentStopDate)).toEqual(244.0);
            expect(e.polygon.extrudedHeight.getValue(documentStartDate)).toEqual(245.0);
            expect(e.polygon.extrudedHeight.getValue(documentStopDate)).toEqual(246.0);
            expect(e.polygon.stRotation.getValue(documentStartDate)).toEqual(247.0);
            expect(e.polygon.stRotation.getValue(documentStopDate)).toEqual(248.0);
            expect(e.polygon.granularity.getValue(documentStartDate)).toEqual(249.0);
            expect(e.polygon.granularity.getValue(documentStopDate)).toEqual(250.0);
            expect(e.polygon.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(13, 14, 15, 12));
            expect(e.polygon.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(17, 18, 19, 16));
            expect(e.polygon.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(21, 22, 23, 20));
            expect(e.polygon.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(25, 26, 27, 24));
            expect(e.polygon.outlineWidth.getValue(documentStartDate)).toEqual(251.0);
            expect(e.polygon.outlineWidth.getValue(documentStopDate)).toEqual(252.0);
            expect(e.polyline.width.getValue(documentStartDate)).toEqual(253.0);
            expect(e.polyline.width.getValue(documentStopDate)).toEqual(254.0);
            expect(e.polyline.granularity.getValue(documentStartDate)).toEqual(255.0);
            expect(e.polyline.granularity.getValue(documentStopDate)).toEqual(256.0);
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(29, 30, 31, 28));
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(33, 34, 35, 32));
            ...
            expect(e.rectangle.height.getValue(documentStartDate)).toEqual(257.0);
            expect(e.rectangle.height.getValue(documentStopDate)).toEqual(258.0);
            expect(e.rectangle.extrudedHeight.getValue(documentStartDate)).toEqual(259.0);
            expect(e.rectangle.extrudedHeight.getValue(documentStopDate)).toEqual(260.0);
            expect(e.rectangle.rotation.getValue(documentStartDate)).toEqual(261.0);
            expect(e.rectangle.rotation.getValue(documentStopDate)).toEqual(262.0);
            expect(e.rectangle.stRotation.getValue(documentStartDate)).toEqual(263.0);
            expect(e.rectangle.stRotation.getValue(documentStopDate)).toEqual(264.0);
            expect(e.rectangle.granularity.getValue(documentStartDate)).toEqual(265.0);
            expect(e.rectangle.granularity.getValue(documentStopDate)).toEqual(266.0);
            expect(e.rectangle.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(37, 38, 39, 36));
            expect(e.rectangle.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(41, 42, 43, 40));
            expect(e.rectangle.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(45, 46, 47, 44));
            expect(e.rectangle.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(49, 50, 51, 48));
            expect(e.rectangle.outlineWidth.getValue(documentStartDate)).toEqual(267.0);
            expect(e.rectangle.outlineWidth.getValue(documentStopDate)).toEqual(268.0);
            expect(e.wall.granularity.getValue(documentStartDate)).toEqual(269.0);
            expect(e.wall.granularity.getValue(documentStopDate)).toEqual(270.0);
            expect(e.wall.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(53, 54, 55, 52));
            expect(e.wall.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(57, 58, 59, 56));
            expect(e.wall.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(61, 62, 63, 60));
            expect(e.wall.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(65, 66, 67, 64));
            expect(e.wall.outlineWidth.getValue(documentStartDate)).toEqual(271.0);
            expect(e.wall.outlineWidth.getValue(documentStopDate)).toEqual(272.0);
            ...
            expect(e.billboard.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.517647058823529, 0.52156862745098, 0.525490196078431, 0.513725490196078), 1e-14);
            expect(e.billboard.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.533333333333333, 0.537254901960784, 0.541176470588235, 0.529411764705882), 1e-14);
            ...
            expect(e.box.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.549019607843137, 0.552941176470588, 0.556862745098039, 0.545098039215686), 1e-14);
            expect(e.box.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.564705882352941, 0.568627450980392, 0.572549019607843, 0.56078431372549), 1e-14);
            ...
            expect(e.box.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(6, 7, 8, 5));
            expect(e.box.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(10, 11, 12, 9));
            expect(e = dataSource.entities.getById('sampled8')).toBeDefined();
            expect(e.box.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(14, 15, 16, 13));
            expect(e.box.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(18, 19, 20, 17));
            expect(e.box.material.cellAlpha.getValue(documentStartDate)).toEqual(313.0);
            expect(e.box.material.cellAlpha.getValue(documentStopDate)).toEqual(314.0);
            ...
            expect(e.box.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(22, 23, 24, 21));
            expect(e.box.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(26, 27, 28, 25));
            expect(e.box.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(30, 31, 32, 29));
            expect(e.box.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(34, 35, 36, 33));
            expect(e.box.material.offset.getValue(documentStartDate)).toEqual(315.0);
            expect(e.box.material.offset.getValue(documentStopDate)).toEqual(316.0);
            expect(e.box.material.repeat.getValue(documentStartDate)).toEqual(317.0);
            expect(e.box.material.repeat.getValue(documentStopDate)).toEqual(318.0);
            expect(e = dataSource.entities.getById('sampled10')).toBeDefined();
            expect(e.box.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.580392156862745, 0.584313725490196, 0.588235294117647, 0.576470588235294), 1e-14);
            expect(e.box.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.596078431372549, 0.6, 0.603921568627451, 0.592156862745098), 1e-14);
            expect(e = dataSource.entities.getById('sampled11')).toBeDefined();
            expect(e.box.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.611764705882353, 0.615686274509804, 0.619607843137255, 0.607843137254902), 1e-14);
            expect(e.box.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.627450980392157, 0.631372549019608, 0.635294117647059, 0.623529411764706), 1e-14);
            expect(e = dataSource.entities.getById('sampled12')).toBeDefined();
            expect(e.box.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.643137254901961, 0.647058823529412, 0.650980392156863, 0.63921568627451), 1e-14);
            expect(e.box.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.658823529411765, 0.662745098039216, 0.666666666666667, 0.654901960784314), 1e-14);
            expect(e = dataSource.entities.getById('sampled13')).toBeDefined();
            expect(e.box.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.674509803921569, 0.67843137254902, 0.682352941176471, 0.670588235294118), 1e-14);
            expect(e.box.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.690196078431373, 0.694117647058824, 0.698039215686274, 0.686274509803922), 1e-14);
            expect(e = dataSource.entities.getById('sampled14')).toBeDefined();
            expect(e.box.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.705882352941177, 0.709803921568627, 0.713725490196078, 0.701960784313725), 1e-14);
            expect(e.box.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.72156862745098, 0.725490196078431, 0.729411764705882, 0.717647058823529), 1e-14);
            expect(e = dataSource.entities.getById('sampled15')).toBeDefined();
            expect(e.corridor.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.737254901960784, 0.741176470588235, 0.745098039215686, 0.733333333333333), 1e-14);
            expect(e.corridor.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.752941176470588, 0.756862745098039, 0.76078431372549, 0.749019607843137), 1e-14);
            ...
            expect(e.corridor.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(38, 39, 40, 37));
            expect(e.corridor.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(42, 43, 44, 41));
            expect(e = dataSource.entities.getById('sampled17')).toBeDefined();
            expect(e.corridor.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(46, 47, 48, 45));
            expect(e.corridor.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(50, 51, 52, 49));
            expect(e.corridor.material.cellAlpha.getValue(documentStartDate)).toEqual(319.0);
            expect(e.corridor.material.cellAlpha.getValue(documentStopDate)).toEqual(320.0);
            ...
            expect(e.corridor.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(54, 55, 56, 53));
            expect(e.corridor.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(58, 59, 60, 57));
            expect(e.corridor.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(62, 63, 64, 61));
            expect(e.corridor.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(66, 67, 68, 65));
            expect(e.corridor.material.offset.getValue(documentStartDate)).toEqual(321.0);
            expect(e.corridor.material.offset.getValue(documentStopDate)).toEqual(322.0);
            expect(e.corridor.material.repeat.getValue(documentStartDate)).toEqual(323.0);
            expect(e.corridor.material.repeat.getValue(documentStopDate)).toEqual(324.0);
            expect(e = dataSource.entities.getById('sampled19')).toBeDefined();
            expect(e.corridor.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.768627450980392, 0.772549019607843, 0.776470588235294, 0.764705882352941), 1e-14);
            expect(e.corridor.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.784313725490196, 0.788235294117647, 0.792156862745098, 0.780392156862745), 1e-14);
            expect(e = dataSource.entities.getById('sampled20')).toBeDefined();
            expect(e.corridor.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.8, 0.803921568627451, 0.807843137254902, 0.796078431372549), 1e-14);
            expect(e.corridor.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.815686274509804, 0.819607843137255, 0.823529411764706, 0.811764705882353), 1e-14);
            expect(e = dataSource.entities.getById('sampled21')).toBeDefined();
            expect(e.corridor.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.831372549019608, 0.835294117647059, 0.83921568627451, 0.827450980392157), 1e-14);
            expect(e.corridor.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.847058823529412, 0.850980392156863, 0.854901960784314, 0.843137254901961), 1e-14);
            expect(e = dataSource.entities.getById('sampled22')).toBeDefined();
            expect(e.corridor.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.862745098039216, 0.866666666666667, 0.870588235294118, 0.858823529411765), 1e-14);
            expect(e.corridor.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.87843137254902, 0.882352941176471, 0.886274509803922, 0.874509803921569), 1e-14);
            expect(e = dataSource.entities.getById('sampled23')).toBeDefined();
            expect(e.corridor.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.894117647058824, 0.898039215686275, 0.901960784313726, 0.890196078431373), 1e-14);
            expect(e.corridor.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.909803921568627, 0.913725490196078, 0.917647058823529, 0.905882352941176), 1e-14);
            expect(e = dataSource.entities.getById('sampled24')).toBeDefined();
            expect(e.cylinder.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.925490196078431, 0.929411764705882, 0.933333333333333, 0.92156862745098), 1e-14);
            expect(e.cylinder.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.941176470588235, 0.945098039215686, 0.949019607843137, 0.937254901960784), 1e-14);
            ...
            expect(e.cylinder.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(70, 71, 72, 69));
            expect(e.cylinder.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(74, 75, 76, 73));
            expect(e = dataSource.entities.getById('sampled26')).toBeDefined();
            expect(e.cylinder.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(78, 79, 80, 77));
            expect(e.cylinder.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(82, 83, 84, 81));
            expect(e.cylinder.material.cellAlpha.getValue(documentStartDate)).toEqual(325.0);
            expect(e.cylinder.material.cellAlpha.getValue(documentStopDate)).toEqual(326.0);
            ...
            expect(e.cylinder.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(86, 87, 88, 85));
            expect(e.cylinder.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(90, 91, 92, 89));
            expect(e.cylinder.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(94, 95, 96, 93));
            expect(e.cylinder.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(98, 99, 100, 97));
            expect(e.cylinder.material.offset.getValue(documentStartDate)).toEqual(327.0);
            expect(e.cylinder.material.offset.getValue(documentStopDate)).toEqual(328.0);
            expect(e.cylinder.material.repeat.getValue(documentStartDate)).toEqual(329.0);
            expect(e.cylinder.material.repeat.getValue(documentStopDate)).toEqual(330.0);
            expect(e = dataSource.entities.getById('sampled28')).toBeDefined();
            expect(e.cylinder.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.956862745098039, 0.96078431372549, 0.964705882352941, 0.952941176470588), 1e-14);
            expect(e.cylinder.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.972549019607843, 0.976470588235294, 0.980392156862745, 0.968627450980392), 1e-14);
            expect(e = dataSource.entities.getById('sampled29')).toBeDefined();
            expect(e.cylinder.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.988235294117647, 0.992156862745098, 0.996078431372549, 0.984313725490196), 1e-14);
            expect(e.cylinder.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.00392156862745098, 0.00784313725490196, 0.0117647058823529, 0), 1e-14);
            expect(e = dataSource.entities.getById('sampled30')).toBeDefined();
            expect(e.cylinder.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.0196078431372549, 0.0235294117647059, 0.0274509803921569, 0.0156862745098039), 1e-14);
            expect(e.cylinder.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.0352941176470588, 0.0392156862745098, 0.0431372549019608, 0.0313725490196078), 1e-14);
            expect(e = dataSource.entities.getById('sampled31')).toBeDefined();
            expect(e.cylinder.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.0509803921568627, 0.0549019607843137, 0.0588235294117647, 0.0470588235294118), 1e-14);
            expect(e.cylinder.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.0666666666666667, 0.0705882352941176, 0.0745098039215686, 0.0627450980392157), 1e-14);
            expect(e = dataSource.entities.getById('sampled32')).toBeDefined();
            expect(e.cylinder.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.0823529411764706, 0.0862745098039216, 0.0901960784313725, 0.0784313725490196), 1e-14);
            expect(e.cylinder.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.0980392156862745, 0.101960784313725, 0.105882352941176, 0.0941176470588235), 1e-14);
            expect(e = dataSource.entities.getById('sampled33')).toBeDefined();
            expect(e.ellipse.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.113725490196078, 0.117647058823529, 0.12156862745098, 0.109803921568627), 1e-14);
            expect(e.ellipse.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.129411764705882, 0.133333333333333, 0.137254901960784, 0.125490196078431), 1e-14);
            ...
            expect(e.ellipse.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(102, 103, 104, 101));
            expect(e.ellipse.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(106, 107, 108, 105));
            expect(e = dataSource.entities.getById('sampled35')).toBeDefined();
            expect(e.ellipse.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(110, 111, 112, 109));
            expect(e.ellipse.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(114, 115, 116, 113));
            expect(e.ellipse.material.cellAlpha.getValue(documentStartDate)).toEqual(331.0);
            expect(e.ellipse.material.cellAlpha.getValue(documentStopDate)).toEqual(332.0);
            ...
            expect(e.ellipse.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(118, 119, 120, 117));
            expect(e.ellipse.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(122, 123, 124, 121));
            expect(e.ellipse.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(126, 127, 128, 125));
            expect(e.ellipse.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(130, 131, 132, 129));
            expect(e.ellipse.material.offset.getValue(documentStartDate)).toEqual(333.0);
            expect(e.ellipse.material.offset.getValue(documentStopDate)).toEqual(334.0);
            expect(e.ellipse.material.repeat.getValue(documentStartDate)).toEqual(335.0);
            expect(e.ellipse.material.repeat.getValue(documentStopDate)).toEqual(336.0);
            expect(e = dataSource.entities.getById('sampled37')).toBeDefined();
            expect(e.ellipse.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.145098039215686, 0.149019607843137, 0.152941176470588, 0.141176470588235), 1e-14);
            expect(e.ellipse.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.16078431372549, 0.164705882352941, 0.168627450980392, 0.156862745098039), 1e-14);
            expect(e = dataSource.entities.getById('sampled38')).toBeDefined();
            expect(e.ellipse.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.176470588235294, 0.180392156862745, 0.184313725490196, 0.172549019607843), 1e-14);
            expect(e.ellipse.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.192156862745098, 0.196078431372549, 0.2, 0.188235294117647), 1e-14);
            expect(e = dataSource.entities.getById('sampled39')).toBeDefined();
            expect(e.ellipse.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.207843137254902, 0.211764705882353, 0.215686274509804, 0.203921568627451), 1e-14);
            expect(e.ellipse.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.223529411764706, 0.227450980392157, 0.231372549019608, 0.219607843137255), 1e-14);
            expect(e = dataSource.entities.getById('sampled40')).toBeDefined();
            expect(e.ellipse.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.23921568627451, 0.243137254901961, 0.247058823529412, 0.235294117647059), 1e-14);
            expect(e.ellipse.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.254901960784314, 0.258823529411765, 0.262745098039216, 0.250980392156863), 1e-14);
            expect(e = dataSource.entities.getById('sampled41')).toBeDefined();
            expect(e.ellipse.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.270588235294118, 0.274509803921569, 0.27843137254902, 0.266666666666667), 1e-14);
            expect(e.ellipse.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.286274509803922, 0.290196078431373, 0.294117647058824, 0.282352941176471), 1e-14);
            expect(e = dataSource.entities.getById('sampled42')).toBeDefined();
            expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.301960784313725, 0.305882352941176, 0.309803921568627, 0.298039215686275), 1e-14);
            expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.317647058823529, 0.32156862745098, 0.325490196078431, 0.313725490196078), 1e-14);
            ...
            expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(134, 135, 136, 133));
            expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(138, 139, 140, 137));
            expect(e = dataSource.entities.getById('sampled44')).toBeDefined();
            expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(142, 143, 144, 141));
            expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(146, 147, 148, 145));
            expect(e.ellipsoid.material.cellAlpha.getValue(documentStartDate)).toEqual(337.0);
            expect(e.ellipsoid.material.cellAlpha.getValue(documentStopDate)).toEqual(338.0);
            ...
            expect(e.ellipsoid.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(150, 151, 152, 149));
            expect(e.ellipsoid.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(154, 155, 156, 153));
            expect(e.ellipsoid.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(158, 159, 160, 157));
            expect(e.ellipsoid.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(162, 163, 164, 161));
            expect(e.ellipsoid.material.offset.getValue(documentStartDate)).toEqual(339.0);
            expect(e.ellipsoid.material.offset.getValue(documentStopDate)).toEqual(340.0);
            expect(e.ellipsoid.material.repeat.getValue(documentStartDate)).toEqual(341.0);
            expect(e.ellipsoid.material.repeat.getValue(documentStopDate)).toEqual(342.0);
            expect(e = dataSource.entities.getById('sampled46')).toBeDefined();
            expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.333333333333333, 0.337254901960784, 0.341176470588235, 0.329411764705882), 1e-14);
            expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.349019607843137, 0.352941176470588, 0.356862745098039, 0.345098039215686), 1e-14);
            expect(e = dataSource.entities.getById('sampled47')).toBeDefined();
            expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.364705882352941, 0.368627450980392, 0.372549019607843, 0.36078431372549), 1e-14);
            expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.380392156862745, 0.384313725490196, 0.388235294117647, 0.376470588235294), 1e-14);
            expect(e = dataSource.entities.getById('sampled48')).toBeDefined();
            expect(e.ellipsoid.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.396078431372549, 0.4, 0.403921568627451, 0.392156862745098), 1e-14);
            expect(e.ellipsoid.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.411764705882353, 0.415686274509804, 0.419607843137255, 0.407843137254902), 1e-14);
            expect(e = dataSource.entities.getById('sampled49')).toBeDefined();
            expect(e.ellipsoid.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.427450980392157, 0.431372549019608, 0.435294117647059, 0.423529411764706), 1e-14);
            expect(e.ellipsoid.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.443137254901961, 0.447058823529412, 0.450980392156863, 0.43921568627451), 1e-14);
            expect(e = dataSource.entities.getById('sampled50')).toBeDefined();
            expect(e.ellipsoid.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.458823529411765, 0.462745098039216, 0.466666666666667, 0.454901960784314), 1e-14);
            expect(e.ellipsoid.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.474509803921569, 0.47843137254902, 0.482352941176471, 0.470588235294118), 1e-14);
            expect(e = dataSource.entities.getById('sampled51')).toBeDefined();
            expect(e.label.fillColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.490196078431373, 0.494117647058824, 0.498039215686275, 0.486274509803922), 1e-14);
            expect(e.label.fillColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.505882352941176, 0.509803921568627, 0.513725490196078, 0.501960784313725), 1e-14);
            expect(e = dataSource.entities.getById('sampled52')).toBeDefined();
            expect(e.label.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.52156862745098, 0.525490196078431, 0.529411764705882, 0.517647058823529), 1e-14);
            expect(e.label.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.537254901960784, 0.541176470588235, 0.545098039215686, 0.533333333333333), 1e-14);
            expect(e = dataSource.entities.getById('sampled53')).toBeDefined();
            expect(e.model.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.552941176470588, 0.556862745098039, 0.56078431372549, 0.549019607843137), 1e-14);
            expect(e.model.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.568627450980392, 0.572549019607843, 0.576470588235294, 0.564705882352941), 1e-14);
            expect(e = dataSource.entities.getById('sampled54')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.584313725490196, 0.588235294117647, 0.592156862745098, 0.580392156862745), 1e-14);
            expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.6, 0.603921568627451, 0.607843137254902, 0.596078431372549), 1e-14);
            expect(e = dataSource.entities.getById('sampled55')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(166, 167, 168, 165));
            expect(e.path.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(170, 171, 172, 169));
            expect(e.path.material.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(174, 175, 176, 173));
            expect(e.path.material.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(178, 179, 180, 177));
            expect(e.path.material.outlineWidth.getValue(documentStartDate)).toEqual(343.0);
            expect(e.path.material.outlineWidth.getValue(documentStopDate)).toEqual(344.0);
            expect(e = dataSource.entities.getById('sampled56')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(182, 183, 184, 181));
            expect(e.path.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(186, 187, 188, 185));
            expect(e = dataSource.entities.getById('sampled57')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(190, 191, 192, 189));
            expect(e.path.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(194, 195, 196, 193));
            expect(e.path.material.glowPower.getValue(documentStartDate)).toEqual(345.0);
            expect(e.path.material.glowPower.getValue(documentStopDate)).toEqual(346.0);
            ...
            expect(e.path.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(198, 199, 200, 197));
            expect(e.path.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(202, 203, 204, 201));
            expect(e = dataSource.entities.getById('sampled59')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(206, 207, 208, 205));
            expect(e.path.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(210, 211, 212, 209));
            expect(e.path.material.cellAlpha.getValue(documentStartDate)).toEqual(347.0);
            expect(e.path.material.cellAlpha.getValue(documentStopDate)).toEqual(348.0);
            ...
            expect(e.path.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(214, 215, 216, 213));
            expect(e.path.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(218, 219, 220, 217));
            expect(e.path.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(222, 223, 224, 221));
            expect(e.path.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(226, 227, 228, 225));
            expect(e.path.material.offset.getValue(documentStartDate)).toEqual(349.0);
            expect(e.path.material.offset.getValue(documentStopDate)).toEqual(350.0);
            expect(e.path.material.repeat.getValue(documentStartDate)).toEqual(351.0);
            expect(e.path.material.repeat.getValue(documentStopDate)).toEqual(352.0);
            expect(e = dataSource.entities.getById('sampled61')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.615686274509804, 0.619607843137255, 0.623529411764706, 0.611764705882353), 1e-14);
            expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.631372549019608, 0.635294117647059, 0.63921568627451, 0.627450980392157), 1e-14);
            expect(e = dataSource.entities.getById('sampled62')).toBeDefined();
            expect(e.path.material.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.647058823529412, 0.650980392156863, 0.654901960784314, 0.643137254901961), 1e-14);
            expect(e.path.material.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.662745098039216, 0.666666666666667, 0.670588235294118, 0.658823529411765), 1e-14);
            expect(e = dataSource.entities.getById('sampled63')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.67843137254902, 0.682352941176471, 0.686274509803922, 0.674509803921569), 1e-14);
            expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.694117647058824, 0.698039215686274, 0.701960784313725, 0.690196078431373), 1e-14);
            expect(e = dataSource.entities.getById('sampled64')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.709803921568627, 0.713725490196078, 0.717647058823529, 0.705882352941177), 1e-14);
            expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.725490196078431, 0.729411764705882, 0.733333333333333, 0.72156862745098), 1e-14);
            expect(e = dataSource.entities.getById('sampled65')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.741176470588235, 0.745098039215686, 0.749019607843137, 0.737254901960784), 1e-14);
            expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.756862745098039, 0.76078431372549, 0.764705882352941, 0.752941176470588), 1e-14);
            expect(e = dataSource.entities.getById('sampled66')).toBeDefined();
            expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.772549019607843, 0.776470588235294, 0.780392156862745, 0.768627450980392), 1e-14);
            expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.788235294117647, 0.792156862745098, 0.796078431372549, 0.784313725490196), 1e-14);
            expect(e = dataSource.entities.getById('sampled67')).toBeDefined();
            expect(e.path.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.803921568627451, 0.807843137254902, 0.811764705882353, 0.8), 1e-14);
            expect(e.path.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.819607843137255, 0.823529411764706, 0.827450980392157, 0.815686274509804), 1e-14);
            expect(e = dataSource.entities.getById('sampled68')).toBeDefined();
            expect(e.path.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.835294117647059, 0.83921568627451, 0.843137254901961, 0.831372549019608), 1e-14);
            expect(e.path.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.850980392156863, 0.854901960784314, 0.858823529411765, 0.847058823529412), 1e-14);
            expect(e = dataSource.entities.getById('sampled69')).toBeDefined();
            expect(e.point.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.866666666666667, 0.870588235294118, 0.874509803921569, 0.862745098039216), 1e-14);
            expect(e.point.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.882352941176471, 0.886274509803922, 0.890196078431373, 0.87843137254902), 1e-14);
            expect(e = dataSource.entities.getById('sampled70')).toBeDefined();
            expect(e.point.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.898039215686275, 0.901960784313726, 0.905882352941176, 0.894117647058824), 1e-14);
            expect(e.point.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.913725490196078, 0.917647058823529, 0.92156862745098, 0.909803921568627), 1e-14);
            expect(e = dataSource.entities.getById('sampled71')).toBeDefined();
            expect(e.polygon.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.929411764705882, 0.933333333333333, 0.937254901960784, 0.925490196078431), 1e-14);
            expect(e.polygon.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.945098039215686, 0.949019607843137, 0.952941176470588, 0.941176470588235), 1e-14);
            ...
            expect(e.polygon.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(230, 231, 232, 229));
            expect(e.polygon.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(234, 235, 236, 233));
            expect(e = dataSource.entities.getById('sampled73')).toBeDefined();
            expect(e.polygon.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(238, 239, 240, 237));
            expect(e.polygon.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(242, 243, 244, 241));
            expect(e.polygon.material.cellAlpha.getValue(documentStartDate)).toEqual(353.0);
            expect(e.polygon.material.cellAlpha.getValue(documentStopDate)).toEqual(354.0);
            ...
            expect(e.polygon.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(246, 247, 248, 245));
            expect(e.polygon.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(250, 251, 252, 249));
            expect(e.polygon.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(254, 0, 1, 253));
            expect(e.polygon.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(3, 4, 5, 2));
            expect(e.polygon.material.offset.getValue(documentStartDate)).toEqual(355.0);
            expect(e.polygon.material.offset.getValue(documentStopDate)).toEqual(356.0);
            expect(e.polygon.material.repeat.getValue(documentStartDate)).toEqual(357.0);
            expect(e.polygon.material.repeat.getValue(documentStopDate)).toEqual(358.0);
            expect(e = dataSource.entities.getById('sampled75')).toBeDefined();
            expect(e.polygon.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.96078431372549, 0.964705882352941, 0.968627450980392, 0.956862745098039), 1e-14);
            expect(e.polygon.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.976470588235294, 0.980392156862745, 0.984313725490196, 0.972549019607843), 1e-14);
            expect(e = dataSource.entities.getById('sampled76')).toBeDefined();
            expect(e.polygon.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.992156862745098, 0.996078431372549, 0, 0.988235294117647), 1e-14);
            expect(e.polygon.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.00784313725490196, 0.0117647058823529, 0.0156862745098039, 0.00392156862745098), 1e-14);
            expect(e = dataSource.entities.getById('sampled77')).toBeDefined();
            expect(e.polygon.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.0235294117647059, 0.0274509803921569, 0.0313725490196078, 0.0196078431372549), 1e-14);
            expect(e.polygon.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.0392156862745098, 0.0431372549019608, 0.0470588235294118, 0.0352941176470588), 1e-14);
            expect(e = dataSource.entities.getById('sampled78')).toBeDefined();
            expect(e.polygon.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.0549019607843137, 0.0588235294117647, 0.0627450980392157, 0.0509803921568627), 1e-14);
            expect(e.polygon.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.0705882352941176, 0.0745098039215686, 0.0784313725490196, 0.0666666666666667), 1e-14);
            expect(e = dataSource.entities.getById('sampled79')).toBeDefined();
            expect(e.polygon.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.0862745098039216, 0.0901960784313725, 0.0941176470588235, 0.0823529411764706), 1e-14);
            expect(e.polygon.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.101960784313725, 0.105882352941176, 0.109803921568627, 0.0980392156862745), 1e-14);
            expect(e = dataSource.entities.getById('sampled80')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.117647058823529, 0.12156862745098, 0.125490196078431, 0.113725490196078), 1e-14);
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.133333333333333, 0.137254901960784, 0.141176470588235, 0.129411764705882), 1e-14);
            expect(e = dataSource.entities.getById('sampled81')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(7, 8, 9, 6));
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(11, 12, 13, 10));
            expect(e.polyline.material.outlineColor.getValue(documentStartDate)).toEqual(Color.fromBytes(15, 16, 17, 14));
            expect(e.polyline.material.outlineColor.getValue(documentStopDate)).toEqual(Color.fromBytes(19, 20, 21, 18));
            expect(e.polyline.material.outlineWidth.getValue(documentStartDate)).toEqual(359.0);
            expect(e.polyline.material.outlineWidth.getValue(documentStopDate)).toEqual(360.0);
            expect(e = dataSource.entities.getById('sampled82')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(23, 24, 25, 22));
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(27, 28, 29, 26));
            expect(e = dataSource.entities.getById('sampled83')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(31, 32, 33, 30));
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(35, 36, 37, 34));
            expect(e.polyline.material.glowPower.getValue(documentStartDate)).toEqual(361.0);
            expect(e.polyline.material.glowPower.getValue(documentStopDate)).toEqual(362.0);
            ...
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(39, 40, 41, 38));
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(43, 44, 45, 42));
            expect(e = dataSource.entities.getById('sampled85')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(47, 48, 49, 46));
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(51, 52, 53, 50));
            expect(e.polyline.material.cellAlpha.getValue(documentStartDate)).toEqual(363.0);
            expect(e.polyline.material.cellAlpha.getValue(documentStopDate)).toEqual(364.0);
            ...
            expect(e.polyline.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(55, 56, 57, 54));
            expect(e.polyline.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(59, 60, 61, 58));
            expect(e.polyline.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(63, 64, 65, 62));
            expect(e.polyline.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(67, 68, 69, 66));
            expect(e.polyline.material.offset.getValue(documentStartDate)).toEqual(365.0);
            expect(e.polyline.material.offset.getValue(documentStopDate)).toEqual(366.0);
            expect(e.polyline.material.repeat.getValue(documentStartDate)).toEqual(367.0);
            expect(e.polyline.material.repeat.getValue(documentStopDate)).toEqual(368.0);
            expect(e = dataSource.entities.getById('sampled87')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.149019607843137, 0.152941176470588, 0.156862745098039, 0.145098039215686), 1e-14);
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.164705882352941, 0.168627450980392, 0.172549019607843, 0.16078431372549), 1e-14);
            expect(e = dataSource.entities.getById('sampled88')).toBeDefined();
            expect(e.polyline.material.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.180392156862745, 0.184313725490196, 0.188235294117647, 0.176470588235294), 1e-14);
            expect(e.polyline.material.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.196078431372549, 0.2, 0.203921568627451, 0.192156862745098), 1e-14);
            expect(e = dataSource.entities.getById('sampled89')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.211764705882353, 0.215686274509804, 0.219607843137255, 0.207843137254902), 1e-14);
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.227450980392157, 0.231372549019608, 0.235294117647059, 0.223529411764706), 1e-14);
            expect(e = dataSource.entities.getById('sampled90')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.243137254901961, 0.247058823529412, 0.250980392156863, 0.23921568627451), 1e-14);
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.258823529411765, 0.262745098039216, 0.266666666666667, 0.254901960784314), 1e-14);
            expect(e = dataSource.entities.getById('sampled91')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.274509803921569, 0.27843137254902, 0.282352941176471, 0.270588235294118), 1e-14);
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.290196078431373, 0.294117647058824, 0.298039215686275, 0.286274509803922), 1e-14);
            expect(e = dataSource.entities.getById('sampled92')).toBeDefined();
            expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.305882352941176, 0.309803921568627, 0.313725490196078, 0.301960784313725), 1e-14);
            expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.32156862745098, 0.325490196078431, 0.329411764705882, 0.317647058823529), 1e-14);
            expect(e = dataSource.entities.getById('sampled93')).toBeDefined();
            expect(e.polyline.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.337254901960784, 0.341176470588235, 0.345098039215686, 0.333333333333333), 1e-14);
            expect(e.polyline.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.352941176470588, 0.356862745098039, 0.36078431372549, 0.349019607843137), 1e-14);
            expect(e = dataSource.entities.getById('sampled94')).toBeDefined();
            expect(e.polyline.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.368627450980392, 0.372549019607843, 0.376470588235294, 0.364705882352941), 1e-14);
            expect(e.polyline.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.384313725490196, 0.388235294117647, 0.392156862745098, 0.380392156862745), 1e-14);
            ...
            expect(e.rectangle.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(71, 72, 73, 70));
            expect(e.rectangle.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(75, 76, 77, 74));
            expect(e = dataSource.entities.getById('sampled98')).toBeDefined();
            expect(e.rectangle.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(79, 80, 81, 78));
            expect(e.rectangle.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(83, 84, 85, 82));
            expect(e.rectangle.material.cellAlpha.getValue(documentStartDate)).toEqual(369.0);
            expect(e.rectangle.material.cellAlpha.getValue(documentStopDate)).toEqual(370.0);
            ...
            expect(e.rectangle.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(87, 88, 89, 86));
            expect(e.rectangle.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(91, 92, 93, 90));
            expect(e.rectangle.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(95, 96, 97, 94));
            expect(e.rectangle.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(99, 100, 101, 98));
            expect(e.rectangle.material.offset.getValue(documentStartDate)).toEqual(371.0);
            expect(e.rectangle.material.offset.getValue(documentStopDate)).toEqual(372.0);
            expect(e.rectangle.material.repeat.getValue(documentStartDate)).toEqual(373.0);
            expect(e.rectangle.material.repeat.getValue(documentStopDate)).toEqual(374.0);
            expect(e = dataSource.entities.getById('sampled100')).toBeDefined();
            expect(e.rectangle.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.431372549019608, 0.435294117647059, 0.43921568627451, 0.427450980392157), 1e-14);
            expect(e.rectangle.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.447058823529412, 0.450980392156863, 0.454901960784314, 0.443137254901961), 1e-14);
            expect(e = dataSource.entities.getById('sampled101')).toBeDefined();
            expect(e.rectangle.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.462745098039216, 0.466666666666667, 0.470588235294118, 0.458823529411765), 1e-14);
            expect(e.rectangle.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.47843137254902, 0.482352941176471, 0.486274509803922, 0.474509803921569), 1e-14);
            expect(e = dataSource.entities.getById('sampled102')).toBeDefined();
            expect(e.rectangle.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.494117647058824, 0.498039215686275, 0.501960784313725, 0.490196078431373), 1e-14);
            expect(e.rectangle.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.509803921568627, 0.513725490196078, 0.517647058823529, 0.505882352941176), 1e-14);
            expect(e = dataSource.entities.getById('sampled103')).toBeDefined();
            expect(e.rectangle.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.525490196078431, 0.529411764705882, 0.533333333333333, 0.52156862745098), 1e-14);
            expect(e.rectangle.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.541176470588235, 0.545098039215686, 0.549019607843137, 0.537254901960784), 1e-14);
            expect(e = dataSource.entities.getById('sampled104')).toBeDefined();
            expect(e.rectangle.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.556862745098039, 0.56078431372549, 0.564705882352941, 0.552941176470588), 1e-14);
            expect(e.rectangle.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.572549019607843, 0.576470588235294, 0.580392156862745, 0.568627450980392), 1e-14);
            expect(e = dataSource.entities.getById('sampled105')).toBeDefined();
            expect(e.wall.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.588235294117647, 0.592156862745098, 0.596078431372549, 0.584313725490196), 1e-14);
            expect(e.wall.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.603921568627451, 0.607843137254902, 0.611764705882353, 0.6), 1e-14);
            ...
            expect(e.wall.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(103, 104, 105, 102));
            expect(e.wall.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(107, 108, 109, 106));
            expect(e = dataSource.entities.getById('sampled107')).toBeDefined();
            expect(e.wall.material.color.getValue(documentStartDate)).toEqual(Color.fromBytes(111, 112, 113, 110));
            expect(e.wall.material.color.getValue(documentStopDate)).toEqual(Color.fromBytes(115, 116, 117, 114));
            expect(e.wall.material.cellAlpha.getValue(documentStartDate)).toEqual(375.0);
            expect(e.wall.material.cellAlpha.getValue(documentStopDate)).toEqual(376.0);
            ...
            expect(e.wall.material.evenColor.getValue(documentStartDate)).toEqual(Color.fromBytes(119, 120, 121, 118));
            expect(e.wall.material.evenColor.getValue(documentStopDate)).toEqual(Color.fromBytes(123, 124, 125, 122));
            expect(e.wall.material.oddColor.getValue(documentStartDate)).toEqual(Color.fromBytes(127, 128, 129, 126));
            expect(e.wall.material.oddColor.getValue(documentStopDate)).toEqual(Color.fromBytes(131, 132, 133, 130));
            expect(e.wall.material.offset.getValue(documentStartDate)).toEqual(377.0);
            expect(e.wall.material.offset.getValue(documentStopDate)).toEqual(378.0);
            expect(e.wall.material.repeat.getValue(documentStartDate)).toEqual(379.0);
            expect(e.wall.material.repeat.getValue(documentStopDate)).toEqual(380.0);
            expect(e = dataSource.entities.getById('sampled109')).toBeDefined();
            expect(e.wall.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.619607843137255, 0.623529411764706, 0.627450980392157, 0.615686274509804), 1e-14);
            expect(e.wall.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.635294117647059, 0.63921568627451, 0.643137254901961, 0.631372549019608), 1e-14);
            expect(e = dataSource.entities.getById('sampled110')).toBeDefined();
            expect(e.wall.material.color.getValue(documentStartDate)).toEqualEpsilon(new Color(0.650980392156863, 0.654901960784314, 0.658823529411765, 0.647058823529412), 1e-14);
            expect(e.wall.material.color.getValue(documentStopDate)).toEqualEpsilon(new Color(0.666666666666667, 0.670588235294118, 0.674509803921569, 0.662745098039216), 1e-14);
            expect(e = dataSource.entities.getById('sampled111')).toBeDefined();
            expect(e.wall.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.682352941176471, 0.686274509803922, 0.690196078431373, 0.67843137254902), 1e-14);
            expect(e.wall.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.698039215686274, 0.701960784313725, 0.705882352941177, 0.694117647058824), 1e-14);
            expect(e = dataSource.entities.getById('sampled112')).toBeDefined();
            expect(e.wall.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.713725490196078, 0.717647058823529, 0.72156862745098, 0.709803921568627), 1e-14);
            expect(e.wall.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.729411764705882, 0.733333333333333, 0.737254901960784, 0.725490196078431), 1e-14);
            expect(e = dataSource.entities.getById('sampled113')).toBeDefined();
            expect(e.wall.outlineColor.getValue(documentStartDate)).toEqualEpsilon(new Color(0.745098039215686, 0.749019607843137, 0.752941176470588, 0.741176470588235), 1e-14);
            expect(e.wall.outlineColor.getValue(documentStopDate)).toEqualEpsilon(new Color(0.76078431372549, 0.764705882352941, 0.768627450980392, 0.756862745098039), 1e-14);
            ...
            expect(e = dataSource.entities.getById('sampled252')).toBeDefined();
        });
    });
});
