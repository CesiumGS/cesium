...
defineSuite([
    ...
    it('processCzmlPacket adds data for constrained cone.', function() {
        ...
        expect(dynamicObject.cone.capMaterial.getValue(validTime).color.getValue(validTime)).toEqual(new Color(0.1, 0.1, 0.1, 0.1));
        expect(dynamicObject.cone.innerMaterial.getValue(validTime).color.getValue(validTime)).toEqual(new Color(0.2, 0.2, 0.2, 0.2));
        expect(dynamicObject.cone.outerMaterial.getValue(validTime).color.getValue(validTime)).toEqual(new Color(0.3, 0.3, 0.3, 0.3));
        expect(dynamicObject.cone.silhouetteMaterial.getValue(validTime).color.getValue(validTime)).toEqual(new Color(0.4, 0.4, 0.4, 0.4));
