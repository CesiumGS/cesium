...
defineSuite([
    ...
    it('Works with uninterpolatable value types.', function() {
        ...
        dynamicProperty._addCzmlIntervals(booleanConstant);
        expect(dynamicProperty.getValue(new JulianDate())).toEqual(true);

        dynamicProperty._addCzmlIntervals(booleanVerbose);
        expect(dynamicProperty.getValue(new JulianDate())).toEqual(false);

        dynamicProperty._addCzmlIntervals(booleanInterval);
        ...
        dynamicProperty._addCzmlIntervals(booleanIntervalArray);
        dynamicProperty._addCzmlIntervals(booleanVerbose);
