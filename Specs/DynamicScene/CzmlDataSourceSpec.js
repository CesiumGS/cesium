...
defineSuite([
    ...
    it('processUrl loads expected data', function() {
        ...
        waitsFor(function() {
            return dataSource.dynamicObjects.getObjects().length === 10;
        });
    });
    ...
    it('process loads expected data', function() {
        ...
        runs(function() {
            ...
            expect(dataSource.dynamicObjects.getObjects().length).toEqual(10);
        });
    });
    ...
    it('process loads data on top of existing', function() {
        ...
        runs(function() {
            var dataSource = new CzmlDataSource();
            dataSource.process(simple, simpleUrl);
            expect(dataSource.dynamicObjects.getObjects().length === 10);
